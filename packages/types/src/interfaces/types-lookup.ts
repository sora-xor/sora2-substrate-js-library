...
declare module '@polkadot/types/lookup' {
  ...
  /** @name SpConsensusBabeDigestsPreDigest (170) */
  ...
  /** @name SpConsensusBabeDigestsPrimaryPreDigest (171) */
  ...
  /** @name SpConsensusBabeDigestsSecondaryPlainPreDigest (173) */
  interface SpConsensusBabeDigestsSecondaryPlainPreDigest extends Struct {
    readonly authorityIndex: u32;
    readonly slot: u64;
  }

  /** @name SpConsensusBabeDigestsSecondaryVRFPreDigest (174) */
  ...
  /** @name PermissionsCall (198) */
  type PermissionsCall = Null;

  /** @name PermissionsError (199) */
  ...
  /** @name FramenodeRuntimeOriginCaller (221) */
  ...
  /** @name PalletCollectiveRawOrigin (223) */
  ...
  /** @name PalletStakingRewardDestination (227) */
  ...
  /** @name FramenodeRuntimeOpaqueSessionKeys (233) */
  ...
  /** @name MulticollateralBondingCurvePoolCall (262) */
  ...
  /** @name TechnicalCall (263) */
  type TechnicalCall = Null;

  /** @name PoolXykCall (264) */
  ...
  /** @name CommonPrimitivesFilterMode (268) */
  ...
  /** @name LiquidityProxySwapBatchInfo (270) */
  ...
  /** @name PalletDemocracyConviction (280) */
  ...
  /** @name EthBridgeBridgeSignatureVersion (284) */
  ...
  /** @name EthBridgeRequestsIncomingRequestKind (285) */
  ...
  /** @name EthBridgeRequestsIncomingTransactionRequestKind (286) */
  ...
  /** @name EthBridgeRequestsIncomingMetaRequestKind (287) */
  ...
  /** @name EthBridgeRequestsIncomingRequest (289) */
  ...
  /** @name EthBridgeRequestsIncomingIncomingTransfer (290) */
  ...
  /** @name EthBridgeRequestsAssetKind (291) */
  ...
  /** @name EthBridgeRequestsIncomingIncomingAddToken (292) */
  ...
  /** @name EthBridgeRequestsIncomingIncomingChangePeers (293) */
  ...
  /** @name EthBridgeRequestsIncomingIncomingCancelOutgoingRequest (294) */
  ...
  /** @name EthBridgeRequestsOutgoingRequest (295) */
  ...
  /** @name EthBridgeRequestsOutgoingOutgoingTransfer (296) */
  ...
  /** @name EthBridgeRequestsOutgoingOutgoingAddAsset (297) */
  ...
  /** @name EthBridgeRequestsOutgoingOutgoingAddToken (298) */
  ...
  /** @name EthBridgeRequestsOutgoingOutgoingAddPeer (299) */
  ...
  /** @name EthBridgeRequestsOutgoingOutgoingRemovePeer (300) */
  ...
  /** @name EthBridgeRequestsOutgoingOutgoingPrepareForMigration (302) */
  ...
  /** @name EthBridgeRequestsOutgoingOutgoingMigrate (303) */
  ...
  /** @name EthBridgeRequestsOutgoingOutgoingAddPeerCompat (304) */
  ...
  /** @name EthBridgeRequestsOutgoingOutgoingRemovePeerCompat (305) */
  ...
  /** @name EthBridgeRequestsIncomingIncomingMarkAsDoneRequest (306) */
  ...
  /** @name EthBridgeRequestsIncomingIncomingPrepareForMigration (307) */
  ...
  /** @name EthBridgeRequestsIncomingIncomingMigrate (308) */
  ...
  /** @name EthBridgeRequestsIncomingIncomingChangePeersCompat (309) */
  ...
  /** @name EthBridgeRequestsIncomingChangePeersContract (310) */
  ...
  /** @name EthBridgeRequestsLoadIncomingRequest (311) */
  ...
  /** @name EthBridgeRequestsLoadIncomingTransactionRequest (312) */
  ...
  /** @name EthBridgeRequestsLoadIncomingMetaRequest (313) */
  ...
  /** @name EthBridgeOffchainSignatureParams (315) */
  ...
  /** @name PswapDistributionCall (316) */
  ...
  /** @name PalletElectionsPhragmenCall (323) */
  ...
  /** @name PalletElectionsPhragmenRenouncing (324) */
  ...
  /** @name PalletIdentityIdentityInfo (336) */
  ...
  /** @name CeresLiquidityLockerCall (377) */
  ...
  /** @name CeresGovernancePlatformCall (379) */
  ...
  /** @name DemeterFarmingPlatformCall (381) */
  ...
  /** @name PalletElectionProviderMultiPhaseCall (383) */
  ...
  /** @name PalletElectionProviderMultiPhaseRawSolution (384) */
  ...
  /** @name FramenodeRuntimeNposCompactSolution24 (385) */
  ...
  /** @name PalletElectionProviderMultiPhaseSolutionOrSnapshotSize (460) */
  interface PalletElectionProviderMultiPhaseSolutionOrSnapshotSize extends Struct {
    readonly voters: Compact<u32>;
    readonly targets: Compact<u32>;
  }

  /** @name SpNposElectionsSupport (464) */
  ...
  /** @name HermesGovernancePlatformCall (469) */
  ...
  /** @name PalletStakingSoraDurationWrapper (474) */
  ...
  /** @name OrmlCurrenciesModuleError (525) */
  ...
  /** @name CommonPrimitivesAssetIdExtraAssetRecordArg (533) */
  ...
  /** @name CommonPrimitivesDexInfo (535) */
  ...
  /** @name MulticollateralBondingCurvePoolDistributionAccounts (537) */
  ...
  /** @name MulticollateralBondingCurvePoolDistributionAccountData (538) */
  ...
  /** @name MulticollateralBondingCurvePoolDistributionAccount (539) */
  ...
  /** @name MulticollateralBondingCurvePoolError (542) */
  ...
  /** @name PalletDemocracyReferendumInfo (558) */
  ...
  /** @name PalletDemocracyReferendumStatus (559) */
  ...
  /** @name PalletDemocracyVoteVoting (561) */
  ...
  /** @name PalletDemocracyDelegations (565) */
  interface PalletDemocracyDelegations extends Struct {
    readonly votes: u128;
    readonly capital: u128;
  }

  /** @name PalletDemocracyVotePriorLock (566) */
  interface PalletDemocracyVotePriorLock extends ITuple<[u32, u128]> {}

  /** @name PalletDemocracyError (570) */
  ...
  /** @name EthBridgeRequestsOffchainRequest (572) */
  ...
  /** @name EthBridgeRequestsRequestStatus (573) */
  ...
  /** @name EthBridgeRequestsOutgoingEthPeersSync (580) */
  ...
  /** @name EthBridgeBridgeStatus (581) */
  ...
  /** @name PswapDistributionError (588) */
  ...
  /** @name PalletSchedulerScheduled (594) */
  ...
  /** @name IrohaMigrationPendingMultisigAccount (599) */
  ...
  /** @name PalletMembershipError (602) */
  ...
  /** @name PalletElectionsPhragmenSeatHolder (604) */
  ...
  /** @name PalletElectionsPhragmenVoter (605) */
  ...
  /** @name PalletElectionsPhragmenError (606) */
  ...
  /** @name VestedRewardsRewardInfo (607) */
  ...
  /** @name VestedRewardsCrowdloanInfo (608) */
  ...
  /** @name VestedRewardsCrowdloanUserInfo (610) */
  ...
  /** @name PalletIdentityRegistration (612) */
  ...
  /** @name PalletIdentityRegistrarInfo (620) */
  ...
  /** @name CeresLiquidityLockerStorageVersion (632) */
  ...
  /** @name CeresLiquidityLockerLockInfo (634) */
  ...
  /** @name CeresLiquidityLockerError (635) */
  ...
  /** @name CeresTokenLockerStorageVersion (636) */
  ...
  /** @name CeresTokenLockerTokenLockInfo (638) */
  ...
  /** @name CeresTokenLockerError (639) */
  ...
  /** @name CeresGovernancePlatformVotingInfo (641) */
  ...
  /** @name CeresGovernancePlatformPollInfo (642) */
  ...
  /** @name CeresGovernancePlatformStorageVersion (643) */
  ...
  /** @name CeresGovernancePlatformError (644) */
  ...
  /** @name CeresLaunchpadIloInfo (645) */
  ...
  /** @name CeresLaunchpadContributorsVesting (646) */
  ...
  /** @name CeresLaunchpadTeamVesting (647) */
  ...
  /** @name CeresLaunchpadContributionInfo (649) */
  ...
  /** @name DemeterFarmingPlatformTokenInfo (651) */
  ...
  /** @name DemeterFarmingPlatformUserInfo (653) */
  ...
  /** @name DemeterFarmingPlatformPoolData (655) */
  ...
  /** @name DemeterFarmingPlatformStorageVersion (656) */
  ...
  /** @name DemeterFarmingPlatformError (657) */
  ...
  /** @name PalletElectionProviderMultiPhaseReadySolution (663) */
  ...
  /** @name PalletElectionProviderMultiPhaseRoundSnapshot (665) */
  interface PalletElectionProviderMultiPhaseRoundSnapshot extends Struct {
    readonly voters: Vec<ITuple<[AccountId32, u64, Vec<AccountId32>]>>;
    readonly targets: Vec<AccountId32>;
  }

  /** @name PalletElectionProviderMultiPhaseSignedSignedSubmission (671) */
  ...
  /** @name PalletElectionProviderMultiPhaseError (672) */
  ...
  /** @name HermesGovernancePlatformHermesVotingInfo (680) */
  ...
  /** @name HermesGovernancePlatformHermesPollInfo (681) */
  ...
  /** @name HermesGovernancePlatformError (682) */
  ...
  /** @name SpRuntimeMultiSignature (691) */
  ...
  /** @name SpCoreEcdsaSignature (692) */
  interface SpCoreEcdsaSignature extends U8aFixed {}

  /** @name FrameSystemExtensionsCheckSpecVersion (695) */
  type FrameSystemExtensionsCheckSpecVersion = Null;

  /** @name FrameSystemExtensionsCheckTxVersion (696) */
  type FrameSystemExtensionsCheckTxVersion = Null;

  /** @name FrameSystemExtensionsCheckGenesis (697) */
  type FrameSystemExtensionsCheckGenesis = Null;

  /** @name FrameSystemExtensionsCheckNonce (700) */
  interface FrameSystemExtensionsCheckNonce extends Compact<u32> {}

  /** @name FrameSystemExtensionsCheckWeight (701) */
  type FrameSystemExtensionsCheckWeight = Null;

  /** @name FramenodeRuntimeExtensionsChargeTransactionPayment (702) */
  interface FramenodeRuntimeExtensionsChargeTransactionPayment extends PalletTransactionPaymentChargeTransactionPayment {}

  /** @name PalletTransactionPaymentChargeTransactionPayment (703) */
  interface PalletTransactionPaymentChargeTransactionPayment extends Compact<u128> {}

  /** @name FramenodeRuntimeRuntime (704) */
