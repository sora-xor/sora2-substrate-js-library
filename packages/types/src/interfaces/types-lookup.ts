...
declare module '@polkadot/types/lookup' {
  ...
  /** @name QaToolsPalletsOrderBookToolsOrderBookFillSettings (623) */
  ...
  /** @name PalletUtilityError (626) */
  interface PalletUtilityError extends Enum {
    readonly isTooManyCalls: boolean;
    readonly type: 'TooManyCalls';
  }

  /** @name PalletStakingSoraDurationWrapper (627) */
  interface PalletStakingSoraDurationWrapper extends Struct {
    readonly secs: u64;
    readonly nanos: u32;
  }

  /** @name PalletStakingStakingLedger (628) */
  ...
  /** @name PalletStakingUnlockChunk (630) */
  interface PalletStakingUnlockChunk extends Struct {
    readonly value: Compact<u128>;
    readonly era: Compact<u32>;
  }

  /** @name PalletStakingNominations (633) */
  ...
  /** @name PalletStakingActiveEraInfo (635) */
  interface PalletStakingActiveEraInfo extends Struct {
    readonly index: u32;
    readonly start: Option<u64>;
  }

  /** @name PalletStakingEraRewardPoints (637) */
  interface PalletStakingEraRewardPoints extends Struct {
    readonly total: u32;
    readonly individual: BTreeMap<AccountId32, u32>;
  }

  /** @name PalletStakingUnappliedSlash (642) */
  ...
  /** @name PalletStakingSlashingSlashingSpans (644) */
  ...
  /** @name PalletStakingSlashingSpanRecord (645) */
  interface PalletStakingSlashingSpanRecord extends Struct {
    readonly slashed: u128;
    readonly paidOut: u128;
  }

  /** @name PalletStakingPalletError (648) */
  ...
  /** @name SpStakingOffenceOffenceDetails (649) */
  interface SpStakingOffenceOffenceDetails extends Struct {
    readonly offender: ITuple<[AccountId32, PalletStakingExposure]>;
    readonly reporters: Vec<AccountId32>;
  }

  /** @name SpCoreCryptoKeyTypeId (654) */
  interface SpCoreCryptoKeyTypeId extends U8aFixed {}

  /** @name PalletSessionError (655) */
  ...
  /** @name PalletGrandpaStoredState (656) */
  ...
  /** @name PalletGrandpaStoredPendingChange (657) */
  ...
  /** @name PalletImOnlineBoundedOpaqueNetworkState (663) */
  interface PalletImOnlineBoundedOpaqueNetworkState extends Struct {
    readonly peerId: Bytes;
    readonly externalAddresses: Vec<Bytes>;
  }

  /** @name PalletImOnlineError (667) */
  ...
  /** @name OrmlTokensBalanceLock (670) */
  interface OrmlTokensBalanceLock extends Struct {
    readonly id: U8aFixed;
    readonly amount: u128;
  }

  /** @name OrmlTokensAccountData (672) */
  ...
  /** @name OrmlTokensReserveData (674) */
  interface OrmlTokensReserveData extends Struct {
    readonly id: Null;
    readonly amount: u128;
  }

  /** @name OrmlTokensModuleError (676) */
  ...
  /** @name OrmlCurrenciesModuleError (677) */
  ...
  /** @name CommonPrimitivesAssetIdExtraAssetRecordArg (685) */
  ...
  /** @name CommonPrimitivesDexInfo (687) */
  ...
  /** @name MulticollateralBondingCurvePoolDistributionAccounts (689) */
  ...
  /** @name MulticollateralBondingCurvePoolDistributionAccountData (690) */
  ...
  /** @name MulticollateralBondingCurvePoolDistributionAccount (691) */
  ...
  /** @name MulticollateralBondingCurvePoolError (694) */
  ...
  /** @name PalletCollectiveVotes (701) */
  ...
  /** @name PalletCollectiveError (702) */
  ...
  /** @name PalletDemocracyReferendumInfo (710) */
  ...
  /** @name PalletDemocracyReferendumStatus (711) */
  ...
  /** @name PalletDemocracyVoteVoting (713) */
  ...
  /** @name PalletDemocracyDelegations (717) */
  interface PalletDemocracyDelegations extends Struct {
    readonly votes: u128;
    readonly capital: u128;
  }

  /** @name PalletDemocracyVotePriorLock (718) */
  interface PalletDemocracyVotePriorLock extends ITuple<[u32, u128]> {}

  /** @name PalletDemocracyError (722) */
  ...
  /** @name EthBridgeRequestsOffchainRequest (724) */
  ...
  /** @name EthBridgeRequestsRequestStatus (725) */
  ...
  /** @name EthBridgeRequestsOutgoingEthPeersSync (732) */
  ...
  /** @name EthBridgeBridgeStatus (733) */
  ...
  /** @name PswapDistributionError (737) */
  ...
  /** @name PalletSchedulerScheduled (743) */
  ...
  /** @name IrohaMigrationPendingMultisigAccount (748) */
  ...
  /** @name PalletMembershipError (751) */
  ...
  /** @name PalletElectionsPhragmenSeatHolder (753) */
  ...
  /** @name PalletElectionsPhragmenVoter (754) */
  ...
  /** @name PalletElectionsPhragmenError (755) */
  ...
  /** @name VestedRewardsRewardInfo (756) */
  ...
  /** @name VestedRewardsCrowdloanInfo (757) */
  ...
  /** @name VestedRewardsCrowdloanUserInfo (759) */
  ...
  /** @name PalletIdentityRegistration (761) */
  ...
  /** @name PalletIdentityRegistrarInfo (769) */
  ...
  /** @name CeresLiquidityLockerStorageVersion (782) */
  ...
  /** @name CeresLiquidityLockerLockInfo (784) */
  ...
  /** @name CeresLiquidityLockerError (785) */
  ...
  /** @name CeresTokenLockerStorageVersion (786) */
  ...
  /** @name CeresTokenLockerTokenLockInfo (788) */
  ...
  /** @name CeresTokenLockerError (789) */
  ...
  /** @name CeresGovernancePlatformVotingInfo (791) */
  ...
  /** @name CeresGovernancePlatformPollInfo (792) */
  ...
  /** @name CeresGovernancePlatformStorageVersion (793) */
  ...
  /** @name CeresGovernancePlatformError (794) */
  ...
  /** @name CeresLaunchpadIloInfo (795) */
  ...
  /** @name CeresLaunchpadContributorsVesting (796) */
  ...
  /** @name CeresLaunchpadTeamVesting (797) */
  ...
  /** @name CeresLaunchpadContributionInfo (799) */
  ...
  /** @name DemeterFarmingPlatformTokenInfo (801) */
  ...
  /** @name DemeterFarmingPlatformUserInfo (803) */
  ...
  /** @name DemeterFarmingPlatformPoolData (805) */
  ...
  /** @name DemeterFarmingPlatformStorageVersion (806) */
  ...
  /** @name DemeterFarmingPlatformError (807) */
  ...
  /** @name PalletBagsListListNode (808) */
  ...
  /** @name PalletBagsListListBag (809) */
  interface PalletBagsListListBag extends Struct {
    readonly head: Option<AccountId32>;
    readonly tail: Option<AccountId32>;
  }

  /** @name PalletBagsListError (811) */
  ...
  /** @name PalletBagsListListListError (812) */
  ...
  /** @name PalletElectionProviderMultiPhaseReadySolution (813) */
  ...
  /** @name HermesGovernancePlatformHermesVotingInfo (830) */
  ...
  /** @name HermesGovernancePlatformHermesPollInfo (831) */
  ...
  /** @name HermesGovernancePlatformStorageVersion (832) */
  ...
  /** @name HermesGovernancePlatformError (833) */
  ...
  /** @name OrderBookOrderBookTechStatus (840) */
  ...
  /** @name KensetsuCollateralInfo (853) */
  ...
  /** @name KensetsuCollateralizedDebtPosition (854) */
  ...
  interface KensetsuError extends Enum {
    ...
    readonly type: 'ArithmeticError' | 'WrongAssetId' | 'CdpNotFound' | 'CollateralInfoNotFound' | 'CdpSafe' | 'CdpUnsafe' | 'NotEnoughCollateral' | 'OperationNotPermitted' | 'OutstandingDebt' | 'NoDebt' | 'CdPsPerUserLimitReached' | 'HardCapSupply' | 'BalanceNotEnough' | 'WrongCollateralAssetId' | 'AccrueWrongTime';
  }
