...
declare module '@polkadot/types/lookup' {
  ...
  interface LiquidityProxyEvent extends Enum {
    ...
    readonly asXorlessTransfer: ITuple<[CommonPrimitivesAssetId32, AccountId32, AccountId32, u128, Bytes]>;
  ...
  /** @name PalletDemocracyVoteThreshold (95) */
  ...
  /** @name PalletDemocracyVoteAccountVote (96) */
  ...
  /** @name PswapDistributionEvent (99) */
  ...
  /** @name CommonPrimitivesRewardReason (112) */
  ...
  /** @name PriceToolsEvent (116) */
  type PriceToolsEvent = Null;

  /** @name CeresStakingEvent (117) */
  ...
  /** @name CeresLiquidityLockerEvent (118) */
  ...
  /** @name CeresTokenLockerEvent (119) */
  ...
  /** @name CeresGovernancePlatformEvent (120) */
  ...
  /** @name DemeterFarmingPlatformEvent (122) */
  ...
  /** @name PalletElectionProviderMultiPhaseEvent (124) */
  ...
  /** @name PalletElectionProviderMultiPhaseElectionCompute (125) */
  ...
  /** @name SpNposElectionsElectionScore (127) */
  ...
  /** @name PalletElectionProviderMultiPhasePhase (128) */
  ...
  interface OrderBookEvent extends Enum {
    ...
    readonly isLimitOrderExpired: boolean;
    readonly asLimitOrderExpired: {
      readonly orderBookId: OrderBookOrderBookId;
      readonly orderId: u128;
      readonly ownerId: AccountId32;
    } & Struct;
  ...
  /** @name OrderBookOrderBookStatus (144) */
  ...
  /** @name CommonPrimitivesPriceVariant (145) */
  ...
  /** @name LeafProviderEvent (148) */
  type LeafProviderEvent = Null;

  /** @name BridgeProxyEvent (149) */
  ...
  /** @name BridgeTypesMessageStatus (150) */
  ...
  /** @name EthereumLightClientEvent (151) */
  ...
  /** @name BridgeTypesHeaderHeaderId (154) */
  interface BridgeTypesHeaderHeaderId extends Struct {
    readonly number: u64;
    readonly hash_: H256;
  }

  /** @name BridgeInboundChannelEvent (155) */
  type BridgeInboundChannelEvent = Null;

  /** @name BridgeOutboundChannelEvent (156) */
  ...
  /** @name BridgeTypesGenericNetworkId (159) */
  ...
  /** @name BridgeTypesSubNetworkId (160) */
  ...
  /** @name BeefyLightClientEvent (167) */
  ...
  /** @name SubstrateBridgeChannelInboundPalletEvent (168) */
  type SubstrateBridgeChannelInboundPalletEvent = Null;

  /** @name SubstrateBridgeChannelOutboundPalletEvent (169) */
  ...
  /** @name ParachainBridgeAppEvent (171) */
  ...
  /** @name XcmV2MultiLocation (173) */
  interface XcmV2MultiLocation extends Struct {
    readonly parents: u8;
    readonly interior: XcmV2MultilocationJunctions;
  }

  /** @name XcmV2MultilocationJunctions (174) */
  ...
  /** @name XcmV3MultiLocation (181) */
  interface XcmV3MultiLocation extends Struct {
    readonly parents: u8;
    readonly interior: XcmV3Junctions;
  }

  /** @name XcmV3Junctions (182) */
  ...
  /** @name XcmV3JunctionNetworkId (185) */
  ...
  /** @name BridgeDataSignerEvent (189) */
  ...
  /** @name SpCoreEcdsaPublic (191) */
  interface SpCoreEcdsaPublic extends U8aFixed {}

  /** @name SpCoreEcdsaSignature (194) */
  interface SpCoreEcdsaSignature extends U8aFixed {}

  /** @name MultisigVerifierEvent (198) */
  ...
  /** @name SpConsensusBabeDigestsPreDigest (233) */
  ...
  /** @name SpConsensusBabeDigestsPrimaryPreDigest (234) */
  ...
  /** @name SpConsensusBabeDigestsSecondaryPlainPreDigest (236) */
  interface SpConsensusBabeDigestsSecondaryPlainPreDigest extends Struct {
    readonly authorityIndex: u32;
    readonly slot: u64;
  }

  /** @name SpConsensusBabeDigestsSecondaryVRFPreDigest (237) */
  ...
  /** @name SpConsensusBabeBabeEpochConfiguration (238) */
  interface SpConsensusBabeBabeEpochConfiguration extends Struct {
    readonly c: ITuple<[u64, u64]>;
    readonly allowedSlots: SpConsensusBabeAllowedSlots;
  }

  /** @name PalletBabeCall (239) */
  ...
  /** @name SpConsensusSlotsEquivocationProof (240) */
  ...
  /** @name SpRuntimeBlakeTwo256 (242) */
  type SpRuntimeBlakeTwo256 = Null;

  /** @name SpSessionMembershipProof (243) */
  ...
  /** @name PermissionsCall (261) */
  type PermissionsCall = Null;

  /** @name PermissionsError (262) */
  ...
  /** @name FramenodeRuntimeOriginCaller (282) */
  ...
  /** @name FrameSupportDispatchRawOrigin (283) */
  ...
  /** @name PalletCollectiveRawOrigin (284) */
  ...
  /** @name BridgeTypesCallOriginOutputU256 (287) */
  ...
  /** @name BridgeTypesEvmAdditionalEVMInboundData (288) */
  interface BridgeTypesEvmAdditionalEVMInboundData extends Struct {
    readonly source: H160;
  }

  /** @name BridgeTypesGenericTimepoint (289) */
  ...
  /** @name PalletStakingPalletCall (293) */
  ...
  /** @name PalletStakingRewardDestination (294) */
  ...
  /** @name PalletStakingPalletConfigOpU128 (295) */
  ...
  /** @name PalletStakingPalletConfigOpU32 (296) */
  ...
  /** @name PalletStakingPalletConfigOpPercent (297) */
  ...
  /** @name PalletStakingPalletConfigOpPerbill (298) */
  ...
  /** @name FramenodeRuntimeOpaqueSessionKeys (300) */
  ...
  /** @name SpFinalityGrandpaEquivocationProof (303) */
  interface SpFinalityGrandpaEquivocationProof extends Struct {
    readonly setId: u64;
    readonly equivocation: SpFinalityGrandpaEquivocation;
  }

  /** @name SpFinalityGrandpaEquivocation (304) */
  ...
  /** @name FinalityGrandpaEquivocationPrevote (305) */
  ...
  /** @name FinalityGrandpaPrecommit (311) */
  ...
  /** @name MulticollateralBondingCurvePoolCall (327) */
  ...
  /** @name TechnicalCall (328) */
  type TechnicalCall = Null;

  /** @name PoolXykCall (329) */
  ...
  /** @name CommonPrimitivesFilterMode (333) */
  ...
  /** @name LiquidityProxySwapBatchInfo (335) */
  ...
  /** @name PalletDemocracyConviction (345) */
  ...
  /** @name EthBridgeBridgeSignatureVersion (349) */
  ...
  /** @name EthBridgeRequestsIncomingRequestKind (350) */
  ...
  /** @name EthBridgeRequestsIncomingTransactionRequestKind (351) */
  ...
  /** @name EthBridgeRequestsIncomingMetaRequestKind (352) */
  ...
  /** @name EthBridgeRequestsIncomingRequest (354) */
  ...
  /** @name EthBridgeRequestsIncomingIncomingTransfer (355) */
  ...
  /** @name EthBridgeRequestsAssetKind (356) */
  ...
  /** @name EthBridgeRequestsIncomingIncomingAddToken (357) */
  ...
  /** @name EthBridgeRequestsIncomingIncomingChangePeers (358) */
  ...
  /** @name EthBridgeRequestsIncomingIncomingCancelOutgoingRequest (359) */
  ...
  /** @name EthBridgeRequestsOutgoingRequest (360) */
  ...
  /** @name EthBridgeRequestsOutgoingOutgoingTransfer (361) */
  ...
  /** @name EthBridgeRequestsOutgoingOutgoingAddAsset (362) */
  ...
  /** @name EthBridgeRequestsOutgoingOutgoingAddToken (363) */
  ...
  /** @name EthBridgeRequestsOutgoingOutgoingAddPeer (364) */
  ...
  /** @name EthBridgeRequestsOutgoingOutgoingRemovePeer (365) */
  ...
  /** @name EthBridgeRequestsOutgoingOutgoingPrepareForMigration (367) */
  ...
  /** @name EthBridgeRequestsOutgoingOutgoingMigrate (368) */
  ...
  /** @name EthBridgeRequestsOutgoingOutgoingAddPeerCompat (369) */
  ...
  /** @name EthBridgeRequestsOutgoingOutgoingRemovePeerCompat (370) */
  ...
  /** @name EthBridgeRequestsIncomingIncomingMarkAsDoneRequest (371) */
  ...
  /** @name EthBridgeRequestsIncomingIncomingPrepareForMigration (372) */
  ...
  /** @name EthBridgeRequestsIncomingIncomingMigrate (373) */
  ...
  /** @name EthBridgeRequestsIncomingIncomingChangePeersCompat (374) */
  ...
  /** @name EthBridgeRequestsIncomingChangePeersContract (375) */
  ...
  /** @name EthBridgeRequestsLoadIncomingRequest (376) */
  ...
  /** @name EthBridgeRequestsLoadIncomingTransactionRequest (377) */
  ...
  /** @name EthBridgeRequestsLoadIncomingMetaRequest (378) */
  ...
  /** @name EthBridgeOffchainSignatureParams (380) */
  ...
  /** @name PalletElectionsPhragmenCall (388) */
  ...
  /** @name PalletElectionsPhragmenRenouncing (389) */
  ...
  /** @name CeresLiquidityLockerCall (442) */
  ...
  /** @name CeresGovernancePlatformCall (444) */
  ...
  /** @name DemeterFarmingPlatformCall (446) */
  ...
  /** @name PalletElectionProviderMultiPhaseCall (448) */
  ...
  /** @name PalletElectionProviderMultiPhaseRawSolution (449) */
  ...
  /** @name FramenodeRuntimeNposCompactSolution24 (450) */
  ...
  /** @name PalletElectionProviderMultiPhaseSolutionOrSnapshotSize (525) */
  interface PalletElectionProviderMultiPhaseSolutionOrSnapshotSize extends Struct {
    readonly voters: Compact<u32>;
    readonly targets: Compact<u32>;
  }

  /** @name SpNposElectionsSupport (529) */
  ...
  /** @name BandFeeCalculationParameters (534) */
  ...
  /** @name HermesGovernancePlatformCall (536) */
  ...
  /** @name BridgeTypesNetworkConfig (549) */
  ...
  /** @name BridgeTypesNetworkConfigConsensus (550) */
  ...
  /** @name BridgeTypesDifficultyForkConfig (551) */
  ...
  /** @name EthbloomBloom (554) */
  interface EthbloomBloom extends U8aFixed {}

  /** @name BridgeTypesEthashproofDoubleNodeWithMerkleProof (558) */
  ...
  /** @name BridgeTypesEthashproofMixNonce (562) */
  interface BridgeTypesEthashproofMixNonce extends U8aFixed {}

  /** @name SpRuntimeMultiSignature (563) */
  ...
  /** @name BridgeInboundChannelCall (564) */
  ...
  /** @name SpBeefyMmrBeefyAuthoritySet (573) */
  ...
  /** @name SpBeefyPayload (575) */
  interface SpBeefyPayload extends Vec<ITuple<[U8aFixed, Bytes]>> {}

  /** @name BridgeCommonBeefyTypesValidatorProof (578) */
  ...
  /** @name BitvecOrderMsb0 (581) */
  type BitvecOrderMsb0 = Null;

  /** @name SpBeefyMmrMmrLeaf (583) */
  ...
  /** @name BridgeTypesGenericCommitment (589) */
  ...
  /** @name BridgeTypesEvmMessage (597) */
  ...
  /** @name FramenodeRuntimeMultiProof (599) */
  ...
  /** @name BeefyLightClientSubstrateBridgeMessageProof (600) */
  ...
  /** @name ParachainBridgeAppCall (605) */
  ...
  /** @name XcmV3MultiassetAssetId (607) */
  ...
  /** @name BridgeTypesSubstrateXcmAppTransferStatus (608) */
  ...
  /** @name QaToolsPalletsOrderBookToolsOrderBookFillSettings (617) */
  ...
  /** @name PalletUtilityError (620) */
  interface PalletUtilityError extends Enum {
    readonly isTooManyCalls: boolean;
    readonly type: 'TooManyCalls';
  }

  /** @name PalletStakingSoraDurationWrapper (621) */
  interface PalletStakingSoraDurationWrapper extends Struct {
    readonly secs: u64;
    readonly nanos: u32;
  }

  /** @name PalletStakingStakingLedger (622) */
  ...
  /** @name PalletStakingUnlockChunk (624) */
  interface PalletStakingUnlockChunk extends Struct {
    readonly value: Compact<u128>;
    readonly era: Compact<u32>;
  }

  /** @name PalletStakingNominations (627) */
  ...
  /** @name PalletStakingActiveEraInfo (629) */
  interface PalletStakingActiveEraInfo extends Struct {
    readonly index: u32;
    readonly start: Option<u64>;
  }

  /** @name PalletStakingEraRewardPoints (631) */
  interface PalletStakingEraRewardPoints extends Struct {
    readonly total: u32;
    readonly individual: BTreeMap<AccountId32, u32>;
  }

  /** @name PalletStakingUnappliedSlash (636) */
  ...
  /** @name PalletStakingSlashingSlashingSpans (638) */
  ...
  /** @name PalletStakingSlashingSpanRecord (639) */
  interface PalletStakingSlashingSpanRecord extends Struct {
    readonly slashed: u128;
    readonly paidOut: u128;
  }

  /** @name PalletStakingPalletError (642) */
  ...
  /** @name OrmlTokensBalanceLock (664) */
  interface OrmlTokensBalanceLock extends Struct {
    readonly id: U8aFixed;
    readonly amount: u128;
  }

  /** @name OrmlTokensAccountData (666) */
  ...
  /** @name OrmlTokensReserveData (668) */
  interface OrmlTokensReserveData extends Struct {
    readonly id: Null;
    readonly amount: u128;
  }

  /** @name OrmlTokensModuleError (670) */
  ...
  /** @name OrmlCurrenciesModuleError (671) */
  ...
  /** @name CommonPrimitivesAssetIdExtraAssetRecordArg (679) */
  ...
  /** @name CommonPrimitivesDexInfo (681) */
  ...
  /** @name MulticollateralBondingCurvePoolDistributionAccounts (683) */
  ...
  /** @name MulticollateralBondingCurvePoolDistributionAccountData (684) */
  ...
  /** @name MulticollateralBondingCurvePoolDistributionAccount (685) */
  ...
  /** @name MulticollateralBondingCurvePoolError (688) */
  ...
  /** @name PalletCollectiveVotes (695) */
  ...
  /** @name PalletCollectiveError (696) */
  ...
  /** @name PalletDemocracyReferendumInfo (704) */
  ...
  /** @name PalletDemocracyReferendumStatus (705) */
  ...
  /** @name PalletDemocracyVoteVoting (707) */
  ...
  /** @name PalletDemocracyDelegations (711) */
  interface PalletDemocracyDelegations extends Struct {
    readonly votes: u128;
    readonly capital: u128;
  }

  /** @name PalletDemocracyVotePriorLock (712) */
  interface PalletDemocracyVotePriorLock extends ITuple<[u32, u128]> {}

  /** @name PalletDemocracyError (716) */
  ...
  /** @name EthBridgeRequestsOffchainRequest (717) */
  ...
  /** @name EthBridgeRequestsRequestStatus (718) */
  ...
  /** @name EthBridgeRequestsOutgoingEthPeersSync (725) */
  ...
  /** @name EthBridgeBridgeStatus (726) */
  ...
  /** @name PswapDistributionError (730) */
  ...
  /** @name IrohaMigrationPendingMultisigAccount (741) */
  ...
  /** @name PalletMembershipError (744) */
  ...
  /** @name PalletElectionsPhragmenSeatHolder (746) */
  ...
  /** @name PalletElectionsPhragmenVoter (747) */
  ...
  /** @name PalletElectionsPhragmenError (748) */
  ...
  /** @name VestedRewardsRewardInfo (749) */
  ...
  /** @name VestedRewardsCrowdloanInfo (750) */
  ...
  /** @name VestedRewardsCrowdloanUserInfo (752) */
  ...
  /** @name PalletIdentityRegistration (754) */
  ...
  /** @name PalletIdentityRegistrarInfo (762) */
  ...
  /** @name CeresLiquidityLockerStorageVersion (775) */
  ...
  /** @name CeresLiquidityLockerLockInfo (777) */
  ...
  /** @name CeresLiquidityLockerError (778) */
  ...
  /** @name CeresTokenLockerStorageVersion (779) */
  ...
  /** @name CeresTokenLockerTokenLockInfo (781) */
  ...
  /** @name CeresTokenLockerError (782) */
  ...
  /** @name CeresGovernancePlatformVotingInfo (784) */
  ...
  /** @name CeresGovernancePlatformPollInfo (785) */
  ...
  /** @name CeresGovernancePlatformStorageVersion (786) */
  ...
  /** @name CeresGovernancePlatformError (787) */
  ...
  /** @name CeresLaunchpadIloInfo (788) */
  ...
  /** @name CeresLaunchpadContributorsVesting (789) */
  ...
  /** @name CeresLaunchpadTeamVesting (790) */
  ...
  /** @name CeresLaunchpadContributionInfo (792) */
  ...
  /** @name DemeterFarmingPlatformTokenInfo (794) */
  ...
  /** @name DemeterFarmingPlatformUserInfo (796) */
  ...
  /** @name DemeterFarmingPlatformPoolData (798) */
  ...
  /** @name DemeterFarmingPlatformStorageVersion (799) */
  ...
  /** @name DemeterFarmingPlatformError (800) */
  ...
  /** @name PalletBagsListListNode (801) */
  ...
  /** @name PalletBagsListListBag (802) */
  interface PalletBagsListListBag extends Struct {
    readonly head: Option<AccountId32>;
    readonly tail: Option<AccountId32>;
  }

  /** @name PalletBagsListError (804) */
  ...
  /** @name PalletBagsListListListError (805) */
  ...
  /** @name PalletElectionProviderMultiPhaseReadySolution (806) */
  ...
  /** @name PalletElectionProviderMultiPhaseRoundSnapshot (808) */
  interface PalletElectionProviderMultiPhaseRoundSnapshot extends Struct {
    readonly voters: Vec<ITuple<[AccountId32, u64, Vec<AccountId32>]>>;
    readonly targets: Vec<AccountId32>;
  }

  /** @name PalletElectionProviderMultiPhaseSignedSignedSubmission (814) */
  ...
  /** @name PalletElectionProviderMultiPhaseError (815) */
  ...
  /** @name HermesGovernancePlatformHermesVotingInfo (824) */
  ...
  /** @name HermesGovernancePlatformHermesPollInfo (825) */
  ...
  /** @name HermesGovernancePlatformStorageVersion (826) */
  ...
  /** @name HermesGovernancePlatformError (827) */
  ...
  /** @name PalletPreimageRequestStatus (828) */
  ...
  /** @name BridgeProxyBridgeRequest (849) */
  ...
  /** @name BridgeTypesMessageDirection (850) */
  ...
  /** @name EthereumLightClientError (860) */
  ...
  /** @name BridgeInboundChannelError (861) */
  ...
  /** @name BridgeTypesGenericCommitmentWithBlock (862) */
  interface BridgeTypesGenericCommitmentWithBlock extends Struct {
    readonly blockNumber: u32;
    readonly commitment: BridgeTypesGenericCommitment;
  }

  /** @name BridgeOutboundChannelError (863) */
  ...
  /** @name BeefyLightClientError (871) */
  ...
  /** @name SubstrateBridgeChannelInboundPalletError (872) */
  ...
  /** @name SubstrateBridgeChannelOutboundPalletError (873) */
  ...
  /** @name ParachainBridgeAppError (876) */
  ...
  /** @name BridgeDataSignerError (883) */
  ...
  /** @name MultisigVerifierError (884) */
  ...
  /** @name PalletSudoError (887) */
  interface PalletSudoError extends Enum {
    readonly isRequireSudo: boolean;
    readonly type: 'RequireSudo';
  }

  /** @name FaucetError (888) */
  ...
  /** @name FrameSystemExtensionsCheckSpecVersion (892) */
  type FrameSystemExtensionsCheckSpecVersion = Null;

  /** @name FrameSystemExtensionsCheckTxVersion (893) */
  type FrameSystemExtensionsCheckTxVersion = Null;

  /** @name FrameSystemExtensionsCheckGenesis (894) */
  type FrameSystemExtensionsCheckGenesis = Null;

  /** @name FrameSystemExtensionsCheckNonce (897) */
  interface FrameSystemExtensionsCheckNonce extends Compact<u32> {}

  /** @name FrameSystemExtensionsCheckWeight (898) */
  type FrameSystemExtensionsCheckWeight = Null;

  /** @name XorFeeExtensionChargeTransactionPayment (899) */
  interface XorFeeExtensionChargeTransactionPayment extends Struct {
    readonly tip: Compact<u128>;
  }

  /** @name FramenodeRuntimeRuntime (900) */
