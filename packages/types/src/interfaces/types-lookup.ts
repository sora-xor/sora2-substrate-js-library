...
declare module '@polkadot/types/lookup' {
  ...
  /** @name BridgeTypesMessageStatus (147) */
  ...
  /** @name EthereumLightClientEvent (148) */
  ...
  /** @name BridgeTypesHeaderHeaderId (151) */
  interface BridgeTypesHeaderHeaderId extends Struct {
    readonly number: u64;
    readonly hash_: H256;
  }

  /** @name BridgeInboundChannelEvent (152) */
  type BridgeInboundChannelEvent = Null;

  /** @name BridgeOutboundChannelEvent (153) */
  ...
  /** @name BridgeTypesGenericNetworkId (156) */
  ...
  /** @name BeefyLightClientEvent (164) */
  ...
  /** @name SubstrateBridgeChannelInboundPalletEvent (165) */
  type SubstrateBridgeChannelInboundPalletEvent = Null;

  /** @name SubstrateBridgeChannelOutboundPalletEvent (166) */
  ...
  /** @name SubstrateBridgeAppEvent (168) */
  ...
  /** @name XcmV2MultiLocation (170) */
  interface XcmV2MultiLocation extends Struct {
    readonly parents: u8;
    readonly interior: XcmV2MultilocationJunctions;
  }

  /** @name XcmV2MultilocationJunctions (171) */
  ...
  /** @name XcmV3MultiLocation (178) */
  interface XcmV3MultiLocation extends Struct {
    readonly parents: u8;
    readonly interior: XcmV3Junctions;
  }

  /** @name XcmV3Junctions (179) */
  ...
  /** @name XcmV3JunctionNetworkId (182) */
  ...
  /** @name XcmV3JunctionBodyPart (184) */
  ...
  /** @name BridgeDataSignerEvent (186) */
  ...
  /** @name BandFeeCalculationParameters (531) */
  ...
  /** @name HermesGovernancePlatformCall (533) */
  ...
  /** @name BridgeTypesGenericAccount (541) */
  ...
  /** @name EthereumLightClientCall (542) */
  ...
  /** @name BridgeTypesNetworkConfig (543) */
  ...
  /** @name BridgeTypesNetworkConfigConsensus (544) */
  ...
  /** @name BridgeTypesDifficultyForkConfig (545) */
  ...
  /** @name EthbloomBloom (548) */
  interface EthbloomBloom extends U8aFixed {}

  /** @name BridgeTypesEthashproofDoubleNodeWithMerkleProof (552) */
  ...
  /** @name BridgeTypesEthashproofMixNonce (556) */
  interface BridgeTypesEthashproofMixNonce extends U8aFixed {}

  /** @name SpRuntimeMultiSignature (557) */
  ...
  /** @name BridgeInboundChannelCall (558) */
  ...
  /** @name SpBeefyMmrBeefyAuthoritySet (567) */
  ...
  /** @name SpBeefyPayload (569) */
  interface SpBeefyPayload extends Vec<ITuple<[U8aFixed, Bytes]>> {}

  /** @name BridgeCommonBeefyTypesValidatorProof (572) */
  ...
  /** @name BitvecOrderMsb0 (575) */
  type BitvecOrderMsb0 = Null;

  /** @name SpBeefyMmrMmrLeaf (577) */
  ...
  /** @name BridgeTypesEvmMessage (591) */
  ...
  /** @name SubstrateBridgeAppCall (599) */
  ...
  /** @name XcmV3MultiassetAssetId (601) */
  ...
  /** @name BridgeTypesSubstrateXcmAppTransferStatus (603) */
  ...
  /** @name QaToolsPalletsOrderBookToolsOrderBookFillSettings (612) */
  ...
  /** @name PalletUtilityError (615) */
  interface PalletUtilityError extends Enum {
    readonly isTooManyCalls: boolean;
    readonly type: 'TooManyCalls';
  }

  /** @name PalletStakingSoraDurationWrapper (616) */
  interface PalletStakingSoraDurationWrapper extends Struct {
    readonly secs: u64;
    readonly nanos: u32;
  }

  /** @name PalletStakingStakingLedger (617) */
  ...
  /** @name PalletStakingUnlockChunk (619) */
  interface PalletStakingUnlockChunk extends Struct {
    readonly value: Compact<u128>;
    readonly era: Compact<u32>;
  }

  /** @name PalletStakingNominations (622) */
  ...
  /** @name PalletStakingPalletError (637) */
  ...
  /** @name SpStakingOffenceOffenceDetails (638) */
  ...
  /** @name PalletImOnlineBoundedOpaqueNetworkState (652) */
  ...
  /** @name OrmlCurrenciesModuleError (666) */
  ...
  /** @name CommonPrimitivesAssetIdExtraAssetRecordArg (674) */
  ...
  /** @name CommonPrimitivesDexInfo (676) */
  ...
  /** @name MulticollateralBondingCurvePoolDistributionAccounts (678) */
  ...
  /** @name MulticollateralBondingCurvePoolDistributionAccountData (679) */
  ...
  /** @name MulticollateralBondingCurvePoolDistributionAccount (680) */
  ...
  /** @name MulticollateralBondingCurvePoolError (683) */
  ...
  /** @name PalletCollectiveVotes (690) */
  ...
  /** @name PalletCollectiveError (691) */
  ...
  /** @name PalletDemocracyReferendumInfo (699) */
  ...
  /** @name PalletDemocracyReferendumStatus (700) */
  ...
  /** @name PalletDemocracyVoteVoting (702) */
  ...
  /** @name PalletDemocracyDelegations (706) */
  interface PalletDemocracyDelegations extends Struct {
    readonly votes: u128;
    readonly capital: u128;
  }

  /** @name PalletDemocracyVotePriorLock (707) */
  interface PalletDemocracyVotePriorLock extends ITuple<[u32, u128]> {}

  /** @name PalletDemocracyError (711) */
  ...
  /** @name EthBridgeRequestsOffchainRequest (712) */
  ...
  /** @name EthBridgeRequestsRequestStatus (713) */
  ...
  /** @name EthBridgeRequestsOutgoingEthPeersSync (720) */
  ...
  /** @name EthBridgeBridgeStatus (721) */
  ...
  /** @name PswapDistributionError (725) */
  ...
  /** @name PalletSchedulerScheduled (731) */
  ...
  /** @name IrohaMigrationPendingMultisigAccount (736) */
  ...
  /** @name PalletMembershipError (739) */
  ...
  /** @name PalletElectionsPhragmenSeatHolder (741) */
  ...
  /** @name PalletElectionsPhragmenVoter (742) */
  ...
  /** @name PalletElectionsPhragmenError (743) */
  ...
  /** @name VestedRewardsRewardInfo (744) */
  ...
  /** @name VestedRewardsCrowdloanInfo (745) */
  ...
  /** @name VestedRewardsCrowdloanUserInfo (747) */
  ...
  /** @name PalletIdentityRegistration (749) */
  ...
  /** @name PalletIdentityRegistrarInfo (757) */
  ...
  /** @name CeresLiquidityLockerStorageVersion (770) */
  ...
  /** @name CeresLiquidityLockerLockInfo (772) */
  ...
  /** @name CeresLiquidityLockerError (773) */
  ...
  /** @name CeresTokenLockerStorageVersion (774) */
  ...
  /** @name CeresTokenLockerTokenLockInfo (776) */
  ...
  /** @name CeresTokenLockerError (777) */
  ...
  /** @name CeresGovernancePlatformVotingInfo (779) */
  ...
  /** @name CeresGovernancePlatformPollInfo (780) */
  ...
  /** @name CeresGovernancePlatformStorageVersion (781) */
  ...
  /** @name CeresGovernancePlatformError (782) */
  ...
  /** @name CeresLaunchpadIloInfo (783) */
  ...
  /** @name CeresLaunchpadContributorsVesting (784) */
  ...
  /** @name CeresLaunchpadTeamVesting (785) */
  ...
  /** @name CeresLaunchpadContributionInfo (787) */
  ...
  /** @name DemeterFarmingPlatformTokenInfo (789) */
  ...
  /** @name DemeterFarmingPlatformUserInfo (791) */
  ...
  /** @name DemeterFarmingPlatformPoolData (793) */
  ...
  /** @name DemeterFarmingPlatformStorageVersion (794) */
  ...
  /** @name DemeterFarmingPlatformError (795) */
  ...
  /** @name PalletBagsListListNode (796) */
  ...
  /** @name PalletBagsListListBag (797) */
  interface PalletBagsListListBag extends Struct {
    readonly head: Option<AccountId32>;
    readonly tail: Option<AccountId32>;
  }

  /** @name PalletBagsListError (799) */
  ...
  /** @name PalletBagsListListListError (800) */
  ...
  /** @name PalletElectionProviderMultiPhaseReadySolution (801) */
  ...
  /** @name PalletElectionProviderMultiPhaseRoundSnapshot (803) */
  interface PalletElectionProviderMultiPhaseRoundSnapshot extends Struct {
    readonly voters: Vec<ITuple<[AccountId32, u64, Vec<AccountId32>]>>;
    readonly targets: Vec<AccountId32>;
  }

  /** @name PalletElectionProviderMultiPhaseSignedSignedSubmission (809) */
  ...
  /** @name PalletElectionProviderMultiPhaseError (810) */
  ...
  /** @name HermesGovernancePlatformHermesVotingInfo (819) */
  ...
  /** @name HermesGovernancePlatformHermesPollInfo (820) */
  ...
  /** @name HermesGovernancePlatformStorageVersion (821) */
  ...
  /** @name HermesGovernancePlatformError (822) */
  ...
  /** @name BridgeProxyBridgeRequest (846) */
  ...
  /** @name BridgeTypesMessageDirection (847) */
  ...
  /** @name EthereumLightClientError (857) */
  ...
  /** @name BridgeInboundChannelError (858) */
  ...
  /** @name BridgeOutboundChannelError (859) */
  ...
  /** @name BeefyLightClientError (867) */
  ...
  /** @name SubstrateBridgeChannelInboundPalletError (868) */
  ...
  /** @name SubstrateBridgeChannelOutboundPalletError (869) */
  ...
  /** @name SubstrateBridgeAppError (872) */
  ...
  /** @name BridgeDataSignerError (879) */
  ...
  /** @name MultisigVerifierError (880) */
  ...
  /** @name FramenodeRuntimeExtensionsChargeTransactionPayment (893) */
  interface FramenodeRuntimeExtensionsChargeTransactionPayment extends PalletTransactionPaymentChargeTransactionPayment {}

  /** @name PalletTransactionPaymentChargeTransactionPayment (894) */
  interface PalletTransactionPaymentChargeTransactionPayment extends Compact<u128> {}

  /** @name FramenodeRuntimeRuntime (895) */
