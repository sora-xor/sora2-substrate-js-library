  ...
  export interface AugmentedQueries<ApiType> {
    ...
    dexManager: {
      dexInfos: AugmentedQuery<ApiType, (arg: DEXId | AnyNumber | Uint8Array) => Observable<Option<DEXInfo>>, [DEXId]> &
        QueryableStorageEntry<ApiType, [DEXId]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    farming: {
      ...
      poolFarmers: AugmentedQuery<
        ApiType,
        (arg: AccountId | string | Uint8Array) => Observable<Vec<PoolFarmer>>,
        [AccountId]
      > &
        QueryableStorageEntry<ApiType, [AccountId]>;
      /**
      ...
      pools: AugmentedQuery<
        ApiType,
        (arg: BlockNumber | AnyNumber | Uint8Array) => Observable<Vec<AccountId>>,
        [BlockNumber]
      > &
        QueryableStorageEntry<ApiType, [BlockNumber]>;
      savedValues: AugmentedQuery<
        ApiType,
        (arg: BlockNumber | AnyNumber | Uint8Array) => Observable<Vec<ITuple<[AccountId, Vec<PoolFarmer>]>>>,
        [BlockNumber]
      > &
        QueryableStorageEntry<ApiType, [BlockNumber]>;
      /**
    ...
    irohaMigration: {
      ...
      pendingMultiSigAccounts: AugmentedQuery<
        ApiType,
        (arg: Text | string) => Observable<PendingMultisigAccount>,
        [Text]
      > &
        QueryableStorageEntry<ApiType, [Text]>;
    ...
    permissions: {
      owners: AugmentedQuery<
        ApiType,
        (
          arg1: PermissionId | AnyNumber | Uint8Array,
          arg2: Scope | { Limited: any } | { Unlimited: any } | string | Uint8Array
        ) => Observable<Vec<OwnerId>>,
        [PermissionId, Scope]
      > &
        QueryableStorageEntry<ApiType, [PermissionId, Scope]>;
      permissions: AugmentedQuery<
        ApiType,
        (
          arg1: HolderId | string | Uint8Array,
          arg2: Scope | { Limited: any } | { Unlimited: any } | string | Uint8Array
        ) => Observable<Vec<PermissionId>>,
        [HolderId, Scope]
      > &
        QueryableStorageEntry<ApiType, [HolderId, Scope]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    referrals: {
      referrerBalances: AugmentedQuery<
        ApiType,
        (arg: AccountId | string | Uint8Array) => Observable<Option<Balance>>,
        [AccountId]
      > &
        QueryableStorageEntry<ApiType, [AccountId]>;
    ...
    tokens: {
      ...
      accounts: AugmentedQuery<
        ApiType,
        (arg1: AccountId | string | Uint8Array, arg2: CurrencyId | AnyNumber | Uint8Array) => Observable<AccountData>,
        [AccountId, CurrencyId]
      > &
        QueryableStorageEntry<ApiType, [AccountId, CurrencyId]>;
      /**
      ...
      locks: AugmentedQuery<
        ...
        (
          ...
          arg2: CurrencyId | AnyNumber | Uint8Array
      ...
      totalIssuance: AugmentedQuery<
        ApiType,
        (arg: CurrencyId | AnyNumber | Uint8Array) => Observable<Balance>,
        [CurrencyId]
      > &
        QueryableStorageEntry<ApiType, [CurrencyId]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    tradingPair: {
      enabledSources: AugmentedQuery<
        ApiType,
        (
          arg1: DEXId | AnyNumber | Uint8Array,
          arg2: TradingPair | { base_asset_id?: any; target_asset_id?: any } | string | Uint8Array
        ) => Observable<Option<BTreeSet<LiquiditySourceType>>>,
        [DEXId, TradingPair]
      > &
        QueryableStorageEntry<ApiType, [DEXId, TradingPair]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
