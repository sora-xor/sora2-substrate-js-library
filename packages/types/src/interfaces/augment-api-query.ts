...
import type { ApolloPlatformBorrowingPosition, ApolloPlatformLendingPosition, ApolloPlatformPoolInfo, AssetsAssetRecord, BandBandRate, BandFeeCalculationParameters, BridgeProxyBridgeRequest, BridgeProxyTransferLimitSettings, BridgeTypesAssetKind, BridgeTypesAuxiliaryDigestItem, BridgeTypesGenericAssetId, BridgeTypesGenericBridgeMessage, BridgeTypesGenericCommitmentWithBlock, BridgeTypesGenericNetworkId, BridgeTypesSubNetworkId, BridgeTypesSubstrateBridgeMessage, BridgeTypesTonTonAddress, BridgeTypesTonTonNetworkId, CeresGovernancePlatformPollInfo, CeresGovernancePlatformStorageVersion, CeresGovernancePlatformVotingInfo, CeresLaunchpadContributionInfo, CeresLaunchpadIloInfo, CeresLiquidityLockerLockInfo, CeresLiquidityLockerStorageVersion, CeresStakingStakingInfo, CeresTokenLockerStorageVersion, CeresTokenLockerTokenLockInfo, CommonBalanceUnit, CommonPrimitivesAssetId32, CommonPrimitivesAssetInfo, CommonPrimitivesDexInfo, CommonPrimitivesLiquiditySourceType, CommonPrimitivesOracle, CommonPrimitivesOrderBookId, CommonPrimitivesTechAccountId, CommonPrimitivesTradingPairAssetId32, DemeterFarmingPlatformPoolData, DemeterFarmingPlatformStorageVersion, DemeterFarmingPlatformTokenInfo, DemeterFarmingPlatformUserInfo, DenominationMigrationStage, EthBridgeBridgeSignatureVersion, EthBridgeBridgeStatus, EthBridgeOffchainSignatureParams, EthBridgeRequestsAssetKind, EthBridgeRequestsOffchainRequest, EthBridgeRequestsOutgoingEthPeersSync, EthBridgeRequestsRequestStatus, EvmFungibleAppBaseFeeInfo, ExtendedAssetsSoulboundTokenMetadata, FarmingPoolFarmer, FixnumFixedPoint, FrameSupportDispatchPerDispatchClassWeight, FrameSupportPreimagesBounded, FrameSystemAccountInfo, FrameSystemEventRecord, FrameSystemLastRuntimeUpgradeInfo, FrameSystemPhase, FramenodeRuntimeOpaqueSessionKeys, HermesGovernancePlatformHermesPollInfo, HermesGovernancePlatformHermesVotingInfo, HermesGovernancePlatformStorageVersion, IrohaMigrationPendingMultisigAccount, KensetsuCollateralInfo, KensetsuCollateralizedDebtPosition, KensetsuStablecoinCollateralIdentifier, KensetsuStablecoinInfo, MulticollateralBondingCurvePoolDistributionAccounts, OrderBook, OrderBookLimitOrder, OrmlTokensAccountData, OrmlTokensBalanceLock, OrmlTokensReserveData, PalletBagsListListBag, PalletBagsListListNode, PalletBalancesAccountData, PalletBalancesBalanceLock, PalletBalancesReserveData, PalletCollectiveVotes, PalletDemocracyReferendumInfo, PalletDemocracyVoteThreshold, PalletDemocracyVoteVoting, PalletElectionProviderMultiPhasePhase, PalletElectionProviderMultiPhaseReadySolution, PalletElectionProviderMultiPhaseRoundSnapshot, PalletElectionProviderMultiPhaseSignedSignedSubmission, PalletElectionProviderMultiPhaseSolutionOrSnapshotSize, PalletElectionsPhragmenSeatHolder, PalletElectionsPhragmenVoter, PalletGrandpaStoredPendingChange, PalletGrandpaStoredState, PalletIdentityRegistrarInfo, PalletIdentityRegistration, PalletImOnlineBoundedOpaqueNetworkState, PalletImOnlineSr25519AppSr25519Public, PalletMultisigBridgeTimepoint, PalletMultisigMultisig, PalletMultisigMultisigAccount, PalletPreimageRequestStatus, PalletSchedulerScheduled, PalletStakingActiveEraInfo, PalletStakingEraRewardPoints, PalletStakingExposure, PalletStakingForcing, PalletStakingNominations, PalletStakingRewardDestination, PalletStakingSlashingSlashingSpans, PalletStakingSlashingSpanRecord, PalletStakingSoraDurationWrapper, PalletStakingStakingLedger, PalletStakingUnappliedSlash, PalletStakingValidatorPrefs, PalletTransactionPaymentReleases, PermissionsScope, PrestoCouponInfo, PrestoCropReceipt, PrestoCropReceiptCropReceiptContent, PrestoRequestsRequest, PriceToolsAggregatedPriceInfo, RewardsRewardInfo, SpBeefyCryptoPublic, SpBeefyMmrBeefyAuthoritySet, SpConsensusBabeAppPublic, SpConsensusBabeBabeEpochConfiguration, SpConsensusBabeDigestsNextConfigDescriptor, SpConsensusBabeDigestsPreDigest, SpCoreCryptoKeyTypeId, SpCoreEcdsaPublic, SpCoreEcdsaSignature, SpNposElectionsElectionScore, SpRuntimeDigest, SpStakingOffenceOffenceDetails, VestedRewardsClaim, VestedRewardsCrowdloanInfo, VestedRewardsCrowdloanUserInfo, VestedRewardsRewardInfo, VestedRewardsVestingCurrenciesVestingScheduleVariant, XorFeeAssetFee, XstSyntheticInfo } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    apolloPlatform: {
       ...
       **/
      userTotalCollateral: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array) => Observable<Option<u128>>, [AccountId32, CommonPrimitivesAssetId32]>;
    };
    assets: {
      /**
    ...
    bridgeDataSigner: {
       ...
       * Approvals
       **/
      approvals: AugmentedQuery<ApiType, (arg1: BridgeTypesGenericNetworkId | { EVM: any } | { Sub: any } | { EVMLegacy: any } | { TON: any } | string | Uint8Array, arg2: H256 | string | Uint8Array) => Observable<BTreeMap<SpCoreEcdsaPublic, SpCoreEcdsaSignature>>, [BridgeTypesGenericNetworkId, H256]>;
      /**
       * Peers
       **/
      peers: AugmentedQuery<ApiType, (arg: BridgeTypesGenericNetworkId | { EVM: any } | { Sub: any } | { EVMLegacy: any } | { TON: any } | string | Uint8Array) => Observable<Option<BTreeSet<SpCoreEcdsaPublic>>>, [BridgeTypesGenericNetworkId]>;
      /**
       * Pending peers
       **/
      pendingPeerUpdate: AugmentedQuery<ApiType, (arg: BridgeTypesGenericNetworkId | { EVM: any } | { Sub: any } | { EVMLegacy: any } | { TON: any } | string | Uint8Array) => Observable<bool>, [BridgeTypesGenericNetworkId]>;
    };
    bridgeInboundChannel: {
      channelNonces: AugmentedQuery<ApiType, (arg: BridgeTypesGenericNetworkId | { EVM: any } | { Sub: any } | { EVMLegacy: any } | { TON: any } | string | Uint8Array) => Observable<u64>, [BridgeTypesGenericNetworkId]>;
      evmChannelAddresses: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<Option<H160>>, [H256]>;
      reportedChannelNonces: AugmentedQuery<ApiType, (arg: BridgeTypesGenericNetworkId | { EVM: any } | { Sub: any } | { EVMLegacy: any } | { TON: any } | string | Uint8Array) => Observable<u64>, [BridgeTypesGenericNetworkId]>;
      tonChannelAddresses: AugmentedQuery<ApiType, (arg: BridgeTypesTonTonNetworkId | 'Mainnet' | 'Testnet' | number | Uint8Array) => Observable<Option<BridgeTypesTonTonAddress>>, [BridgeTypesTonTonNetworkId]>;
    };
    bridgeMultisig: {
      /**
    ...
    bridgeOutboundChannel: {
      ...
      latestCommitment: AugmentedQuery<ApiType, (arg: BridgeTypesGenericNetworkId | { EVM: any } | { Sub: any } | { EVMLegacy: any } | { TON: any } | string | Uint8Array) => Observable<Option<BridgeTypesGenericCommitmentWithBlock>>, [BridgeTypesGenericNetworkId]>;
      /**
       ...
       **/
      messageQueues: AugmentedQuery<ApiType, (arg: BridgeTypesGenericNetworkId | { EVM: any } | { Sub: any } | { EVMLegacy: any } | { TON: any } | string | Uint8Array) => Observable<Vec<BridgeTypesGenericBridgeMessage>>, [BridgeTypesGenericNetworkId]>;
      queueTotalGas: AugmentedQuery<ApiType, (arg: BridgeTypesGenericNetworkId | { EVM: any } | { Sub: any } | { EVMLegacy: any } | { TON: any } | string | Uint8Array) => Observable<U256>, [BridgeTypesGenericNetworkId]>;
    };
    bridgeProxy: {
      /**
       ...
       **/
      lockedAssets: AugmentedQuery<ApiType, (arg1: BridgeTypesGenericNetworkId | { EVM: any } | { Sub: any } | { EVMLegacy: any } | { TON: any } | string | Uint8Array, arg2: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array) => Observable<u128>, [BridgeTypesGenericNetworkId, CommonPrimitivesAssetId32]>;
      senders: AugmentedQuery<ApiType, (arg1: BridgeTypesGenericNetworkId | { EVM: any } | { Sub: any } | { EVMLegacy: any } | { TON: any } | string | Uint8Array, arg2: H256 | string | Uint8Array) => Observable<Option<AccountId32>>, [BridgeTypesGenericNetworkId, H256]>;
      transactions: AugmentedQuery<ApiType, (arg1: ITuple<[BridgeTypesGenericNetworkId, AccountId32]> | [BridgeTypesGenericNetworkId | { EVM: any } | { Sub: any } | { EVMLegacy: any } | { TON: any } | string | Uint8Array, AccountId32 | string | Uint8Array], arg2: H256 | string | Uint8Array) => Observable<Option<BridgeProxyBridgeRequest>>, [ITuple<[BridgeTypesGenericNetworkId, AccountId32]>, H256]>;
      /**
    ...
    extendedAssets: {
       ...
       **/
      soulboundAsset: AugmentedQuery<ApiType, (arg: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array) => Observable<Option<ExtendedAssetsSoulboundTokenMetadata>>, [CommonPrimitivesAssetId32]>;
    };
    farming: {
    ...
    jettonApp: {
      appInfo: AugmentedQuery<ApiType, () => Observable<Option<ITuple<[BridgeTypesTonTonNetworkId, BridgeTypesTonTonAddress]>>>, []>;
      assetKinds: AugmentedQuery<ApiType, (arg: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array) => Observable<Option<BridgeTypesAssetKind>>, [CommonPrimitivesAssetId32]>;
      assetsByAddresses: AugmentedQuery<ApiType, (arg: BridgeTypesTonTonAddress | { workchain?: any; address?: any } | string | Uint8Array) => Observable<Option<CommonPrimitivesAssetId32>>, [BridgeTypesTonTonAddress]>;
      sidechainPrecision: AugmentedQuery<ApiType, (arg: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array) => Observable<Option<u8>>, [CommonPrimitivesAssetId32]>;
      tokenAddresses: AugmentedQuery<ApiType, (arg: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array) => Observable<Option<BridgeTypesTonTonAddress>>, [CommonPrimitivesAssetId32]>;
    };
    kensetsu: {
      /**
       ...
       **/
      cdpOwnerIndex: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<Vec<u128>>>, [AccountId32]>;
      /**
       ...
       **/
      collateralInfos: AugmentedQuery<ApiType, (arg: KensetsuStablecoinCollateralIdentifier | { collateralAssetId?: any; stablecoinAssetId?: any } | string | Uint8Array) => Observable<Option<KensetsuCollateralInfo>>, [KensetsuStablecoinCollateralIdentifier]>;
      /**
       ...
       **/
      stablecoinInfos: AugmentedQuery<ApiType, (arg: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array) => Observable<Option<KensetsuStablecoinInfo>>, [CommonPrimitivesAssetId32]>;
      /**
    ...
    multisigVerifier: {
      peerKeys: AugmentedQuery<ApiType, (arg: BridgeTypesGenericNetworkId | { EVM: any } | { Sub: any } | { EVMLegacy: any } | { TON: any } | string | Uint8Array) => Observable<Option<BTreeSet<SpCoreEcdsaPublic>>>, [BridgeTypesGenericNetworkId]>;
    };
    offences: {
      /**
    ...
    orderBook: {
       ...
       **/
      aggregatedAsks: AugmentedQuery<ApiType, (arg: CommonPrimitivesOrderBookId | { dexId?: any; base?: any; quote?: any } | string | Uint8Array) => Observable<BTreeMap<CommonBalanceUnit, CommonBalanceUnit>>, [CommonPrimitivesOrderBookId]>;
      /**
       * The index contains the aggregated information about bids with total volume of orders for each price.
       **/
      aggregatedBids: AugmentedQuery<ApiType, (arg: CommonPrimitivesOrderBookId | { dexId?: any; base?: any; quote?: any } | string | Uint8Array) => Observable<BTreeMap<CommonBalanceUnit, CommonBalanceUnit>>, [CommonPrimitivesOrderBookId]>;
      /**
       * The tech storage that is used during the process of updating the order book.
       **/
      alignmentCursor: AugmentedQuery<ApiType, (arg: CommonPrimitivesOrderBookId | { dexId?: any; base?: any; quote?: any } | string | Uint8Array) => Observable<Option<u128>>, [CommonPrimitivesOrderBookId]>;
      /**
       * The index contains the list with the ask order `id` for each price.
       **/
      asks: AugmentedQuery<ApiType, (arg1: CommonPrimitivesOrderBookId | { dexId?: any; base?: any; quote?: any } | string | Uint8Array, arg2: CommonBalanceUnit | { inner?: any; isDivisible?: any } | string | Uint8Array) => Observable<Option<Vec<u128>>>, [CommonPrimitivesOrderBookId, CommonBalanceUnit]>;
      /**
       * The index contains the list with the bid order `id` for each price.
       **/
      bids: AugmentedQuery<ApiType, (arg1: CommonPrimitivesOrderBookId | { dexId?: any; base?: any; quote?: any } | string | Uint8Array, arg2: CommonBalanceUnit | { inner?: any; isDivisible?: any } | string | Uint8Array) => Observable<Option<Vec<u128>>>, [CommonPrimitivesOrderBookId, CommonBalanceUnit]>;
      /**
       * The tech storage that is used in the order expiration mechanism.
       **/
      expirationsAgenda: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Vec<ITuple<[CommonPrimitivesOrderBookId, u128]>>>, [u32]>;
      /**
       ...
       **/
      limitOrders: AugmentedQuery<ApiType, (arg1: CommonPrimitivesOrderBookId | { dexId?: any; base?: any; quote?: any } | string | Uint8Array, arg2: u128 | AnyNumber | Uint8Array) => Observable<Option<OrderBookLimitOrder>>, [CommonPrimitivesOrderBookId, u128]>;
      /**
       * The storage contains the information about order book, it's parameters and statuses.
       **/
      orderBooks: AugmentedQuery<ApiType, (arg: CommonPrimitivesOrderBookId | { dexId?: any; base?: any; quote?: any } | string | Uint8Array) => Observable<Option<OrderBook>>, [CommonPrimitivesOrderBookId]>;
      /**
       * The index contains the list with the order `id` for the user in different order books.
       **/
      userLimitOrders: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: CommonPrimitivesOrderBookId | { dexId?: any; base?: any; quote?: any } | string | Uint8Array) => Observable<Option<Vec<u128>>>, [AccountId32, CommonPrimitivesOrderBookId]>;
    };
    parachainBridgeApp: {
    ...
    presto: {
       ...
       * Coupons
       **/
      coupons: AugmentedQuery<ApiType, (arg: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array) => Observable<Option<PrestoCouponInfo>>, [CommonPrimitivesAssetId32]>;
      /**
       * Crop receipts
       **/
      cropReceipts: AugmentedQuery<ApiType, (arg: u64 | AnyNumber | Uint8Array) => Observable<Option<PrestoCropReceipt>>, [u64]>;
      /**
       * Crop receipts content
       **/
      cropReceiptsContent: AugmentedQuery<ApiType, (arg: u64 | AnyNumber | Uint8Array) => Observable<Option<PrestoCropReceiptCropReceiptContent>>, [u64]>;
      /**
       * Index to map Crop Receipt with emitted Coupon
       **/
      cropReceiptToCoupon: AugmentedQuery<ApiType, (arg: u64 | AnyNumber | Uint8Array) => Observable<Option<CommonPrimitivesAssetId32>>, [u64]>;
      /**
       ...
       * Requests
       **/
      requests: AugmentedQuery<ApiType, (arg: u64 | AnyNumber | Uint8Array) => Observable<Option<PrestoRequestsRequest>>, [u64]>;
      /**
       * Crop receipts index by user
       **/
      userCropReceipts: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Vec<u64>>, [AccountId32]>;
      /**
       * Requests index by users
       **/
      userRequests: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Vec<u64>>, [AccountId32]>;
    };
    priceTools: {
    ...
    substrateBridgeApp: {
      assetKinds: AugmentedQuery<ApiType, (arg1: BridgeTypesSubNetworkId | 'Mainnet' | 'Kusama' | 'Polkadot' | 'Rococo' | 'Alphanet' | 'Liberland' | number | Uint8Array, arg2: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array) => Observable<Option<BridgeTypesAssetKind>>, [BridgeTypesSubNetworkId, CommonPrimitivesAssetId32]>;
      sidechainAssetId: AugmentedQuery<ApiType, (arg1: BridgeTypesSubNetworkId | 'Mainnet' | 'Kusama' | 'Polkadot' | 'Rococo' | 'Alphanet' | 'Liberland' | number | Uint8Array, arg2: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array) => Observable<Option<BridgeTypesGenericAssetId>>, [BridgeTypesSubNetworkId, CommonPrimitivesAssetId32]>;
      sidechainPrecision: AugmentedQuery<ApiType, (arg1: BridgeTypesSubNetworkId | 'Mainnet' | 'Kusama' | 'Polkadot' | 'Rococo' | 'Alphanet' | 'Liberland' | number | Uint8Array, arg2: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array) => Observable<Option<u8>>, [BridgeTypesSubNetworkId, CommonPrimitivesAssetId32]>;
      thischainAssetId: AugmentedQuery<ApiType, (arg1: BridgeTypesSubNetworkId | 'Mainnet' | 'Kusama' | 'Polkadot' | 'Rococo' | 'Alphanet' | 'Liberland' | number | Uint8Array, arg2: BridgeTypesGenericAssetId | { Sora: any } | { XCM: any } | { EVM: any } | { Liberland: any } | string | Uint8Array) => Observable<Option<CommonPrimitivesAssetId32>>, [BridgeTypesSubNetworkId, BridgeTypesGenericAssetId]>;
    };
    ...
    vestedRewards: {
       ...
       **/
      claimSchedules: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Vec<VestedRewardsClaim>>, [u32]>;
      /**
