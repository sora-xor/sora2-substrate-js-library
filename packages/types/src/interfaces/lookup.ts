...
export default {
  ...
  /**
   * Lookup299: xor_fee::pallet::Error<T>
   **/
  XorFeeError: {
  ...
  /**
   * Lookup314: bridge_types::types::CallOriginOutput<primitive_types::H256, primitive_types::H256, bridge_types::evm::AdditionalEVMInboundData>
   **/
  ...
  /**
   * Lookup662: pallet_staking::sora::DurationWrapper
   **/
  ...
  /**
   * Lookup663: pallet_staking::StakingLedger<T>
   **/
  ...
  /**
   * Lookup665: pallet_staking::UnlockChunk<Balance>
   **/
  ...
  /**
   * Lookup668: pallet_staking::Nominations<T>
   **/
  ...
  /**
   * Lookup670: pallet_staking::ActiveEraInfo
   **/
  ...
  /**
   * Lookup672: pallet_staking::EraRewardPoints<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup677: pallet_staking::UnappliedSlash<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup679: pallet_staking::slashing::SlashingSpans
   **/
  ...
  /**
   * Lookup680: pallet_staking::slashing::SpanRecord<Balance>
   **/
  ...
  /**
   * Lookup705: orml_tokens::BalanceLock<Balance>
   **/
  ...
  /**
   * Lookup707: orml_tokens::AccountData<Balance>
   **/
  ...
  /**
   * Lookup709: orml_tokens::ReserveData<ReserveIdentifier, Balance>
   **/
  ...
  /**
   * Lookup711: orml_tokens::module::Error<T>
   **/
  OrmlTokensModuleError: {
    _enum: ['BalanceTooLow', 'AmountIntoBalanceFailed', 'LiquidityRestrictions', 'MaxLocksExceeded', 'KeepAlive', 'ExistentialDeposit', 'DeadAccount', 'TooManyReserves']
  },
  /**
   * Lookup712: orml_currencies::module::Error<T>
   **/
  OrmlCurrenciesModuleError: {
    _enum: ['AmountIntoBalanceFailed', 'BalanceTooLow', 'DepositFailed']
  },
  /**
   * Lookup715: trading_pair::pallet::Error<T>
   **/
  TradingPairError: {
  ...
  /**
   * Lookup940: regulated_assets::SoulboundTokenMetadata<common::primitives::AssetId32<common::primitives::_allowed_deprecated::PredefinedAssetId>, MaxAllowedTokensPerSBT>
   **/
  ...
  /**
   * Lookup942: regulated_assets::pallet::Error<T>
   **/
  ...
  /**
   * Lookup944: sp_runtime::MultiSignature
   **/
  ...
  /**
   * Lookup946: frame_system::extensions::check_spec_version::CheckSpecVersion<T>
   **/
  FrameSystemExtensionsCheckSpecVersion: 'Null',
  /**
   * Lookup947: frame_system::extensions::check_tx_version::CheckTxVersion<T>
   **/
  FrameSystemExtensionsCheckTxVersion: 'Null',
  /**
   * Lookup948: frame_system::extensions::check_genesis::CheckGenesis<T>
   **/
  FrameSystemExtensionsCheckGenesis: 'Null',
  /**
   * Lookup951: frame_system::extensions::check_nonce::CheckNonce<T>
   **/
  FrameSystemExtensionsCheckNonce: 'Compact<u32>',
  /**
   * Lookup952: frame_system::extensions::check_weight::CheckWeight<T>
   **/
  FrameSystemExtensionsCheckWeight: 'Null',
  /**
   * Lookup953: xor_fee::extension::ChargeTransactionPayment<T>
   **/
  XorFeeExtensionChargeTransactionPayment: {
    tip: 'Compact<u128>'
  },
  /**
   * Lookup954: framenode_runtime::Runtime
   **/
