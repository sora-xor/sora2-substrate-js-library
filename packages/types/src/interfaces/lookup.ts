...
export default {
  ...
  /**
   * Lookup30: permissions::pallet::Event<T>
   **/
  PermissionsEvent: {
    _enum: {
  ...
  /**
   * Lookup31: rewards::pallet::Event<T>
   **/
  RewardsEvent: {
    _enum: {
      Claimed: 'AccountId32',
  ...
  /**
   * Lookup32: xor_fee::pallet::Event<T>
   **/
  XorFeeEvent: {
    _enum: {
  ...
  /**
   * Lookup35: pallet_multisig::BridgeTimepoint<BlockNumber>
   **/
  ...
  /**
   * Lookup36: pallet_multisig::MultiChainHeight<BlockNumber>
   **/
  ...
  /**
   * Lookup64: common::primitives::AssetId32<common::primitives::PredefinedAssetId>
   **/
  CommonPrimitivesAssetId32: {
    code: '[u8;32]'
  },
  /**
   * Lookup65: common::primitives::PredefinedAssetId
   **/
  CommonPrimitivesPredefinedAssetId: {
    _enum: ['XOR', 'DOT', 'KSM', 'USDT', 'VAL', 'PSWAP', 'DAI', 'ETH', 'XSTUSD']
  },
  /**
   * Lookup67: trading_pair::pallet::Event<T>
   **/
  TradingPairEvent: {
    _enum: {
  ...
  /**
   * Lookup68: common::primitives::TradingPair<common::primitives::AssetId32<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup69: assets::pallet::Event<T>
   **/
  AssetsEvent: {
    _enum: {
  ...
  /**
   * Lookup70: multicollateral_bonding_curve_pool::pallet::Event<T>
   **/
  ...
  /**
   * Lookup72: fixnum::FixedPoint<I, P>
   **/
  FixnumFixedPoint: {
    inner: 'i128'
  },
  /**
   * Lookup74: technical::pallet::Event<T>
   **/
  TechnicalEvent: {
    _enum: {
  ...
  /**
   * Lookup75: common::primitives::TechAssetId<common::primitives::PredefinedAssetId>
   **/
  ...
  /**
   * Lookup76: common::primitives::TechAccountId<sp_core::crypto::AccountId32, common::primitives::TechAssetId<common::primitives::PredefinedAssetId>, DEXId>
   **/
  ...
  /**
   * Lookup77: common::primitives::TechPurpose<common::primitives::TechAssetId<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup78: common::primitives::TradingPair<common::primitives::TechAssetId<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup79: pool_xyk::pallet::Event<T>
   **/
  PoolXykEvent: {
    _enum: {
  ...
  /**
   * Lookup80: liquidity_proxy::pallet::Event<T>
   **/
  LiquidityProxyEvent: {
    _enum: {
  ...
  /**
   * Lookup82: common::primitives::LiquiditySourceId<DEXId, common::primitives::LiquiditySourceType>
   **/
  ...
  /**
   * Lookup83: common::primitives::LiquiditySourceType
   **/
  ...
  /**
   * Lookup88: pallet_democracy::vote_threshold::VoteThreshold
   **/
  PalletDemocracyVoteThreshold: {
    _enum: ['SuperMajorityApprove', 'SuperMajorityAgainst', 'SimpleMajority']
  },
  /**
   * Lookup89: pallet_democracy::vote::AccountVote<Balance>
   **/
  ...
  /**
   * Lookup91: eth_bridge::pallet::Event<T>
   **/
  EthBridgeEvent: {
    _enum: {
  ...
  /**
   * Lookup92: pswap_distribution::pallet::Event<T>
   **/
  ...
  /**
   * Lookup98: frame_support::traits::schedule::LookupError
   **/
  FrameSupportScheduleLookupError: {
    _enum: ['Unknown', 'BadFormat']
  },
  /**
   * Lookup99: iroha_migration::pallet::Event<T>
   **/
  IrohaMigrationEvent: {
    _enum: {
  ...
  /**
   * Lookup102: pallet_elections_phragmen::pallet::Event<T>
   **/
  ...
  /**
   * Lookup105: vested_rewards::pallet::Event<T>
   **/
  VestedRewardsEvent: {
    _enum: {
      RewardsVested: 'u128',
  ...
  /**
   * Lookup106: common::primitives::RewardReason
   **/
  ...
  /**
   * Lookup109: price_tools::pallet::Event<T>
   **/
  PriceToolsEvent: 'Null',
  /**
   * Lookup110: ceres_staking::pallet::Event<T>
   **/
  CeresStakingEvent: {
    _enum: {
  ...
  /**
   * Lookup111: ceres_liquidity_locker::pallet::Event<T>
   **/
  ...
  /**
   * Lookup112: ceres_token_locker::pallet::Event<T>
   **/
  ...
  /**
   * Lookup113: ceres_governance_platform::pallet::Event<T>
   **/
  ...
  /**
   * Lookup114: ceres_launchpad::pallet::Event<T>
   **/
  CeresLaunchpadEvent: {
    _enum: {
  ...
  /**
   * Lookup115: demeter_farming_platform::pallet::Event<T>
   **/
  ...
  /**
   * Lookup120: ethereum_light_client::pallet::Event<T>
   **/
  ...
  /**
   * Lookup123: bridge_types::header::HeaderId
   **/
  ...
  /**
   * Lookup124: bridge_channel::inbound::pallet::Event<T>
   **/
  BridgeChannelInboundPalletEvent: 'Null',
  /**
   * Lookup125: bridge_channel::outbound::pallet::Event<T>
   **/
  ...
  /**
   * Lookup126: dispatch::pallet::Event<T, I>
   **/
  DispatchEvent: {
    _enum: {
  ...
  /**
   * Lookup128: bridge_types::types::MessageDirection
   **/
  ...
  /**
   * Lookup135: evm_bridge_proxy::pallet::Event
   **/
  EvmBridgeProxyEvent: {
    _enum: {
  ...
  /**
   * Lookup136: bridge_types::types::MessageStatus
   **/
  BridgeTypesMessageStatus: {
    _enum: ['InQueue', 'Committed', 'Done', 'Failed', 'Refunded']
  },
  /**
   * Lookup137: beefy_light_client::pallet::Event<T>
   **/
  BeefyLightClientEvent: {
    _enum: {
      VerificationSuccessful: '(AccountId32,u32)',
  ...
  /**
   * Lookup171: sp_consensus_babe::digests::PreDigest
   **/
  ...
  /**
   * Lookup172: sp_consensus_babe::digests::PrimaryPreDigest
   **/
  ...
  /**
   * Lookup174: sp_consensus_babe::digests::SecondaryPlainPreDigest
   **/
  ...
  /**
   * Lookup175: sp_consensus_babe::digests::SecondaryVRFPreDigest
   **/
  ...
  /**
   * Lookup177: sp_consensus_babe::BabeEpochConfiguration
   **/
  ...
  /**
   * Lookup179: sp_consensus_slots::EquivocationProof<sp_runtime::generic::header::Header<Number, sp_runtime::traits::BlakeTwo256>, sp_consensus_babe::app::Public>
   **/
  ...
  /**
   * Lookup182: sp_session::MembershipProof
   **/
  ...
  /**
   * Lookup183: pallet_babe::pallet::Error<T>
   **/
  PalletBabeError: {
  ...
  /**
   * Lookup187: pallet_balances::BalanceLock<Balance>
   **/
  ...
  /**
   * Lookup188: pallet_balances::Reasons
   **/
  PalletBalancesReasons: {
    _enum: ['Fee', 'Misc', 'All']
  },
  /**
   * Lookup191: pallet_balances::ReserveData<ReserveIdentifier, Balance>
   **/
  ...
  /**
   * Lookup193: pallet_balances::Releases
   **/
  ...
  /**
   * Lookup195: pallet_balances::pallet::Error<T, I>
   **/
  PalletBalancesError: {
    _enum: ['VestingBalance', 'LiquidityRestrictions', 'InsufficientBalance', 'ExistentialDeposit', 'KeepAlive', 'ExistingVestingSchedule', 'DeadAccount', 'TooManyReserves']
  },
  /**
   * Lookup197: pallet_transaction_payment::Releases
   **/
  PalletTransactionPaymentReleases: {
    _enum: ['V1Ancient', 'V2']
  },
  /**
   * Lookup199: permissions::Scope
   **/
  PermissionsScope: {
    _enum: {
      Limited: 'H512',
  ...
  /**
   * Lookup211: rewards::pallet::Call<T>
   **/
  RewardsCall: {
    _enum: {
      claim: {
  ...
  /**
   * Lookup214: pallet_multisig::MultisigAccount<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup217: pallet_multisig::Multisig<BlockNumber, Balance, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup222: pallet_utility::pallet::Call<T>
   **/
  PalletUtilityCall: {
    _enum: {
      batch: {
  ...
  /**
   * Lookup224: framenode_runtime::OriginCaller
   **/
  ...
  /**
   * Lookup225: frame_support::dispatch::RawOrigin<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup226: pallet_collective::RawOrigin<sp_core::crypto::AccountId32, I>
   **/
  ...
  /**
   * Lookup228: dispatch::RawOrigin<primitive_types::U256, primitive_types::H160, bridge_types::types::CallOriginOutput<primitive_types::U256, primitive_types::H160, primitive_types::H256>>
   **/
  DispatchRawOrigin: {
    origin: 'BridgeTypesCallOriginOutput'
  },
  /**
   * Lookup229: bridge_types::types::CallOriginOutput<primitive_types::U256, primitive_types::H160, primitive_types::H256>
   **/
  ...
  /**
   * Lookup240: framenode_runtime::opaque::SessionKeys
   **/
  ...
  /**
   * Lookup241: beefy_primitives::crypto::Public
   **/
  ...
  /**
   * Lookup245: sp_finality_grandpa::EquivocationProof<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup246: sp_finality_grandpa::Equivocation<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup247: finality_grandpa::Equivocation<sp_finality_grandpa::app::Public, finality_grandpa::Prevote<primitive_types::H256, N>, sp_finality_grandpa::app::Signature>
   **/
  ...
  /**
   * Lookup249: sp_finality_grandpa::app::Signature
   **/
  ...
  /**
   * Lookup252: finality_grandpa::Equivocation<sp_finality_grandpa::app::Public, finality_grandpa::Precommit<primitive_types::H256, N>, sp_finality_grandpa::app::Signature>
   **/
  ...
  /**
   * Lookup263: orml_currencies::module::Call<T>
   **/
  ...
  /**
   * Lookup264: trading_pair::pallet::Call<T>
   **/
  TradingPairCall: {
    _enum: {
      register: {
  ...
  /**
   * Lookup265: assets::pallet::Call<T>
   **/
  AssetsCall: {
    _enum: {
      register: {
  ...
  /**
   * Lookup272: multicollateral_bonding_curve_pool::pallet::Call<T>
   **/
  ...
  /**
   * Lookup273: technical::pallet::Call<T>
   **/
  TechnicalCall: 'Null',
  /**
   * Lookup274: pool_xyk::pallet::Call<T>
   **/
  PoolXykCall: {
    _enum: {
      deposit_liquidity: {
  ...
  /**
   * Lookup275: liquidity_proxy::pallet::Call<T>
   **/
  LiquidityProxyCall: {
    _enum: {
      swap: {
  ...
  /**
   * Lookup276: common::swap_amount::SwapAmount<AmountType>
   **/
  CommonSwapAmount: {
    _enum: {
      WithDesiredInput: {
  ...
  /**
   * Lookup278: common::primitives::FilterMode
   **/
  ...
  /**
   * Lookup285: dex_api::pallet::Call<T>
   **/
  DexApiCall: 'Null',
  /**
   * Lookup286: eth_bridge::pallet::Call<T>
   **/
  EthBridgeCall: {
    _enum: {
      register_bridge: {
  ...
  /**
   * Lookup287: eth_bridge::requests::IncomingRequestKind
   **/
  ...
  /**
   * Lookup288: eth_bridge::requests::IncomingTransactionRequestKind
   **/
  ...
  /**
   * Lookup289: eth_bridge::requests::IncomingMetaRequestKind
   **/
  EthBridgeRequestsIncomingMetaRequestKind: {
    _enum: ['CancelOutgoingRequest', 'MarkAsDone']
  },
  /**
   * Lookup291: eth_bridge::requests::IncomingRequest<T>
   **/
  ...
  /**
   * Lookup292: eth_bridge::requests::incoming::IncomingTransfer<T>
   **/
  ...
  /**
   * Lookup293: eth_bridge::requests::AssetKind
   **/
  EthBridgeRequestsAssetKind: {
    _enum: ['Thischain', 'Sidechain', 'SidechainOwned']
  },
  /**
   * Lookup294: eth_bridge::requests::incoming::IncomingAddToken<T>
   **/
  ...
  /**
   * Lookup295: eth_bridge::requests::incoming::IncomingChangePeers<T>
   **/
  ...
  /**
   * Lookup296: eth_bridge::requests::incoming::IncomingCancelOutgoingRequest<T>
   **/
  ...
  /**
   * Lookup297: eth_bridge::requests::OutgoingRequest<T>
   **/
  ...
  /**
   * Lookup298: eth_bridge::requests::outgoing::OutgoingTransfer<T>
   **/
  ...
  /**
   * Lookup299: eth_bridge::requests::outgoing::OutgoingAddAsset<T>
   **/
  ...
  /**
   * Lookup300: eth_bridge::requests::outgoing::OutgoingAddToken<T>
   **/
  ...
  /**
   * Lookup301: eth_bridge::requests::outgoing::OutgoingAddPeer<T>
   **/
  ...
  /**
   * Lookup302: eth_bridge::requests::outgoing::OutgoingRemovePeer<T>
   **/
  ...
  /**
   * Lookup304: eth_bridge::requests::outgoing::OutgoingPrepareForMigration<T>
   **/
  ...
  /**
   * Lookup305: eth_bridge::requests::outgoing::OutgoingMigrate<T>
   **/
  ...
  /**
   * Lookup306: eth_bridge::requests::outgoing::OutgoingAddPeerCompat<T>
   **/
  ...
  /**
   * Lookup307: eth_bridge::requests::outgoing::OutgoingRemovePeerCompat<T>
   **/
  ...
  /**
   * Lookup308: eth_bridge::requests::incoming::IncomingMarkAsDoneRequest<T>
   **/
  ...
  /**
   * Lookup309: eth_bridge::requests::incoming::IncomingPrepareForMigration<T>
   **/
  ...
  /**
   * Lookup310: eth_bridge::requests::incoming::IncomingMigrate<T>
   **/
  ...
  /**
   * Lookup311: eth_bridge::requests::incoming::IncomingChangePeersCompat<T>
   **/
  ...
  /**
   * Lookup312: eth_bridge::requests::incoming::ChangePeersContract
   **/
  EthBridgeRequestsIncomingChangePeersContract: {
    _enum: ['XOR', 'VAL']
  },
  /**
   * Lookup313: eth_bridge::requests::LoadIncomingRequest<T>
   **/
  ...
  /**
   * Lookup314: eth_bridge::requests::LoadIncomingTransactionRequest<T>
   **/
  ...
  /**
   * Lookup315: eth_bridge::requests::LoadIncomingMetaRequest<T>
   **/
  ...
  /**
   * Lookup317: eth_bridge::offchain::SignatureParams
   **/
  ...
  /**
   * Lookup318: pswap_distribution::pallet::Call<T>
   **/
  ...
  /**
   * Lookup324: frame_support::traits::schedule::MaybeHashed<framenode_runtime::Call, primitive_types::H256>
   **/
  ...
  /**
   * Lookup325: iroha_migration::pallet::Call<T>
   **/
  IrohaMigrationCall: {
    _enum: {
      migrate: {
  ...
  /**
   * Lookup326: pallet_membership::pallet::Call<T, I>
   **/
  ...
  /**
   * Lookup327: pallet_elections_phragmen::pallet::Call<T>
   **/
  ...
  /**
   * Lookup328: pallet_elections_phragmen::Renouncing
   **/
  ...
  /**
   * Lookup329: vested_rewards::pallet::Call<T>
   **/
  VestedRewardsCall: {
    _enum: {
      claim_rewards: 'Null',
  ...
  /**
   * Lookup331: pallet_identity::types::IdentityInfo<FieldLimit>
   **/
  ...
  /**
   * Lookup367: pallet_identity::types::BitFlags<pallet_identity::types::IdentityField>
   **/
  ...
  /**
   * Lookup368: pallet_identity::types::IdentityField
   **/
  ...
  /**
   * Lookup371: ceres_staking::pallet::Call<T>
   **/
  CeresStakingCall: {
    _enum: {
      deposit: {
  ...
  /**
   * Lookup372: ceres_liquidity_locker::pallet::Call<T>
   **/
  ...
  /**
   * Lookup373: ceres_token_locker::pallet::Call<T>
   **/
  ...
  /**
   * Lookup374: ceres_governance_platform::pallet::Call<T>
   **/
  ...
  /**
   * Lookup375: ceres_launchpad::pallet::Call<T>
   **/
  CeresLaunchpadCall: {
    _enum: {
      create_ilo: {
  ...
  /**
   * Lookup376: demeter_farming_platform::pallet::Call<T>
   **/
  ...
  /**
   * Lookup378: pallet_election_provider_multi_phase::pallet::Call<T>
   **/
  ...
  /**
   * Lookup379: pallet_election_provider_multi_phase::RawSolution<framenode_runtime::NposCompactSolution24>
   **/
  ...
  /**
   * Lookup380: framenode_runtime::NposCompactSolution24
   **/
  ...
  /**
   * Lookup455: sp_npos_elections::ElectionScore
   **/
  ...
  /**
   * Lookup456: pallet_election_provider_multi_phase::SolutionOrSnapshotSize
   **/
  ...
  /**
   * Lookup460: sp_npos_elections::Support<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup461: ethereum_light_client::pallet::Call<T>
   **/
  ...
  /**
   * Lookup462: bridge_types::network_config::NetworkConfig
   **/
  ...
  /**
   * Lookup463: bridge_types::network_config::Consensus
   **/
  ...
  /**
   * Lookup464: bridge_types::difficulty::ForkConfig
   **/
  ...
  /**
   * Lookup465: bridge_types::difficulty::ClassicForkConfig
   **/
  ...
  /**
   * Lookup466: bridge_types::header::Header
   **/
  BridgeTypesHeader: {
    parentHash: 'H256',
    timestamp: 'u64',
  ...
  /**
   * Lookup471: bridge_types::ethashproof::DoubleNodeWithMerkleProof
   **/
  ...
  /**
   * Lookup475: bridge_types::ethashproof::MixNonce
   **/
  ...
  /**
   * Lookup480: bridge_channel::inbound::pallet::Call<T>
   **/
  ...
  /**
   * Lookup481: bridge_types::types::Message
   **/
  BridgeTypesMessage: {
    data: 'Bytes',
  ...
  /**
   * Lookup482: bridge_types::types::Proof
   **/
  BridgeTypesProof: {
    blockHash: 'H256',
    txIndex: 'u32',
  ...
  /**
   * Lookup483: eth_app::pallet::Call<T>
   **/
  EthAppCall: {
    _enum: {
      burn: {
  ...
  /**
   * Lookup484: erc20_app::pallet::Call<T>
   **/
  Erc20AppCall: {
    _enum: {
      mint: {
  ...
  /**
   * Lookup485: migration_app::pallet::Call<T>
   **/
  MigrationAppCall: {
    _enum: {
      migrate_erc20: {
  ...
  /**
   * Lookup488: evm_bridge_proxy::pallet::Call<T>
   **/
  EvmBridgeProxyCall: {
    _enum: {
      burn: {
  ...
  /**
   * Lookup489: beefy_light_client::pallet::Call<T>
   **/
  BeefyLightClientCall: {
    _enum: {
      submit_signature_commitment: {
        commitment: 'BridgeCommonBeefyTypesCommitment',
        validatorProof: 'BridgeCommonBeefyTypesValidatorProof',
        latestMmrLeaf: 'BridgeCommonBeefyTypesBeefyMMRLeaf',
        proof: 'BridgeCommonSimplifiedMMRProof'
      }
    }
  },
  /**
   * Lookup490: bridge_common::beefy_types::Commitment
   **/
  BridgeCommonBeefyTypesCommitment: {
    payloadPrefix: 'Bytes',
    payload: '[u8;32]',
    payloadSuffix: 'Bytes',
    blockNumber: 'u32',
  ...
  /**
   * Lookup491: bridge_common::beefy_types::ValidatorProof
   **/
  BridgeCommonBeefyTypesValidatorProof: {
    ...
    positions: 'Vec<u128>',
    publicKeys: 'Vec<H160>',
    publicKeyMerkleProofs: 'Vec<Vec<[u8;32]>>'
  },
  /**
   * Lookup494: bitvec::order::Msb0
   **/
  BitvecOrderMsb0: 'Null',
  /**
   * Lookup496: bridge_common::beefy_types::BeefyMMRLeaf
   **/
  BridgeCommonBeefyTypesBeefyMMRLeaf: {
    version: 'u8',
    parentNumber: 'u32',
    nextAuthoritySetId: 'u64',
    nextAuthoritySetLen: 'u32',
    parentHash: '[u8;32]',
    nextAuthoritySetRoot: '[u8;32]',
    randomSeed: '[u8;32]',
    digestHash: '[u8;32]'
  },
  /**
   * Lookup497: bridge_common::simplified_mmr_proof::SimplifiedMMRProof
   **/
  BridgeCommonSimplifiedMMRProof: {
    merkleProofItems: 'Vec<[u8;32]>',
    merkleProofOrderBitField: 'u64'
  },
  /**
  ...
  /**
   * Lookup502: pallet_authorship::UncleEntryItem<BlockNumber, primitive_types::H256, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup504: pallet_authorship::pallet::Error<T>
   **/
  PalletAuthorshipError: {
    _enum: ['InvalidUncleParent', 'UnclesAlreadySet', 'TooManyUncles', 'GenesisUncle', 'TooHighUncle', 'UncleAlreadyIncluded', 'OldUncle']
  },
  /**
   * Lookup505: pallet_staking::sora::DurationWrapper
   **/
  ...
  /**
   * Lookup506: pallet_staking::StakingLedger<T>
   **/
  ...
  /**
   * Lookup508: pallet_staking::UnlockChunk<Balance>
   **/
  ...
  /**
   * Lookup510: pallet_staking::Nominations<T>
   **/
  ...
  /**
   * Lookup512: pallet_staking::ActiveEraInfo
   **/
  ...
  /**
   * Lookup514: pallet_staking::EraRewardPoints<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup518: pallet_staking::Forcing
   **/
  PalletStakingForcing: {
    _enum: ['NotForcing', 'ForceNew', 'ForceNone', 'ForceAlways']
  },
  /**
   * Lookup520: pallet_staking::UnappliedSlash<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup522: pallet_staking::slashing::SlashingSpans
   **/
  ...
  /**
   * Lookup523: pallet_staking::slashing::SpanRecord<Balance>
   **/
  ...
  /**
   * Lookup526: pallet_staking::Releases
   **/
  PalletStakingReleases: {
    _enum: ['V1_0_0Ancient', 'V2_0_0', 'V3_0_0', 'V4_0_0', 'V5_0_0', 'V6_0_0', 'V7_0_0', 'V8_0_0', 'V9_0_0']
  },
  /**
   * Lookup527: pallet_staking::pallet::pallet::Error<T>
   **/
  ...
  /**
   * Lookup528: sp_staking::offence::OffenceDetails<sp_core::crypto::AccountId32, Offender>
   **/
  ...
  /**
   * Lookup533: sp_core::crypto::KeyTypeId
   **/
  SpCoreCryptoKeyTypeId: '[u8;4]',
  /**
   * Lookup534: pallet_session::pallet::Error<T>
   **/
  PalletSessionError: {
    _enum: ['InvalidProof', 'NoAssociatedValidatorId', 'DuplicatedKey', 'NoKeys', 'NoAccount']
  },
  /**
   * Lookup535: pallet_grandpa::StoredState<N>
   **/
  ...
  /**
   * Lookup536: pallet_grandpa::StoredPendingChange<N, Limit>
   **/
  ...
  /**
   * Lookup538: pallet_grandpa::pallet::Error<T>
   **/
  PalletGrandpaError: {
    _enum: ['PauseFailed', 'ResumeFailed', 'ChangePending', 'TooSoon', 'InvalidKeyOwnershipProof', 'InvalidEquivocationProof', 'DuplicateOffenceReport']
  },
  /**
   * Lookup542: pallet_im_online::BoundedOpaqueNetworkState<PeerIdEncodingLimit, MultiAddrEncodingLimit, AddressesLimit>
   **/
  ...
  /**
   * Lookup546: pallet_im_online::pallet::Error<T>
   **/
  PalletImOnlineError: {
    _enum: ['InvalidKey', 'DuplicatedHeartbeat']
  },
  /**
   * Lookup549: orml_tokens::BalanceLock<Balance>
   **/
  ...
  /**
   * Lookup551: orml_tokens::AccountData<Balance>
   **/
  ...
  /**
   * Lookup553: orml_tokens::ReserveData<ReserveIdentifier, Balance>
   **/
  ...
  /**
   * Lookup562: assets::AssetRecordArg<T>
   **/
  ...
  /**
   * Lookup564: common::primitives::AssetIdExtraAssetRecordArg<DEXId, common::primitives::LiquiditySourceType, AccountId>
   **/
  ...
  /**
   * Lookup565: assets::pallet::Error<T>
   **/
  AssetsError: {
  ...
  /**
   * Lookup566: common::primitives::DEXInfo<common::primitives::AssetId32<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup567: dex_manager::pallet::Error<T>
   **/
  DexManagerError: {
    _enum: ['DEXIdAlreadyExists', 'DEXDoesNotExist', 'InvalidFeeValue', 'InvalidAccountId']
  },
  /**
   * Lookup570: multicollateral_bonding_curve_pool::DistributionAccounts<multicollateral_bonding_curve_pool::DistributionAccountData<multicollateral_bonding_curve_pool::DistributionAccount<sp_core::crypto::AccountId32, common::primitives::TechAccountId<sp_core::crypto::AccountId32, common::primitives::TechAssetId<common::primitives::PredefinedAssetId>, DEXId>>>>
   **/
  ...
  /**
   * Lookup571: multicollateral_bonding_curve_pool::DistributionAccountData<multicollateral_bonding_curve_pool::DistributionAccount<sp_core::crypto::AccountId32, common::primitives::TechAccountId<sp_core::crypto::AccountId32, common::primitives::TechAssetId<common::primitives::PredefinedAssetId>, DEXId>>>
   **/
  ...
  /**
   * Lookup572: multicollateral_bonding_curve_pool::DistributionAccount<sp_core::crypto::AccountId32, common::primitives::TechAccountId<sp_core::crypto::AccountId32, common::primitives::TechAssetId<common::primitives::PredefinedAssetId>, DEXId>>
   **/
  ...
  /**
   * Lookup575: multicollateral_bonding_curve_pool::pallet::Error<T>
   **/
  ...
  /**
   * Lookup576: technical::pallet::Error<T>
   **/
  TechnicalError: {
  ...
  /**
   * Lookup579: pool_xyk::pallet::Error<T>
   **/
  PoolXykError: {
  ...
  /**
   * Lookup580: liquidity_proxy::pallet::Error<T>
   **/
  LiquidityProxyError: {
  ...
  /**
   * Lookup582: pallet_collective::Votes<sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup583: pallet_collective::pallet::Error<T, I>
   **/
  PalletCollectiveError: {
    _enum: ['NotMember', 'DuplicateProposal', 'ProposalMissing', 'WrongIndex', 'DuplicateVote', 'AlreadyInitialized', 'TooEarly', 'TooManyProposals', 'WrongProposalWeight', 'WrongProposalLength']
  },
  /**
   * Lookup589: pallet_democracy::PreimageStatus<sp_core::crypto::AccountId32, Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup590: pallet_democracy::types::ReferendumInfo<BlockNumber, primitive_types::H256, Balance>
   **/
  ...
  /**
   * Lookup591: pallet_democracy::types::ReferendumStatus<BlockNumber, primitive_types::H256, Balance>
   **/
  ...
  /**
   * Lookup593: pallet_democracy::vote::Voting<Balance, sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup600: pallet_democracy::Releases
   **/
  ...
  /**
   * Lookup603: eth_bridge::requests::OffchainRequest<T>
   **/
  ...
  /**
   * Lookup604: eth_bridge::requests::RequestStatus
   **/
  ...
  /**
   * Lookup611: eth_bridge::requests::outgoing::EthPeersSync
   **/
  ...
  /**
   * Lookup612: eth_bridge::BridgeStatus
   **/
  EthBridgeBridgeStatus: {
    _enum: ['Initialized', 'Migrating']
  },
  /**
   * Lookup616: eth_bridge::pallet::Error<T>
   **/
  EthBridgeError: {
  ...
  /**
   * Lookup619: pswap_distribution::pallet::Error<T>
   **/
  ...
  /**
   * Lookup625: pallet_scheduler::ScheduledV3<frame_support::traits::schedule::MaybeHashed<framenode_runtime::Call, primitive_types::H256>, BlockNumber, framenode_runtime::OriginCaller, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup626: pallet_scheduler::pallet::Error<T>
   **/
  PalletSchedulerError: {
    _enum: ['FailedToSchedule', 'NotFound', 'TargetBlockNumberInPast', 'RescheduleNoChange']
  },
  /**
   * Lookup629: iroha_migration::PendingMultisigAccount<T>
   **/
  ...
  /**
   * Lookup630: iroha_migration::pallet::Error<T>
   **/
  IrohaMigrationError: {
  ...
  /**
   * Lookup637: vested_rewards::RewardInfo
   **/
  ...
  /**
   * Lookup641: vested_rewards::MarketMakerInfo
   **/
  ...
  /**
   * Lookup642: vested_rewards::CrowdloanReward
   **/
  ...
  /**
   * Lookup643: vested_rewards::pallet::Error<T>
   **/
  VestedRewardsError: {
  ...
  /**
   * Lookup644: pallet_identity::types::Registration<Balance, MaxJudgements, MaxAdditionalFields>
   **/
  ...
  /**
   * Lookup652: pallet_identity::types::RegistrarInfo<Balance, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup654: pallet_identity::pallet::Error<T>
   **/
  PalletIdentityError: {
  ...
  /**
   * Lookup656: farming::PoolFarmer<T>
   **/
  FarmingPoolFarmer: {
    account: 'AccountId32',
    block: 'u32',
  ...
  /**
   * Lookup657: farming::pallet::Error<T>
   **/
  FarmingError: {
    _enum: ['IncRefError']
  },
  /**
   * Lookup658: xst::pallet::Error<T>
   **/
  XstError: {
  ...
  /**
   * Lookup659: price_tools::PriceInfo
   **/
  PriceToolsPriceInfo: {
    priceFailures: 'u32',
    spotPrices: 'Vec<u128>',
  ...
  /**
   * Lookup660: price_tools::pallet::Error<T>
   **/
  PriceToolsError: {
  ...
  /**
   * Lookup661: ceres_staking::StakingInfo
   **/
  ...
  /**
   * Lookup662: ceres_staking::pallet::Error<T>
   **/
  CeresStakingError: {
    _enum: ['StakingPoolIsFull', 'Unauthorized']
  },
  /**
   * Lookup663: ceres_liquidity_locker::StorageVersion
   **/
  CeresLiquidityLockerStorageVersion: {
    _enum: ['V1', 'V2']
  },
  /**
   * Lookup665: ceres_liquidity_locker::LockInfo<Balance, Moment, common::primitives::AssetId32<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup666: ceres_liquidity_locker::pallet::Error<T>
   **/
  ...
  /**
   * Lookup667: ceres_token_locker::StorageVersion
   **/
  CeresTokenLockerStorageVersion: {
    _enum: ['V1', 'V2']
  },
  /**
   * Lookup669: ceres_token_locker::TokenLockInfo<Balance, Moment, common::primitives::AssetId32<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup670: ceres_token_locker::pallet::Error<T>
   **/
  ...
  /**
   * Lookup672: ceres_governance_platform::VotingInfo
   **/
  ...
  /**
   * Lookup673: ceres_governance_platform::PollInfo<Moment>
   **/
  ...
  /**
   * Lookup674: ceres_governance_platform::StorageVersion
   **/
  CeresGovernancePlatformStorageVersion: {
    _enum: ['V1', 'V2']
  },
  /**
   * Lookup675: ceres_governance_platform::pallet::Error<T>
   **/
  ...
  /**
   * Lookup676: ceres_launchpad::ILOInfo<Balance, sp_core::crypto::AccountId32, Moment>
   **/
  ...
  /**
   * Lookup677: ceres_launchpad::ContributorsVesting<Balance, Moment>
   **/
  ...
  /**
   * Lookup678: ceres_launchpad::TeamVesting<Balance, Moment>
   **/
  ...
  /**
   * Lookup680: ceres_launchpad::ContributionInfo<Balance>
   **/
  ...
  /**
   * Lookup681: ceres_launchpad::pallet::Error<T>
   **/
  CeresLaunchpadError: {
  ...
  /**
   * Lookup682: demeter_farming_platform::TokenInfo<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup684: demeter_farming_platform::UserInfo<common::primitives::AssetId32<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup686: demeter_farming_platform::PoolData
   **/
  ...
  /**
   * Lookup687: demeter_farming_platform::pallet::Error<T>
   **/
  ...
  /**
   * Lookup693: pallet_election_provider_multi_phase::Phase<Bn>
   **/
  ...
  /**
   * Lookup695: pallet_election_provider_multi_phase::ReadySolution<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup696: pallet_election_provider_multi_phase::RoundSnapshot<T>
   **/
  ...
  /**
   * Lookup703: pallet_election_provider_multi_phase::signed::SignedSubmission<sp_core::crypto::AccountId32, Balance, framenode_runtime::NposCompactSolution24>
   **/
  ...
  /**
   * Lookup704: pallet_election_provider_multi_phase::pallet::Error<T>
   **/
  ...
  /**
   * Lookup707: beefy_primitives::mmr::BeefyAuthoritySet<primitive_types::H256>
   **/
  ...
  /**
   * Lookup709: ethereum_light_client::PruningRange
   **/
  ...
  /**
   * Lookup711: ethereum_light_client::StoredHeader<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup713: ethereum_light_client::pallet::Error<T>
   **/
  ...
  /**
   * Lookup714: bridge_channel::inbound::pallet::Error<T>
   **/
  ...
  /**
   * Lookup716: bridge_channel::outbound::Message
   **/
  ...
  /**
   * Lookup722: eth_app::pallet::Error<T>
   **/
  EthAppError: {
  ...
  /**
   * Lookup724: bridge_types::types::AssetKind
   **/
  BridgeTypesAssetKind: {
    _enum: ['Thischain', 'Sidechain']
  },
  /**
   * Lookup727: erc20_app::pallet::Error<T>
   **/
  Erc20AppError: {
  ...
  /**
   * Lookup728: migration_app::pallet::Error<T>
   **/
  MigrationAppError: {
  ...
  /**
   * Lookup730: evm_bridge_proxy::BridgeRequest<T>
   **/
  ...
  /**
   * Lookup731: evm_bridge_proxy::pallet::Error<T>
   **/
  EvmBridgeProxyError: 'Null',
  /**
   * Lookup732: bridge_common::beefy_types::ValidatorSet
   **/
  BridgeCommonBeefyTypesValidatorSet: {
    id: 'u128',
    length: 'u128',
    root: '[u8;32]'
  },
  /**
   * Lookup733: beefy_light_client::pallet::Error<T>
   **/
  BeefyLightClientError: {
    _enum: ['InvalidValidatorSetId', 'InvalidMMRProof', 'PayloadBlocknumberTooOld', 'PayloadBlocknumberTooNew', 'CannotSwitchOldValidatorSet', 'NotEnoughValidatorSignatures', 'InvalidNumberOfSignatures', 'InvalidNumberOfPositions', 'InvalidNumberOfPublicKeys', 'ValidatorNotOnceInbitfield', 'ValidatorSetIncorrectPosition', 'InvalidSignature']
  },
  /**
  ...
  /**
   * Lookup743: framenode_runtime::extensions::ChargeTransactionPayment<T>
   **/
  ...
  /**
   * Lookup745: framenode_runtime::Runtime
   **/
