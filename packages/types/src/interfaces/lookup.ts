...
export default {
  ...
  /**
   * Lookup73: multicollateral_bonding_curve_pool::pallet::Event<T>
   **/
  ...
  /**
   * Lookup75: fixnum::FixedPoint<I, P>
   **/
  FixnumFixedPoint: {
    inner: 'i128'
  },
  /**
   * Lookup77: technical::pallet::Event<T>
   **/
  TechnicalEvent: {
    _enum: {
  ...
  /**
   * Lookup78: common::primitives::TechAssetId<common::primitives::PredefinedAssetId>
   **/
  ...
  /**
   * Lookup79: common::primitives::TechAccountId<sp_core::crypto::AccountId32, common::primitives::TechAssetId<common::primitives::PredefinedAssetId>, DEXId>
   **/
  ...
  /**
   * Lookup80: common::primitives::TechPurpose<common::primitives::TechAssetId<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup81: common::primitives::TradingPair<common::primitives::TechAssetId<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup82: pool_xyk::pallet::Event<T>
   **/
  PoolXykEvent: {
    _enum: {
  ...
  /**
   * Lookup83: liquidity_proxy::pallet::Event<T>
   **/
  LiquidityProxyEvent: {
    _enum: {
  ...
  /**
   * Lookup85: common::primitives::LiquiditySourceId<DEXId, common::primitives::LiquiditySourceType>
   **/
  ...
  /**
   * Lookup86: common::primitives::LiquiditySourceType
   **/
  ...
  /**
   * Lookup87: pallet_collective::pallet::Event<T, I>
   **/
  ...
  /**
   * Lookup89: pallet_democracy::pallet::Event<T>
   **/
  ...
  /**
   * Lookup121: sp_npos_elections::ElectionScore
   **/
  ...
  /**
   * Lookup122: pallet_election_provider_multi_phase::Phase<Bn>
   **/
  ...
  /**
   * Lookup124: band::pallet::Event<T, I>
   **/
  BandEvent: {
    _enum: {
  ...
  /**
   * Lookup128: oracle_proxy::pallet::Event<T>
   **/
  OracleProxyEvent: {
    _enum: {
  ...
  /**
   * Lookup129: common::primitives::Oracle
   **/
  CommonPrimitivesOracle: {
    _enum: ['BandChainFeed']
  },
  /**
   * Lookup130: hermes_governance_platform::pallet::Event<T>
   **/
  ...
  /**
   * Lookup131: hermes_governance_platform::VotingOption
   **/
  HermesGovernancePlatformVotingOption: {
    _enum: ['Yes', 'No']
  },
  /**
   * Lookup132: ethereum_light_client::pallet::Event<T>
   **/
  ...
  /**
   * Lookup135: bridge_types::header::HeaderId
   **/
  ...
  /**
   * Lookup136: bridge_inbound_channel::pallet::Event<T>
   **/
  BridgeInboundChannelEvent: 'Null',
  /**
   * Lookup137: bridge_outbound_channel::pallet::Event<T>
   **/
  ...
  /**
   * Lookup138: dispatch::pallet::Event<T, I>
   **/
  DispatchEvent: {
    _enum: {
  ...
  /**
   * Lookup139: bridge_types::types::MessageId
   **/
  ...
  /**
   * Lookup140: bridge_types::types::MessageDirection
   **/
  ...
  /**
   * Lookup142: eth_app::pallet::Event<T>
   **/
  EthAppEvent: {
    _enum: {
  ...
  /**
   * Lookup145: erc20_app::pallet::Event<T>
   **/
  Erc20AppEvent: {
    _enum: {
  ...
  /**
   * Lookup146: migration_app::pallet::Event<T>
   **/
  MigrationAppEvent: {
    _enum: {
  ...
  /**
   * Lookup147: evm_bridge_proxy::pallet::Event
   **/
  EvmBridgeProxyEvent: {
    _enum: {
  ...
  /**
   * Lookup148: bridge_types::types::MessageStatus
   **/
  BridgeTypesMessageStatus: {
    _enum: ['InQueue', 'Committed', 'Done', 'Failed', 'Refunded']
  },
  /**
   * Lookup149: beefy_light_client::pallet::Event<T>
   **/
  ...
  /**
   * Lookup150: bridge_types::SubNetworkId
   **/
  ...
  /**
   * Lookup152: substrate_bridge_channel::inbound::pallet::Event<T>
   **/
  SubstrateBridgeChannelInboundPalletEvent: 'Null',
  /**
   * Lookup153: substrate_bridge_channel::outbound::pallet::Event<T>
   **/
  ...
  /**
   * Lookup155: substrate_bridge_app::pallet::Event<T>
   **/
  ...
  /**
   * Lookup156: xcm::VersionedMultiLocation
   **/
  ...
  /**
   * Lookup157: xcm::v2::multilocation::MultiLocation
   **/
  XcmV2MultiLocation: {
    parents: 'u8',
  ...
  /**
   * Lookup158: xcm::v2::multilocation::Junctions
   **/
  ...
  /**
   * Lookup159: xcm::v2::junction::Junction
   **/
  XcmV2Junction: {
    _enum: {
  ...
  /**
   * Lookup165: xcm::v3::multilocation::MultiLocation
   **/
  XcmV3MultiLocation: {
    parents: 'u8',
  ...
  /**
   * Lookup166: xcm::v3::junctions::Junctions
   **/
  XcmV3Junctions: {
    _enum: {
      Here: 'Null',
  ...
  /**
   * Lookup167: xcm::v3::junction::Junction
   **/
  XcmV3Junction: {
    _enum: {
      Parachain: 'Compact<u32>',
  ...
  /**
   * Lookup169: xcm::v3::junction::NetworkId
   **/
  ...
  /**
   * Lookup170: xcm::v3::junction::BodyId
   **/
  XcmV3JunctionBodyId: {
    _enum: {
      Unit: 'Null',
  ...
  /**
   * Lookup171: xcm::v3::junction::BodyPart
   **/
  ...
  /**
   * Lookup174: faucet::pallet::Event<T>
   **/
  FaucetEvent: {
    _enum: {
  ...
  /**
   * Lookup198: sp_consensus_babe::app::Public
   **/
  SpConsensusBabeAppPublic: 'SpCoreSr25519Public',
  /**
   * Lookup201: sp_consensus_babe::digests::NextConfigDescriptor
   **/
  ...
  /**
   * Lookup203: sp_consensus_babe::AllowedSlots
   **/
  SpConsensusBabeAllowedSlots: {
    _enum: ['PrimarySlots', 'PrimaryAndSecondaryPlainSlots', 'PrimaryAndSecondaryVRFSlots']
  },
  /**
   * Lookup207: sp_consensus_babe::digests::PreDigest
   **/
  ...
  /**
   * Lookup208: sp_consensus_babe::digests::PrimaryPreDigest
   **/
  ...
  /**
   * Lookup210: sp_consensus_babe::digests::SecondaryPlainPreDigest
   **/
  ...
  /**
   * Lookup211: sp_consensus_babe::digests::SecondaryVRFPreDigest
   **/
  ...
  /**
   * Lookup212: sp_consensus_babe::BabeEpochConfiguration
   **/
  ...
  /**
   * Lookup213: pallet_babe::pallet::Call<T>
   **/
  PalletBabeCall: {
    _enum: {
      report_equivocation: {
  ...
  /**
   * Lookup214: sp_consensus_slots::EquivocationProof<sp_runtime::generic::header::Header<Number, sp_runtime::traits::BlakeTwo256>, sp_consensus_babe::app::Public>
   **/
  ...
  /**
   * Lookup215: sp_runtime::generic::header::Header<Number, sp_runtime::traits::BlakeTwo256>
   **/
  SpRuntimeHeader: {
    parentHash: 'H256',
    number: 'Compact<u32>',
  ...
  /**
   * Lookup216: sp_runtime::traits::BlakeTwo256
   **/
  ...
  /**
   * Lookup218: pallet_babe::pallet::Error<T>
   **/
  PalletBabeError: {
  ...
  /**
   * Lookup243: rewards::pallet::Call<T>
   **/
  RewardsCall: {
    _enum: {
      claim: {
  ...
  /**
   * Lookup246: pallet_multisig::MultisigAccount<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup249: pallet_multisig::Multisig<BlockNumber, Balance, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup256: framenode_runtime::OriginCaller
   **/
  ...
  /**
   * Lookup260: dispatch::RawOrigin<primitive_types::U256, bridge_types::types::AdditionalEVMInboundData, bridge_types::types::CallOriginOutput<primitive_types::U256, primitive_types::H256, bridge_types::types::AdditionalEVMInboundData>>
   **/
  DispatchRawOriginU256: {
    origin: 'BridgeTypesCallOriginOutputU256'
  },
  /**
   * Lookup261: bridge_types::types::AdditionalEVMInboundData
   **/
  BridgeTypesAdditionalEVMInboundData: {
    source: 'H160'
  },
  /**
   * Lookup262: bridge_types::types::CallOriginOutput<primitive_types::U256, primitive_types::H256, bridge_types::types::AdditionalEVMInboundData>
   **/
  ...
  /**
   * Lookup263: dispatch::RawOrigin<bridge_types::SubNetworkId, Additional, bridge_types::types::CallOriginOutput<bridge_types::SubNetworkId, primitive_types::H256, Additional>>
   **/
  DispatchRawOriginSubNetworkId: {
    origin: 'BridgeTypesCallOriginOutputSubNetworkId'
  },
  /**
   * Lookup264: bridge_types::types::CallOriginOutput<bridge_types::SubNetworkId, primitive_types::H256, Additional>
   **/
  ...
  SpCoreVoid: 'Null',
  /**
   * Lookup266: pallet_staking::pallet::pallet::Call<T>
   **/
  ...
  /**
   * Lookup267: pallet_staking::RewardDestination<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup273: framenode_runtime::opaque::SessionKeys
   **/
  ...
  /**
   * Lookup274: sp_beefy::crypto::Public
   **/
  SpBeefyCryptoPublic: 'SpCoreEcdsaPublic',
  /**
   * Lookup275: sp_core::ecdsa::Public
   **/
  SpCoreEcdsaPublic: '[u8;33]',
  /**
   * Lookup277: pallet_grandpa::pallet::Call<T>
   **/
  PalletGrandpaCall: {
    _enum: {
      report_equivocation: {
  ...
  /**
   * Lookup278: sp_finality_grandpa::EquivocationProof<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup279: sp_finality_grandpa::Equivocation<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup280: finality_grandpa::Equivocation<sp_finality_grandpa::app::Public, finality_grandpa::Prevote<primitive_types::H256, N>, sp_finality_grandpa::app::Signature>
   **/
  ...
  /**
   * Lookup281: finality_grandpa::Prevote<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup282: sp_finality_grandpa::app::Signature
   **/
  ...
  /**
   * Lookup285: finality_grandpa::Equivocation<sp_finality_grandpa::app::Public, finality_grandpa::Precommit<primitive_types::H256, N>, sp_finality_grandpa::app::Signature>
   **/
  ...
  /**
   * Lookup286: finality_grandpa::Precommit<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup288: pallet_im_online::pallet::Call<T>
   **/
  PalletImOnlineCall: {
    _enum: {
      heartbeat: {
  ...
  /**
   * Lookup289: pallet_im_online::Heartbeat<BlockNumber>
   **/
  ...
  /**
   * Lookup290: sp_core::offchain::OpaqueNetworkState
   **/
  ...
  /**
   * Lookup294: pallet_im_online::sr25519::app_sr25519::Signature
   **/
  ...
  /**
   * Lookup296: trading_pair::pallet::Call<T>
   **/
  TradingPairCall: {
    _enum: {
      register: {
  ...
  /**
   * Lookup297: assets::pallet::Call<T>
   **/
  AssetsCall: {
    _enum: {
      register: {
  ...
  /**
   * Lookup304: multicollateral_bonding_curve_pool::pallet::Call<T>
   **/
  ...
  /**
   * Lookup305: technical::pallet::Call<T>
   **/
  TechnicalCall: 'Null',
  /**
   * Lookup306: pool_xyk::pallet::Call<T>
   **/
  PoolXykCall: {
    _enum: {
      deposit_liquidity: {
  ...
  /**
   * Lookup307: liquidity_proxy::pallet::Call<T>
   **/
  LiquidityProxyCall: {
    _enum: {
      swap: {
  ...
  /**
   * Lookup308: common::swap_amount::SwapAmount<AmountType>
   **/
  CommonSwapAmount: {
    _enum: {
      WithDesiredInput: {
  ...
  /**
   * Lookup310: common::primitives::FilterMode
   **/
  CommonPrimitivesFilterMode: {
    _enum: ['Disabled', 'ForbidSelected', 'AllowSelected']
  },
  /**
   * Lookup312: liquidity_proxy::SwapBatchInfo<common::primitives::AssetId32<common::primitives::PredefinedAssetId>, DEXId, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup314: liquidity_proxy::BatchReceiverInfo<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup315: pallet_collective::pallet::Call<T, I>
   **/
  ...
  /**
   * Lookup319: pallet_democracy::pallet::Call<T>
   **/
  PalletDemocracyCall: {
    _enum: {
      propose: {
  ...
  /**
   * Lookup320: frame_support::traits::preimages::Bounded<framenode_runtime::RuntimeCall>
   **/
  ...
  /**
   * Lookup322: pallet_democracy::conviction::Conviction
   **/
  PalletDemocracyConviction: {
    _enum: ['None', 'Locked1x', 'Locked2x', 'Locked3x', 'Locked4x', 'Locked5x', 'Locked6x']
  },
  /**
   * Lookup324: dex_api::pallet::Call<T>
   **/
  DexApiCall: 'Null',
  /**
   * Lookup325: eth_bridge::pallet::Call<T>
   **/
  EthBridgeCall: {
    _enum: {
      register_bridge: {
  ...
  /**
   * Lookup326: eth_bridge::BridgeSignatureVersion
   **/
  EthBridgeBridgeSignatureVersion: {
    _enum: ['V1', 'V2', 'V3']
  },
  /**
   * Lookup327: eth_bridge::requests::IncomingRequestKind
   **/
  ...
  /**
   * Lookup328: eth_bridge::requests::IncomingTransactionRequestKind
   **/
  ...
  /**
   * Lookup329: eth_bridge::requests::IncomingMetaRequestKind
   **/
  EthBridgeRequestsIncomingMetaRequestKind: {
    _enum: ['CancelOutgoingRequest', 'MarkAsDone']
  },
  /**
   * Lookup331: eth_bridge::requests::IncomingRequest<T>
   **/
  ...
  /**
   * Lookup332: eth_bridge::requests::incoming::IncomingTransfer<T>
   **/
  ...
  /**
   * Lookup333: eth_bridge::requests::AssetKind
   **/
  EthBridgeRequestsAssetKind: {
    _enum: ['Thischain', 'Sidechain', 'SidechainOwned']
  },
  /**
   * Lookup334: eth_bridge::requests::incoming::IncomingAddToken<T>
   **/
  ...
  /**
   * Lookup335: eth_bridge::requests::incoming::IncomingChangePeers<T>
   **/
  ...
  /**
   * Lookup336: eth_bridge::requests::incoming::IncomingCancelOutgoingRequest<T>
   **/
  ...
  /**
   * Lookup337: eth_bridge::requests::OutgoingRequest<T>
   **/
  ...
  /**
   * Lookup338: eth_bridge::requests::outgoing::OutgoingTransfer<T>
   **/
  ...
  /**
   * Lookup339: eth_bridge::requests::outgoing::OutgoingAddAsset<T>
   **/
  ...
  /**
   * Lookup340: eth_bridge::requests::outgoing::OutgoingAddToken<T>
   **/
  ...
  /**
   * Lookup341: eth_bridge::requests::outgoing::OutgoingAddPeer<T>
   **/
  ...
  /**
   * Lookup342: eth_bridge::requests::outgoing::OutgoingRemovePeer<T>
   **/
  ...
  /**
   * Lookup344: eth_bridge::requests::outgoing::OutgoingPrepareForMigration<T>
   **/
  ...
  /**
   * Lookup345: eth_bridge::requests::outgoing::OutgoingMigrate<T>
   **/
  ...
  /**
   * Lookup346: eth_bridge::requests::outgoing::OutgoingAddPeerCompat<T>
   **/
  ...
  /**
   * Lookup347: eth_bridge::requests::outgoing::OutgoingRemovePeerCompat<T>
   **/
  ...
  /**
   * Lookup348: eth_bridge::requests::incoming::IncomingMarkAsDoneRequest<T>
   **/
  ...
  /**
   * Lookup349: eth_bridge::requests::incoming::IncomingPrepareForMigration<T>
   **/
  ...
  /**
   * Lookup350: eth_bridge::requests::incoming::IncomingMigrate<T>
   **/
  ...
  /**
   * Lookup351: eth_bridge::requests::incoming::IncomingChangePeersCompat<T>
   **/
  ...
  /**
   * Lookup352: eth_bridge::requests::incoming::ChangePeersContract
   **/
  EthBridgeRequestsIncomingChangePeersContract: {
    _enum: ['XOR', 'VAL']
  },
  /**
   * Lookup353: eth_bridge::requests::LoadIncomingRequest<T>
   **/
  ...
  /**
   * Lookup354: eth_bridge::requests::LoadIncomingTransactionRequest<T>
   **/
  ...
  /**
   * Lookup355: eth_bridge::requests::LoadIncomingMetaRequest<T>
   **/
  ...
  /**
   * Lookup357: eth_bridge::offchain::SignatureParams
   **/
  ...
  /**
   * Lookup358: pswap_distribution::pallet::Call<T>
   **/
  ...
  /**
   * Lookup363: iroha_migration::pallet::Call<T>
   **/
  IrohaMigrationCall: {
    _enum: {
      migrate: {
  ...
  /**
   * Lookup364: pallet_membership::pallet::Call<T, I>
   **/
  ...
  /**
   * Lookup365: pallet_elections_phragmen::pallet::Call<T>
   **/
  ...
  /**
   * Lookup366: pallet_elections_phragmen::Renouncing
   **/
  ...
  /**
   * Lookup367: vested_rewards::pallet::Call<T>
   **/
  VestedRewardsCall: {
    _enum: {
      claim_rewards: 'Null',
  ...
  /**
   * Lookup374: pallet_identity::pallet::Call<T>
   **/
  PalletIdentityCall: {
    _enum: {
      add_registrar: {
  ...
  /**
   * Lookup375: pallet_identity::types::IdentityInfo<FieldLimit>
   **/
  ...
  /**
   * Lookup411: pallet_identity::types::BitFlags<pallet_identity::types::IdentityField>
   **/
  ...
  /**
   * Lookup412: pallet_identity::types::IdentityField
   **/
  ...
  /**
   * Lookup413: pallet_identity::types::Judgement<Balance>
   **/
  ...
  /**
   * Lookup415: ceres_staking::pallet::Call<T>
   **/
  CeresStakingCall: {
    _enum: {
      deposit: {
  ...
  /**
   * Lookup416: ceres_liquidity_locker::pallet::Call<T>
   **/
  ...
  /**
   * Lookup417: ceres_token_locker::pallet::Call<T>
   **/
  ...
  /**
   * Lookup418: ceres_governance_platform::pallet::Call<T>
   **/
  ...
  /**
   * Lookup419: ceres_launchpad::pallet::Call<T>
   **/
  CeresLaunchpadCall: {
    _enum: {
      create_ilo: {
  ...
  /**
   * Lookup420: demeter_farming_platform::pallet::Call<T>
   **/
  ...
  /**
   * Lookup421: pallet_bags_list::pallet::Call<T, I>
   **/
  PalletBagsListCall: {
    _enum: {
      rebag: {
  ...
  /**
   * Lookup422: pallet_election_provider_multi_phase::pallet::Call<T>
   **/
  ...
  /**
   * Lookup423: pallet_election_provider_multi_phase::RawSolution<framenode_runtime::NposCompactSolution24>
   **/
  ...
  /**
   * Lookup424: framenode_runtime::NposCompactSolution24
   **/
  ...
  /**
   * Lookup499: pallet_election_provider_multi_phase::SolutionOrSnapshotSize
   **/
  ...
  /**
   * Lookup503: sp_npos_elections::Support<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup504: band::pallet::Call<T, I>
   **/
  BandCall: {
    _enum: {
      relay: {
  ...
  /**
   * Lookup507: oracle_proxy::pallet::Call<T>
   **/
  OracleProxyCall: {
    _enum: {
      enable_oracle: {
  ...
  /**
   * Lookup508: hermes_governance_platform::pallet::Call<T>
   **/
  ...
  /**
   * Lookup509: ethereum_light_client::pallet::Call<T>
   **/
  ...
  /**
   * Lookup510: bridge_types::network_config::NetworkConfig
   **/
  ...
  /**
   * Lookup511: bridge_types::network_config::Consensus
   **/
  ...
  /**
   * Lookup512: bridge_types::difficulty::ForkConfig
   **/
  ...
  /**
   * Lookup513: bridge_types::difficulty::ClassicForkConfig
   **/
  ...
  /**
   * Lookup514: bridge_types::header::Header
   **/
  BridgeTypesHeader: {
    parentHash: 'H256',
    timestamp: 'u64',
  ...
  /**
   * Lookup519: bridge_types::ethashproof::DoubleNodeWithMerkleProof
   **/
  ...
  /**
   * Lookup523: bridge_types::ethashproof::MixNonce
   **/
  BridgeTypesEthashproofMixNonce: '[u8;32]',
  /**
   * Lookup524: sp_runtime::MultiSignature
   **/
  ...
  /**
   * Lookup527: bridge_inbound_channel::pallet::Call<T>
   **/
  ...
  /**
   * Lookup528: bridge_types::types::Message
   **/
  BridgeTypesMessage: {
    data: 'Bytes',
  ...
  /**
   * Lookup529: bridge_types::types::Proof
   **/
  BridgeTypesProof: {
    blockHash: 'H256',
    txIndex: 'u32',
  ...
  /**
   * Lookup530: eth_app::pallet::Call<T>
   **/
  EthAppCall: {
    _enum: {
      burn: {
  ...
  /**
   * Lookup531: erc20_app::pallet::Call<T>
   **/
  Erc20AppCall: {
    _enum: {
      mint: {
  ...
  /**
   * Lookup532: migration_app::pallet::Call<T>
   **/
  MigrationAppCall: {
    _enum: {
      migrate_erc20: {
  ...
  /**
   * Lookup535: evm_bridge_proxy::pallet::Call<T>
   **/
  EvmBridgeProxyCall: {
    _enum: {
      burn: {
  ...
  /**
   * Lookup536: bridge_types::GenericNetworkId
   **/
  ...
  /**
   * Lookup538: beefy_light_client::pallet::Call<T>
   **/
  ...
  /**
   * Lookup539: sp_beefy::mmr::BeefyAuthoritySet<primitive_types::H256>
   **/
  ...
  /**
   * Lookup540: sp_beefy::commitment::Commitment<TBlockNumber>
   **/
  SpBeefyCommitment: {
  ...
  /**
   * Lookup541: sp_beefy::payload::Payload
   **/
  SpBeefyPayload: 'Vec<([u8;2],Bytes)>',
  /**
   * Lookup544: bridge_common::beefy_types::ValidatorProof
   **/
  ...
  /**
   * Lookup547: bitvec::order::Msb0
   **/
  BitvecOrderMsb0: 'Null',
  /**
   * Lookup549: sp_beefy::mmr::MmrLeaf<BlockNumber, primitive_types::H256, primitive_types::H256, bridge_types::types::LeafExtraData<primitive_types::H256, primitive_types::H256>>
   **/
  SpBeefyMmrMmrLeaf: {
    version: 'u8',
  ...
  /**
   * Lookup550: bridge_types::types::LeafExtraData<primitive_types::H256, primitive_types::H256>
   **/
  ...
  /**
   * Lookup553: bridge_common::simplified_proof::Proof<primitive_types::H256>
   **/
  ...
  /**
   * Lookup554: pallet_preimage::pallet::Call<T>
   **/
  PalletPreimageCall: {
    _enum: {
      note_preimage: {
  ...
  /**
   * Lookup555: substrate_bridge_channel::inbound::pallet::Call<T>
   **/
  ...
  /**
   * Lookup556: beefy_light_client::ProvedSubstrateBridgeMessage<Message>
   **/
  BeefyLightClientProvedSubstrateBridgeMessage: {
    message: 'Vec<BridgeTypesParachainMessage>',
    proof: 'BridgeCommonSimplifiedProofProof',
    leaf: 'SpBeefyMmrMmrLeaf',
    digest: 'BridgeTypesAuxiliaryDigest'
  },
  /**
   * Lookup558: bridge_types::types::ParachainMessage<Balance>
   **/
  BridgeTypesParachainMessage: {
    payload: 'Bytes',
    nonce: 'u64',
    timestamp: 'u64',
    fee: 'u128'
  ...
  /**
   * Lookup559: bridge_types::types::AuxiliaryDigest
   **/
  BridgeTypesAuxiliaryDigest: {
    logs: 'Vec<BridgeTypesAuxiliaryDigestItem>'
  },
  /**
   * Lookup561: bridge_types::types::AuxiliaryDigestItem
   **/
  ...
  /**
   * Lookup562: substrate_bridge_app::pallet::Call<T>
   **/
  ...
  /**
   * Lookup563: bridge_types::types::AssetKind
   **/
  BridgeTypesAssetKind: {
    _enum: ['Thischain', 'Sidechain']
  },
  /**
   * Lookup564: xcm::v3::multiasset::AssetId
   **/
  ...
  /**
   * Lookup565: pallet_sudo::pallet::Call<T>
   **/
  PalletSudoCall: {
    _enum: {
      sudo: {
  ...
  /**
   * Lookup566: faucet::pallet::Call<T>
   **/
  FaucetCall: {
    _enum: {
      transfer: {
  ...
  /**
   * Lookup568: pallet_multisig::pallet::Error<T>
   **/
  PalletMultisigError: {
  ...
  /**
   * Lookup569: pallet_utility::pallet::Error<T>
   **/
  PalletUtilityError: {
    _enum: ['TooManyCalls']
  },
  /**
   * Lookup570: pallet_staking::sora::DurationWrapper
   **/
  ...
  /**
   * Lookup578: pallet_staking::ActiveEraInfo
   **/
  ...
  /**
   * Lookup592: pallet_staking::pallet::pallet::Error<T>
   **/
  ...
  /**
   * Lookup600: pallet_grandpa::StoredState<N>
   **/
  ...
  /**
   * Lookup601: pallet_grandpa::StoredPendingChange<N, Limit>
   **/
  ...
  /**
   * Lookup603: pallet_grandpa::pallet::Error<T>
   **/
  PalletGrandpaError: {
    _enum: ['PauseFailed', 'ResumeFailed', 'ChangePending', 'TooSoon', 'InvalidKeyOwnershipProof', 'InvalidEquivocationProof', 'DuplicateOffenceReport']
  },
  /**
   * Lookup607: pallet_im_online::BoundedOpaqueNetworkState<PeerIdEncodingLimit, MultiAddrEncodingLimit, AddressesLimit>
   **/
  ...
  /**
   * Lookup611: pallet_im_online::pallet::Error<T>
   **/
  PalletImOnlineError: {
    _enum: ['InvalidKey', 'DuplicatedHeartbeat']
  },
  /**
   * Lookup614: orml_tokens::BalanceLock<Balance>
   **/
  ...
  /**
   * Lookup616: orml_tokens::AccountData<Balance>
   **/
  ...
  /**
   * Lookup618: orml_tokens::ReserveData<ReserveIdentifier, Balance>
   **/
  ...
  /**
   * Lookup627: assets::AssetRecordArg<T>
   **/
  ...
  /**
   * Lookup629: common::primitives::AssetIdExtraAssetRecordArg<DEXId, common::primitives::LiquiditySourceType, AccountId>
   **/
  ...
  /**
   * Lookup630: assets::pallet::Error<T>
   **/
  AssetsError: {
  ...
  /**
   * Lookup631: common::primitives::DEXInfo<common::primitives::AssetId32<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup632: dex_manager::pallet::Error<T>
   **/
  DexManagerError: {
    _enum: ['DEXIdAlreadyExists', 'DEXDoesNotExist', 'InvalidFeeValue', 'InvalidAccountId']
  },
  /**
   * Lookup635: multicollateral_bonding_curve_pool::DistributionAccounts<multicollateral_bonding_curve_pool::DistributionAccountData<multicollateral_bonding_curve_pool::DistributionAccount<sp_core::crypto::AccountId32, common::primitives::TechAccountId<sp_core::crypto::AccountId32, common::primitives::TechAssetId<common::primitives::PredefinedAssetId>, DEXId>>>>
   **/
  ...
  /**
   * Lookup636: multicollateral_bonding_curve_pool::DistributionAccountData<multicollateral_bonding_curve_pool::DistributionAccount<sp_core::crypto::AccountId32, common::primitives::TechAccountId<sp_core::crypto::AccountId32, common::primitives::TechAssetId<common::primitives::PredefinedAssetId>, DEXId>>>
   **/
  ...
  /**
   * Lookup637: multicollateral_bonding_curve_pool::DistributionAccount<sp_core::crypto::AccountId32, common::primitives::TechAccountId<sp_core::crypto::AccountId32, common::primitives::TechAssetId<common::primitives::PredefinedAssetId>, DEXId>>
   **/
  ...
  /**
   * Lookup640: multicollateral_bonding_curve_pool::pallet::Error<T>
   **/
  ...
  /**
   * Lookup641: technical::pallet::Error<T>
   **/
  TechnicalError: {
  ...
  /**
   * Lookup644: pool_xyk::pallet::Error<T>
   **/
  PoolXykError: {
  ...
  /**
   * Lookup645: liquidity_proxy::pallet::Error<T>
   **/
  LiquidityProxyError: {
  ...
  /**
   * Lookup647: pallet_collective::Votes<sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup648: pallet_collective::pallet::Error<T, I>
   **/
  PalletCollectiveError: {
    _enum: ['NotMember', 'DuplicateProposal', 'ProposalMissing', 'WrongIndex', 'DuplicateVote', 'AlreadyInitialized', 'TooEarly', 'TooManyProposals', 'WrongProposalWeight', 'WrongProposalLength']
  },
  /**
   * Lookup656: pallet_democracy::types::ReferendumInfo<BlockNumber, frame_support::traits::preimages::Bounded<framenode_runtime::RuntimeCall>, Balance>
   **/
  ...
  /**
   * Lookup657: pallet_democracy::types::ReferendumStatus<BlockNumber, frame_support::traits::preimages::Bounded<framenode_runtime::RuntimeCall>, Balance>
   **/
  ...
  /**
   * Lookup658: pallet_democracy::types::Tally<Balance>
   **/
  ...
  /**
   * Lookup659: pallet_democracy::vote::Voting<Balance, sp_core::crypto::AccountId32, BlockNumber, MaxVotes>
   **/
  ...
  /**
   * Lookup663: pallet_democracy::types::Delegations<Balance>
   **/
  ...
  /**
   * Lookup664: pallet_democracy::vote::PriorLock<BlockNumber, Balance>
   **/
  PalletDemocracyVotePriorLock: '(u32,u128)',
  /**
   * Lookup668: pallet_democracy::pallet::Error<T>
   **/
  ...
  /**
   * Lookup669: eth_bridge::requests::OffchainRequest<T>
   **/
  ...
  /**
   * Lookup670: eth_bridge::requests::RequestStatus
   **/
  ...
  /**
   * Lookup677: eth_bridge::requests::outgoing::EthPeersSync
   **/
  ...
  /**
   * Lookup678: eth_bridge::BridgeStatus
   **/
  EthBridgeBridgeStatus: {
    _enum: ['Initialized', 'Migrating']
  },
  /**
   * Lookup682: eth_bridge::pallet::Error<T>
   **/
  EthBridgeError: {
  ...
  /**
   * Lookup685: pswap_distribution::pallet::Error<T>
   **/
  ...
  /**
   * Lookup691: pallet_scheduler::Scheduled<Name, frame_support::traits::preimages::Bounded<framenode_runtime::RuntimeCall>, BlockNumber, framenode_runtime::OriginCaller, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup696: iroha_migration::PendingMultisigAccount<T>
   **/
  ...
  /**
   * Lookup697: iroha_migration::pallet::Error<T>
   **/
  IrohaMigrationError: {
  ...
  /**
   * Lookup699: pallet_membership::pallet::Error<T, I>
   **/
  PalletMembershipError: {
    _enum: ['AlreadyMember', 'NotMember', 'TooManyMembers']
  },
  /**
   * Lookup701: pallet_elections_phragmen::SeatHolder<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup702: pallet_elections_phragmen::Voter<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup703: pallet_elections_phragmen::pallet::Error<T>
   **/
  ...
  /**
   * Lookup704: vested_rewards::RewardInfo
   **/
  ...
  /**
   * Lookup705: vested_rewards::CrowdloanReward
   **/
  ...
  /**
   * Lookup706: vested_rewards::pallet::Error<T>
   **/
  VestedRewardsError: {
  ...
  /**
   * Lookup707: pallet_identity::types::Registration<Balance, MaxJudgements, MaxAdditionalFields>
   **/
  ...
  /**
   * Lookup715: pallet_identity::types::RegistrarInfo<Balance, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup719: farming::PoolFarmer<T>
   **/
  FarmingPoolFarmer: {
    account: 'AccountId32',
    block: 'u32',
  ...
  /**
   * Lookup720: farming::pallet::Error<T>
   **/
  FarmingError: {
    _enum: ['IncRefError']
  },
  /**
   * Lookup721: xst::pallet::Error<T>
   **/
  XstError: {
  ...
  /**
   * Lookup722: price_tools::AggregatedPriceInfo
   **/
  ...
  /**
   * Lookup723: price_tools::PriceInfo
   **/
  PriceToolsPriceInfo: {
    priceFailures: 'u32',
    spotPrices: 'Vec<u128>',
  ...
  /**
   * Lookup724: price_tools::pallet::Error<T>
   **/
  PriceToolsError: {
  ...
  /**
   * Lookup725: ceres_staking::StakingInfo
   **/
  ...
  /**
   * Lookup726: ceres_staking::pallet::Error<T>
   **/
  CeresStakingError: {
    _enum: ['StakingPoolIsFull', 'Unauthorized']
  },
  /**
   * Lookup727: ceres_liquidity_locker::StorageVersion
   **/
  CeresLiquidityLockerStorageVersion: {
    _enum: ['V1', 'V2']
  },
  /**
   * Lookup729: ceres_liquidity_locker::LockInfo<Balance, Moment, common::primitives::AssetId32<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup730: ceres_liquidity_locker::pallet::Error<T>
   **/
  ...
  /**
   * Lookup731: ceres_token_locker::StorageVersion
   **/
  CeresTokenLockerStorageVersion: {
    _enum: ['V1', 'V2']
  },
  /**
   * Lookup733: ceres_token_locker::TokenLockInfo<Balance, Moment, common::primitives::AssetId32<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup734: ceres_token_locker::pallet::Error<T>
   **/
  ...
  /**
   * Lookup736: ceres_governance_platform::VotingInfo
   **/
  ...
  /**
   * Lookup737: ceres_governance_platform::PollInfo<Moment>
   **/
  ...
  /**
   * Lookup738: ceres_governance_platform::StorageVersion
   **/
  CeresGovernancePlatformStorageVersion: {
    _enum: ['V1', 'V2']
  },
  /**
   * Lookup739: ceres_governance_platform::pallet::Error<T>
   **/
  ...
  /**
   * Lookup740: ceres_launchpad::ILOInfo<Balance, sp_core::crypto::AccountId32, Moment, common::primitives::AssetId32<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup741: ceres_launchpad::ContributorsVesting<Balance, Moment>
   **/
  ...
  /**
   * Lookup742: ceres_launchpad::TeamVesting<Balance, Moment>
   **/
  ...
  /**
   * Lookup744: ceres_launchpad::ContributionInfo<Balance>
   **/
  ...
  /**
   * Lookup745: ceres_launchpad::pallet::Error<T>
   **/
  CeresLaunchpadError: {
  ...
  /**
   * Lookup746: demeter_farming_platform::TokenInfo<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup748: demeter_farming_platform::UserInfo<common::primitives::AssetId32<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup750: demeter_farming_platform::PoolData<common::primitives::AssetId32<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup751: demeter_farming_platform::StorageVersion
   **/
  DemeterFarmingPlatformStorageVersion: {
    _enum: ['V1', 'V2']
  },
  /**
   * Lookup752: demeter_farming_platform::pallet::Error<T>
   **/
  ...
  /**
   * Lookup753: pallet_bags_list::list::Node<T, I>
   **/
  ...
  /**
   * Lookup754: pallet_bags_list::list::Bag<T, I>
   **/
  ...
  /**
   * Lookup756: pallet_bags_list::pallet::Error<T, I>
   **/
  PalletBagsListError: {
    _enum: {
  ...
  /**
   * Lookup757: pallet_bags_list::list::ListError
   **/
  PalletBagsListListListError: {
    _enum: ['Duplicate', 'NotHeavier', 'NotInSameBag', 'NodeNotFound']
  },
  /**
   * Lookup758: pallet_election_provider_multi_phase::ReadySolution<T>
   **/
  ...
  /**
   * Lookup760: pallet_election_provider_multi_phase::RoundSnapshot<T>
   **/
  ...
  /**
   * Lookup766: pallet_election_provider_multi_phase::signed::SignedSubmission<sp_core::crypto::AccountId32, Balance, framenode_runtime::NposCompactSolution24>
   **/
  ...
  /**
   * Lookup767: pallet_election_provider_multi_phase::pallet::Error<T>
   **/
  ...
  /**
   * Lookup776: hermes_governance_platform::HermesPollInfo<sp_core::crypto::AccountId32, Moment>
   **/
  ...
  /**
   * Lookup777: hermes_governance_platform::pallet::Error<T>
   **/
  ...
  /**
   * Lookup781: ethereum_light_client::PruningRange
   **/
  ...
  /**
   * Lookup783: ethereum_light_client::StoredHeader<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup785: ethereum_light_client::pallet::Error<T>
   **/
  ...
  /**
   * Lookup786: bridge_inbound_channel::pallet::Error<T>
   **/
  ...
  /**
   * Lookup788: bridge_outbound_channel::Message
   **/
  ...
  /**
   * Lookup795: erc20_app::pallet::Error<T>
   **/
  Erc20AppError: {
  ...
  /**
   * Lookup796: migration_app::pallet::Error<T>
   **/
  MigrationAppError: {
  ...
  /**
   * Lookup799: evm_bridge_proxy::BridgeRequest<sp_core::crypto::AccountId32, common::primitives::AssetId32<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup800: evm_bridge_proxy::pallet::Error<T>
   **/
  EvmBridgeProxyError: {
    _enum: ['PathIsNotAvailable', 'WrongAccountKind']
  },
  /**
   * Lookup802: beefy_light_client::pallet::Error<T>
   **/
  ...
  /**
   * Lookup803: pallet_preimage::RequestStatus<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup806: pallet_preimage::pallet::Error<T>
   **/
  PalletPreimageError: {
    _enum: ['TooBig', 'AlreadyNoted', 'NotAuthorized', 'NotNoted', 'Requested', 'NotRequested']
  },
  /**
   * Lookup807: substrate_bridge_channel::inbound::pallet::Error<T>
   **/
  ...
  /**
   * Lookup808: substrate_bridge_channel::outbound::pallet::Error<T>
   **/
  SubstrateBridgeChannelOutboundPalletError: {
    _enum: ['PayloadTooLarge', 'QueueSizeLimitReached', 'MaxGasTooBig', 'NoFunds', 'Overflow', 'ChannelExists']
  },
  /**
   * Lookup810: substrate_bridge_app::pallet::Error<T>
   **/
  ...
  /**
   * Lookup812: faucet::pallet::Error<T>
   **/
  FaucetError: {
  ...
  /**
   * Lookup822: framenode_runtime::extensions::ChargeTransactionPayment<T>
   **/
  FramenodeRuntimeExtensionsChargeTransactionPayment: 'PalletTransactionPaymentChargeTransactionPayment',
  /**
   * Lookup823: pallet_transaction_payment::ChargeTransactionPayment<T>
   **/
  PalletTransactionPaymentChargeTransactionPayment: 'Compact<u128>',
  /**
   * Lookup824: framenode_runtime::Runtime
   **/
