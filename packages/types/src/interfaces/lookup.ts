...
export default {
  ...
  /**
   * Lookup95: pallet_collective::pallet::Event<T, I>
   **/
  ...
  /**
   * Lookup97: pallet_democracy::pallet::Event<T>
   **/
  ...
  /**
   * Lookup98: pallet_democracy::vote_threshold::VoteThreshold
   **/
  PalletDemocracyVoteThreshold: {
    _enum: ['SuperMajorityApprove', 'SuperMajorityAgainst', 'SimpleMajority']
  },
  /**
   * Lookup99: pallet_democracy::vote::AccountVote<Balance>
   **/
  ...
  /**
   * Lookup101: dex_api::pallet::Event<T>
   **/
  DexApiEvent: {
    _enum: {
      LiquiditySourceEnabled: 'CommonPrimitivesLiquiditySourceType',
  ...
  /**
   * Lookup102: eth_bridge::pallet::Event<T>
   **/
  EthBridgeEvent: {
    _enum: {
  ...
  /**
   * Lookup103: pswap_distribution::pallet::Event<T>
   **/
  ...
  /**
   * Lookup109: iroha_migration::pallet::Event<T>
   **/
  IrohaMigrationEvent: {
    _enum: {
  ...
  /**
   * Lookup112: pallet_elections_phragmen::pallet::Event<T>
   **/
  ...
  /**
   * Lookup115: vested_rewards::pallet::Event<T>
   **/
  VestedRewardsEvent: {
    _enum: {
      RewardsVested: 'u128',
  ...
  /**
   * Lookup116: common::primitives::RewardReason
   **/
  ...
  /**
   * Lookup117: pallet_identity::pallet::Event<T>
   **/
  PalletIdentityEvent: {
    _enum: {
      IdentitySet: {
  ...
  /**
   * Lookup120: price_tools::pallet::Event<T>
   **/
  PriceToolsEvent: 'Null',
  /**
   * Lookup121: ceres_staking::pallet::Event<T>
   **/
  CeresStakingEvent: {
    _enum: {
  ...
  /**
   * Lookup122: ceres_liquidity_locker::pallet::Event<T>
   **/
  ...
  /**
   * Lookup123: ceres_token_locker::pallet::Event<T>
   **/
  ...
  /**
   * Lookup124: ceres_governance_platform::pallet::Event<T>
   **/
  ...
  /**
   * Lookup127: ceres_launchpad::pallet::Event<T>
   **/
  CeresLaunchpadEvent: {
    _enum: {
  ...
  /**
   * Lookup128: demeter_farming_platform::pallet::Event<T>
   **/
  ...
  /**
   * Lookup129: pallet_bags_list::pallet::Event<T, I>
   **/
  PalletBagsListEvent: {
    _enum: {
      Rebagged: {
  ...
  /**
   * Lookup130: pallet_election_provider_multi_phase::pallet::Event<T>
   **/
  ...
  /**
   * Lookup131: pallet_election_provider_multi_phase::ElectionCompute
   **/
  PalletElectionProviderMultiPhaseElectionCompute: {
    _enum: ['OnChain', 'Signed', 'Unsigned', 'Fallback', 'Emergency']
  },
  /**
   * Lookup133: sp_npos_elections::ElectionScore
   **/
  ...
  /**
   * Lookup134: pallet_election_provider_multi_phase::Phase<Bn>
   **/
  ...
  /**
   * Lookup136: band::pallet::Event<T, I>
   **/
  BandEvent: {
    _enum: {
  ...
  /**
   * Lookup140: oracle_proxy::pallet::Event<T>
   **/
  OracleProxyEvent: {
    _enum: {
  ...
  /**
   * Lookup141: common::primitives::Oracle
   **/
  CommonPrimitivesOracle: {
    _enum: ['BandChainFeed']
  },
  /**
   * Lookup142: hermes_governance_platform::pallet::Event<T>
   **/
  ...
  /**
   * Lookup145: pallet_preimage::pallet::Event<T>
   **/
  PalletPreimageEvent: {
    _enum: {
      Noted: {
  ...
  /**
   * Lookup146: order_book::pallet::Event<T>
   **/
  OrderBookEvent: {
    _enum: {
      OrderBookCreated: {
  ...
  /**
   * Lookup147: order_book::types::OrderBookId<common::primitives::AssetId32<common::primitives::_allowed_deprecated::PredefinedAssetId>, DEXId>
   **/
  ...
  /**
   * Lookup148: order_book::types::OrderBookStatus
   **/
  OrderBookOrderBookStatus: {
    _enum: ['Trade', 'PlaceAndCancel', 'OnlyCancel', 'Stop']
  },
  /**
   * Lookup149: common::primitives::PriceVariant
   **/
  CommonPrimitivesPriceVariant: {
    _enum: ['Buy', 'Sell']
  },
  /**
   * Lookup150: common::balance_unit::BalanceUnit
   **/
  CommonBalanceUnit: {
    inner: 'u128',
    isDivisible: 'bool'
  ...
  /**
   * Lookup151: order_book::types::OrderAmount
   **/
  ...
  /**
   * Lookup152: order_book::types::CancelReason
   **/
  OrderBookCancelReason: {
    _enum: ['Manual', 'Expired', 'Aligned']
  },
  /**
   * Lookup153: kensetsu::pallet::Event<T>
   **/
  KensetsuEvent: {
    _enum: {
      CDPCreated: {
  ...
  /**
   * Lookup162: bridge_types::header::HeaderId
   **/
  ...
  /**
   * Lookup163: bridge_inbound_channel::pallet::Event<T>
   **/
  BridgeInboundChannelEvent: 'Null',
  /**
   * Lookup164: bridge_outbound_channel::pallet::Event<T>
   **/
  ...
  /**
   * Lookup165: dispatch::pallet::Event<T, I>
   **/
  DispatchEvent: {
    _enum: {
  ...
  /**
   * Lookup166: bridge_types::types::MessageId
   **/
  ...
  /**
   * Lookup167: bridge_types::GenericNetworkId
   **/
  ...
  /**
   * Lookup173: erc20_app::pallet::Event<T>
   **/
  Erc20AppEvent: {
    _enum: {
  ...
  /**
   * Lookup174: migration_app::pallet::Event<T>
   **/
  MigrationAppEvent: {
    _enum: {
  ...
  /**
   * Lookup175: beefy_light_client::pallet::Event<T>
   **/
  ...
  /**
   * Lookup176: substrate_bridge_channel::inbound::pallet::Event<T>
   **/
  SubstrateBridgeChannelInboundPalletEvent: 'Null',
  /**
   * Lookup177: substrate_bridge_channel::outbound::pallet::Event<T>
   **/
  ...
  /**
   * Lookup179: parachain_bridge_app::pallet::Event<T>
   **/
  ...
  /**
   * Lookup189: xcm::v3::multilocation::MultiLocation
   **/
  XcmV3MultiLocation: {
    parents: 'u8',
  ...
  /**
   * Lookup194: xcm::v3::junction::BodyId
   **/
  XcmV3JunctionBodyId: {
    _enum: {
      Unit: 'Null',
  ...
  /**
   * Lookup195: xcm::v3::junction::BodyPart
   **/
  ...
  /**
   * Lookup197: bridge_data_signer::pallet::Event<T>
   **/
  ...
  /**
   * Lookup199: sp_core::ecdsa::Public
   **/
  ...
  /**
   * Lookup206: multisig_verifier::pallet::Event<T>
   **/
  ...
  /**
   * Lookup208: faucet::pallet::Event<T>
   **/
  FaucetEvent: {
    _enum: {
  ...
  /**
   * Lookup232: sp_consensus_babe::app::Public
   **/
  SpConsensusBabeAppPublic: 'SpCoreSr25519Public',
  /**
   * Lookup235: sp_consensus_babe::digests::NextConfigDescriptor
   **/
  ...
  /**
   * Lookup237: sp_consensus_babe::AllowedSlots
   **/
  SpConsensusBabeAllowedSlots: {
    _enum: ['PrimarySlots', 'PrimaryAndSecondaryPlainSlots', 'PrimaryAndSecondaryVRFSlots']
  },
  /**
   * Lookup241: sp_consensus_babe::digests::PreDigest
   **/
  ...
  /**
   * Lookup242: sp_consensus_babe::digests::PrimaryPreDigest
   **/
  ...
  /**
   * Lookup244: sp_consensus_babe::digests::SecondaryPlainPreDigest
   **/
  ...
  /**
   * Lookup245: sp_consensus_babe::digests::SecondaryVRFPreDigest
   **/
  ...
  /**
   * Lookup246: sp_consensus_babe::BabeEpochConfiguration
   **/
  ...
  /**
   * Lookup247: pallet_babe::pallet::Call<T>
   **/
  PalletBabeCall: {
    _enum: {
      report_equivocation: {
  ...
  /**
   * Lookup248: sp_consensus_slots::EquivocationProof<sp_runtime::generic::header::Header<Number, sp_runtime::traits::BlakeTwo256>, sp_consensus_babe::app::Public>
   **/
  ...
  /**
   * Lookup252: pallet_babe::pallet::Error<T>
   **/
  PalletBabeError: {
  ...
  /**
   * Lookup277: rewards::pallet::Call<T>
   **/
  RewardsCall: {
    _enum: {
      claim: {
  ...
  /**
   * Lookup280: pallet_multisig::MultisigAccount<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup282: pallet_multisig::Multisig<BlockNumber, Balance, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup289: framenode_runtime::OriginCaller
   **/
  ...
  /**
   * Lookup294: bridge_types::types::CallOriginOutput<primitive_types::U256, primitive_types::H256, bridge_types::evm::AdditionalEVMInboundData>
   **/
  ...
  /**
   * Lookup295: bridge_types::evm::AdditionalEVMInboundData
   **/
  BridgeTypesEvmAdditionalEVMInboundData: {
    source: 'H160'
  },
  /**
   * Lookup296: bridge_types::GenericTimepoint
   **/
  ...
  /**
   * Lookup297: dispatch::RawOrigin<bridge_types::types::CallOriginOutput<bridge_types::SubNetworkId, primitive_types::H256, Additional>>
   **/
  DispatchRawOrigin: {
    origin: 'BridgeTypesCallOriginOutputSubNetworkId'
  },
  /**
   * Lookup298: bridge_types::types::CallOriginOutput<bridge_types::SubNetworkId, primitive_types::H256, Additional>
   **/
  ...
  /**
   * Lookup301: pallet_staking::RewardDestination<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup303: pallet_staking::pallet::pallet::ConfigOp<T>
   **/
  ...
  /**
   * Lookup304: pallet_staking::pallet::pallet::ConfigOp<sp_arithmetic::per_things::Percent>
   **/
  ...
  /**
   * Lookup305: pallet_staking::pallet::pallet::ConfigOp<sp_arithmetic::per_things::Perbill>
   **/
  ...
  /**
   * Lookup307: framenode_runtime::opaque::SessionKeys
   **/
  ...
  /**
   * Lookup308: sp_beefy::crypto::Public
   **/
  SpBeefyCryptoPublic: 'SpCoreEcdsaPublic',
  /**
   * Lookup309: pallet_grandpa::pallet::Call<T>
   **/
  PalletGrandpaCall: {
    _enum: {
      report_equivocation: {
  ...
  /**
   * Lookup310: sp_finality_grandpa::EquivocationProof<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup311: sp_finality_grandpa::Equivocation<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup312: finality_grandpa::Equivocation<sp_finality_grandpa::app::Public, finality_grandpa::Prevote<primitive_types::H256, N>, sp_finality_grandpa::app::Signature>
   **/
  ...
  /**
   * Lookup313: finality_grandpa::Prevote<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup314: sp_finality_grandpa::app::Signature
   **/
  ...
  /**
   * Lookup317: finality_grandpa::Equivocation<sp_finality_grandpa::app::Public, finality_grandpa::Precommit<primitive_types::H256, N>, sp_finality_grandpa::app::Signature>
   **/
  ...
  /**
   * Lookup318: finality_grandpa::Precommit<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup322: sp_core::offchain::OpaqueNetworkState
   **/
  ...
  /**
   * Lookup326: pallet_im_online::sr25519::app_sr25519::Signature
   **/
  ...
  /**
   * Lookup328: trading_pair::pallet::Call<T>
   **/
  TradingPairCall: {
    _enum: {
      register: {
  ...
  /**
   * Lookup329: assets::pallet::Call<T>
   **/
  AssetsCall: {
    _enum: {
      register: {
  ...
  /**
   * Lookup334: multicollateral_bonding_curve_pool::pallet::Call<T>
   **/
  ...
  /**
   * Lookup335: technical::pallet::Call<T>
   **/
  TechnicalCall: 'Null',
  /**
   * Lookup336: pool_xyk::pallet::Call<T>
   **/
  PoolXykCall: {
    _enum: {
      deposit_liquidity: {
  ...
  /**
   * Lookup337: liquidity_proxy::pallet::Call<T>
   **/
  LiquidityProxyCall: {
    _enum: {
      swap: {
  ...
  /**
   * Lookup338: common::swap_amount::SwapAmount<AmountType>
   **/
  CommonSwapAmount: {
    _enum: {
      WithDesiredInput: {
  ...
  /**
   * Lookup340: common::primitives::FilterMode
   **/
  CommonPrimitivesFilterMode: {
    _enum: ['Disabled', 'ForbidSelected', 'AllowSelected']
  },
  /**
   * Lookup342: liquidity_proxy::SwapBatchInfo<common::primitives::AssetId32<common::primitives::_allowed_deprecated::PredefinedAssetId>, DEXId, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup344: liquidity_proxy::BatchReceiverInfo<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup349: pallet_democracy::pallet::Call<T>
   **/
  PalletDemocracyCall: {
    _enum: {
      propose: {
  ...
  /**
   * Lookup350: frame_support::traits::preimages::Bounded<framenode_runtime::RuntimeCall>
   **/
  ...
  /**
   * Lookup352: pallet_democracy::conviction::Conviction
   **/
  PalletDemocracyConviction: {
    _enum: ['None', 'Locked1x', 'Locked2x', 'Locked3x', 'Locked4x', 'Locked5x', 'Locked6x']
  },
  /**
   * Lookup354: dex_api::pallet::Call<T>
   **/
  DexApiCall: {
    _enum: {
      enable_liquidity_source: {
  ...
  /**
   * Lookup355: eth_bridge::pallet::Call<T>
   **/
  EthBridgeCall: {
    _enum: {
      register_bridge: {
  ...
  /**
   * Lookup356: eth_bridge::BridgeSignatureVersion
   **/
  EthBridgeBridgeSignatureVersion: {
    _enum: ['V1', 'V2', 'V3']
  },
  /**
   * Lookup357: eth_bridge::requests::IncomingRequestKind
   **/
  ...
  /**
   * Lookup358: eth_bridge::requests::IncomingTransactionRequestKind
   **/
  ...
  /**
   * Lookup359: eth_bridge::requests::IncomingMetaRequestKind
   **/
  EthBridgeRequestsIncomingMetaRequestKind: {
    _enum: ['CancelOutgoingRequest', 'MarkAsDone']
  },
  /**
   * Lookup361: eth_bridge::requests::IncomingRequest<T>
   **/
  ...
  /**
   * Lookup362: eth_bridge::requests::incoming::IncomingTransfer<T>
   **/
  ...
  /**
   * Lookup363: eth_bridge::requests::AssetKind
   **/
  EthBridgeRequestsAssetKind: {
    _enum: ['Thischain', 'Sidechain', 'SidechainOwned']
  },
  /**
   * Lookup364: eth_bridge::requests::incoming::IncomingAddToken<T>
   **/
  ...
  /**
   * Lookup365: eth_bridge::requests::incoming::IncomingChangePeers<T>
   **/
  ...
  /**
   * Lookup366: eth_bridge::requests::incoming::IncomingCancelOutgoingRequest<T>
   **/
  ...
  /**
   * Lookup367: eth_bridge::requests::OutgoingRequest<T>
   **/
  ...
  /**
   * Lookup368: eth_bridge::requests::outgoing::OutgoingTransfer<T>
   **/
  ...
  /**
   * Lookup369: eth_bridge::requests::outgoing::OutgoingAddAsset<T>
   **/
  ...
  /**
   * Lookup370: eth_bridge::requests::outgoing::OutgoingAddToken<T>
   **/
  ...
  /**
   * Lookup371: eth_bridge::requests::outgoing::OutgoingAddPeer<T>
   **/
  ...
  /**
   * Lookup372: eth_bridge::requests::outgoing::OutgoingRemovePeer<T>
   **/
  ...
  /**
   * Lookup374: eth_bridge::requests::outgoing::OutgoingPrepareForMigration<T>
   **/
  ...
  /**
   * Lookup375: eth_bridge::requests::outgoing::OutgoingMigrate<T>
   **/
  ...
  /**
   * Lookup376: eth_bridge::requests::outgoing::OutgoingAddPeerCompat<T>
   **/
  ...
  /**
   * Lookup377: eth_bridge::requests::outgoing::OutgoingRemovePeerCompat<T>
   **/
  ...
  /**
   * Lookup378: eth_bridge::requests::incoming::IncomingMarkAsDoneRequest<T>
   **/
  ...
  /**
   * Lookup379: eth_bridge::requests::incoming::IncomingPrepareForMigration<T>
   **/
  ...
  /**
   * Lookup380: eth_bridge::requests::incoming::IncomingMigrate<T>
   **/
  ...
  /**
   * Lookup381: eth_bridge::requests::incoming::IncomingChangePeersCompat<T>
   **/
  ...
  /**
   * Lookup382: eth_bridge::requests::incoming::ChangePeersContract
   **/
  EthBridgeRequestsIncomingChangePeersContract: {
    _enum: ['XOR', 'VAL']
  },
  /**
   * Lookup383: eth_bridge::requests::LoadIncomingRequest<T>
   **/
  ...
  /**
   * Lookup384: eth_bridge::requests::LoadIncomingTransactionRequest<T>
   **/
  ...
  /**
   * Lookup385: eth_bridge::requests::LoadIncomingMetaRequest<T>
   **/
  ...
  /**
   * Lookup387: eth_bridge::offchain::SignatureParams
   **/
  ...
  /**
   * Lookup388: pswap_distribution::pallet::Call<T>
   **/
  ...
  /**
   * Lookup393: iroha_migration::pallet::Call<T>
   **/
  IrohaMigrationCall: {
    _enum: {
      migrate: {
  ...
  /**
   * Lookup394: pallet_membership::pallet::Call<T, I>
   **/
  ...
  /**
   * Lookup395: pallet_elections_phragmen::pallet::Call<T>
   **/
  ...
  /**
   * Lookup396: pallet_elections_phragmen::Renouncing
   **/
  ...
  /**
   * Lookup397: vested_rewards::pallet::Call<T>
   **/
  VestedRewardsCall: {
    _enum: {
      claim_rewards: 'Null',
  ...
  /**
   * Lookup407: pallet_identity::pallet::Call<T>
   **/
  PalletIdentityCall: {
    _enum: {
      add_registrar: {
  ...
  /**
   * Lookup408: pallet_identity::types::IdentityInfo<FieldLimit>
   **/
  ...
  /**
   * Lookup444: pallet_identity::types::BitFlags<pallet_identity::types::IdentityField>
   **/
  ...
  /**
   * Lookup445: pallet_identity::types::IdentityField
   **/
  ...
  /**
   * Lookup446: pallet_identity::types::Judgement<Balance>
   **/
  ...
  /**
   * Lookup448: ceres_staking::pallet::Call<T>
   **/
  CeresStakingCall: {
    _enum: {
      deposit: {
  ...
  /**
   * Lookup449: ceres_liquidity_locker::pallet::Call<T>
   **/
  ...
  /**
   * Lookup450: ceres_token_locker::pallet::Call<T>
   **/
  ...
  /**
   * Lookup451: ceres_governance_platform::pallet::Call<T>
   **/
  ...
  /**
   * Lookup456: ceres_launchpad::pallet::Call<T>
   **/
  CeresLaunchpadCall: {
    _enum: {
      create_ilo: {
  ...
  /**
   * Lookup457: demeter_farming_platform::pallet::Call<T>
   **/
  ...
  /**
   * Lookup458: pallet_bags_list::pallet::Call<T, I>
   **/
  PalletBagsListCall: {
    _enum: {
      rebag: {
  ...
  /**
   * Lookup459: pallet_election_provider_multi_phase::pallet::Call<T>
   **/
  ...
  /**
   * Lookup460: pallet_election_provider_multi_phase::RawSolution<framenode_runtime::NposCompactSolution24>
   **/
  ...
  /**
   * Lookup461: framenode_runtime::NposCompactSolution24
   **/
  ...
  /**
   * Lookup536: pallet_election_provider_multi_phase::SolutionOrSnapshotSize
   **/
  ...
  /**
   * Lookup540: sp_npos_elections::Support<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup541: band::pallet::Call<T, I>
   **/
  BandCall: {
    _enum: {
      relay: {
  ...
  /**
   * Lookup545: band::FeeCalculationParameters
   **/
  ...
  /**
   * Lookup546: oracle_proxy::pallet::Call<T>
   **/
  OracleProxyCall: {
    _enum: {
      enable_oracle: {
  ...
  /**
   * Lookup547: hermes_governance_platform::pallet::Call<T>
   **/
  ...
  /**
   * Lookup549: order_book::pallet::Call<T>
   **/
  OrderBookCall: {
    _enum: {
      create_orderbook: {
  ...
  /**
   * Lookup552: kensetsu::pallet::Call<T>
   **/
  KensetsuCall: {
    _enum: {
      create_cdp: {
  ...
  /**
   * Lookup553: bridge_proxy::pallet::Call<T>
   **/
  BridgeProxyCall: {
    _enum: {
      burn: {
  ...
  /**
   * Lookup554: bridge_types::GenericAccount<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup555: bridge_proxy::TransferLimitSettings<BlockNumber>
   **/
  ...
  /**
   * Lookup556: ethereum_light_client::pallet::Call<T>
   **/
  ...
  /**
   * Lookup557: bridge_types::network_config::NetworkConfig
   **/
  ...
  /**
   * Lookup558: bridge_types::network_config::Consensus
   **/
  ...
  /**
   * Lookup559: bridge_types::difficulty::ForkConfig
   **/
  ...
  /**
   * Lookup560: bridge_types::difficulty::ClassicForkConfig
   **/
  ...
  /**
   * Lookup561: bridge_types::header::Header
   **/
  BridgeTypesHeader: {
    parentHash: 'H256',
    timestamp: 'u64',
  ...
  /**
   * Lookup562: ethbloom::Bloom
   **/
  EthbloomBloom: '[u8;256]',
  /**
   * Lookup566: bridge_types::ethashproof::DoubleNodeWithMerkleProof
   **/
  ...
  /**
   * Lookup570: bridge_types::ethashproof::MixNonce
   **/
  ...
  /**
   * Lookup572: bridge_inbound_channel::pallet::Call<T>
   **/
  ...
  /**
   * Lookup573: bridge_types::log::Log
   **/
  BridgeTypesLog: {
    address: 'H160',
    topics: 'Vec<H256>',
  ...
  /**
   * Lookup574: bridge_types::evm::Proof
   **/
  BridgeTypesEvmProof: {
    blockHash: 'H256',
    txIndex: 'u32',
  ...
  /**
   * Lookup575: bridge_outbound_channel::pallet::Call<T>
   **/
  ...
  /**
   * Lookup576: eth_app::pallet::Call<T>
   **/
  EthAppCall: {
    _enum: {
      burn: {
  ...
  /**
   * Lookup577: erc20_app::pallet::Call<T>
   **/
  Erc20AppCall: {
    _enum: {
      mint: {
  ...
  /**
   * Lookup578: migration_app::pallet::Call<T>
   **/
  MigrationAppCall: {
    _enum: {
      migrate_erc20: {
  ...
  /**
   * Lookup581: beefy_light_client::pallet::Call<T>
   **/
  ...
  /**
   * Lookup582: sp_beefy::mmr::BeefyAuthoritySet<primitive_types::H256>
   **/
  ...
  /**
   * Lookup583: sp_beefy::commitment::Commitment<TBlockNumber>
   **/
  SpBeefyCommitment: {
  ...
  /**
   * Lookup584: sp_beefy::payload::Payload
   **/
  SpBeefyPayload: 'Vec<([u8;2],Bytes)>',
  /**
   * Lookup587: bridge_common::beefy_types::ValidatorProof
   **/
  ...
  /**
   * Lookup590: bitvec::order::Msb0
   **/
  BitvecOrderMsb0: 'Null',
  /**
   * Lookup592: sp_beefy::mmr::MmrLeaf<BlockNumber, primitive_types::H256, primitive_types::H256, bridge_types::types::LeafExtraData<primitive_types::H256, primitive_types::H256>>
   **/
  SpBeefyMmrMmrLeaf: {
    version: 'u8',
  ...
  /**
   * Lookup593: bridge_types::types::LeafExtraData<primitive_types::H256, primitive_types::H256>
   **/
  ...
  /**
   * Lookup596: bridge_common::simplified_proof::Proof<primitive_types::H256>
   **/
  ...
  /**
   * Lookup597: substrate_bridge_channel::inbound::pallet::Call<T>
   **/
  ...
  /**
   * Lookup598: bridge_types::GenericCommitment<MaxMessages, MaxPayload>
   **/
  ...
  /**
   * Lookup599: bridge_types::substrate::Commitment<MaxMessages, MaxPayload>
   **/
  ...
  /**
   * Lookup601: bridge_types::substrate::BridgeMessage<MaxPayload>
   **/
  ...
  /**
   * Lookup604: bridge_types::evm::Commitment<MaxMessages, MaxPayload>
   **/
  ...
  /**
   * Lookup606: bridge_types::evm::Message<MaxPayload>
   **/
  ...
  /**
   * Lookup608: framenode_runtime::MultiProof
   **/
  ...
  /**
   * Lookup609: beefy_light_client::SubstrateBridgeMessageProof
   **/
  ...
  /**
   * Lookup610: bridge_types::types::AuxiliaryDigest
   **/
  BridgeTypesAuxiliaryDigest: {
    logs: 'Vec<BridgeTypesAuxiliaryDigestItem>'
  },
  /**
   * Lookup612: bridge_types::types::AuxiliaryDigestItem
   **/
  ...
  /**
   * Lookup613: multisig_verifier::Proof
   **/
  ...
  /**
   * Lookup614: substrate_bridge_channel::outbound::pallet::Call<T>
   **/
  ...
  /**
   * Lookup616: bridge_types::types::AssetKind
   **/
  BridgeTypesAssetKind: {
    _enum: ['Thischain', 'Sidechain']
  },
  /**
   * Lookup617: xcm::v3::multiasset::AssetId
   **/
  ...
  /**
   * Lookup618: bridge_types::substrate::XCMAppTransferStatus
   **/
  BridgeTypesSubstrateXcmAppTransferStatus: {
    _enum: ['Success', 'XCMTransferError']
  },
  /**
   * Lookup619: bridge_data_signer::pallet::Call<T>
   **/
  ...
  /**
   * Lookup620: multisig_verifier::pallet::Call<T>
   **/
  ...
  /**
   * Lookup621: pallet_sudo::pallet::Call<T>
   **/
  PalletSudoCall: {
    _enum: {
      sudo: {
  ...
  /**
   * Lookup622: faucet::pallet::Call<T>
   **/
  FaucetCall: {
    _enum: {
      transfer: {
  ...
  /**
   * Lookup623: qa_tools::pallet::Call<T>
   **/
  QaToolsCall: {
    _enum: {
  ...
  /**
   * Lookup626: qa_tools::pallet_tools::order_book::settings::OrderBookAttributes
   **/
  ...
  /**
   * Lookup627: qa_tools::pallet_tools::order_book::settings::OrderBookFill<Moment, BlockNumber>
   **/
  ...
  /**
   * Lookup629: qa_tools::pallet_tools::order_book::settings::SideFill<Moment>
   **/
  ...
  /**
   * Lookup631: qa_tools::pallet_tools::order_book::settings::RandomAmount
   **/
  ...
  /**
   * Lookup636: pallet_utility::pallet::Error<T>
   **/
  PalletUtilityError: {
    _enum: ['TooManyCalls']
  },
  /**
   * Lookup637: pallet_staking::sora::DurationWrapper
   **/
  ...
  /**
   * Lookup658: pallet_staking::pallet::pallet::Error<T>
   **/
  ...
  /**
   * Lookup659: sp_staking::offence::OffenceDetails<sp_core::crypto::AccountId32, Offender>
   **/
  ...
  /**
   * Lookup666: pallet_grandpa::StoredState<N>
   **/
  ...
  /**
   * Lookup667: pallet_grandpa::StoredPendingChange<N, Limit>
   **/
  ...
  /**
   * Lookup669: pallet_grandpa::pallet::Error<T>
   **/
  PalletGrandpaError: {
    _enum: ['PauseFailed', 'ResumeFailed', 'ChangePending', 'TooSoon', 'InvalidKeyOwnershipProof', 'InvalidEquivocationProof', 'DuplicateOffenceReport']
  },
  /**
   * Lookup673: pallet_im_online::BoundedOpaqueNetworkState<PeerIdEncodingLimit, MultiAddrEncodingLimit, AddressesLimit>
   **/
  ...
  /**
   * Lookup677: pallet_im_online::pallet::Error<T>
   **/
  PalletImOnlineError: {
    _enum: ['InvalidKey', 'DuplicatedHeartbeat']
  },
  /**
   * Lookup680: orml_tokens::BalanceLock<Balance>
   **/
  ...
  /**
   * Lookup682: orml_tokens::AccountData<Balance>
   **/
  ...
  /**
   * Lookup684: orml_tokens::ReserveData<ReserveIdentifier, Balance>
   **/
  ...
  /**
   * Lookup693: assets::AssetRecordArg<T>
   **/
  ...
  /**
   * Lookup695: common::primitives::AssetIdExtraAssetRecordArg<DEXId, common::primitives::LiquiditySourceType, AccountId>
   **/
  ...
  /**
   * Lookup696: assets::pallet::Error<T>
   **/
  AssetsError: {
  ...
  /**
   * Lookup697: common::primitives::DEXInfo<common::primitives::AssetId32<common::primitives::_allowed_deprecated::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup701: multicollateral_bonding_curve_pool::DistributionAccount<sp_core::crypto::AccountId32, common::primitives::TechAccountId<sp_core::crypto::AccountId32, common::primitives::TechAssetId<common::primitives::_allowed_deprecated::PredefinedAssetId>, DEXId>>
   **/
  ...
  /**
   * Lookup704: multicollateral_bonding_curve_pool::pallet::Error<T>
   **/
  ...
  /**
   * Lookup705: technical::pallet::Error<T>
   **/
  TechnicalError: {
  ...
  /**
   * Lookup708: pool_xyk::pallet::Error<T>
   **/
  PoolXykError: {
  ...
  /**
   * Lookup709: liquidity_proxy::pallet::Error<T>
   **/
  LiquidityProxyError: {
  ...
  /**
   * Lookup711: pallet_collective::Votes<sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup712: pallet_collective::pallet::Error<T, I>
   **/
  PalletCollectiveError: {
    _enum: ['NotMember', 'DuplicateProposal', 'ProposalMissing', 'WrongIndex', 'DuplicateVote', 'AlreadyInitialized', 'TooEarly', 'TooManyProposals', 'WrongProposalWeight', 'WrongProposalLength']
  },
  /**
   * Lookup720: pallet_democracy::types::ReferendumInfo<BlockNumber, frame_support::traits::preimages::Bounded<framenode_runtime::RuntimeCall>, Balance>
   **/
  ...
  /**
   * Lookup721: pallet_democracy::types::ReferendumStatus<BlockNumber, frame_support::traits::preimages::Bounded<framenode_runtime::RuntimeCall>, Balance>
   **/
  ...
  /**
   * Lookup722: pallet_democracy::types::Tally<Balance>
   **/
  ...
  /**
   * Lookup723: pallet_democracy::vote::Voting<Balance, sp_core::crypto::AccountId32, BlockNumber, MaxVotes>
   **/
  ...
  /**
   * Lookup727: pallet_democracy::types::Delegations<Balance>
   **/
  ...
  /**
   * Lookup728: pallet_democracy::vote::PriorLock<BlockNumber, Balance>
   **/
  PalletDemocracyVotePriorLock: '(u32,u128)',
  /**
   * Lookup732: pallet_democracy::pallet::Error<T>
   **/
  ...
  /**
   * Lookup733: dex_api::pallet::Error<T>
   **/
  DexApiError: {
    _enum: ['LiquiditySourceAlreadyEnabled', 'LiquiditySourceAlreadyDisabled']
  },
  /**
   * Lookup734: eth_bridge::requests::OffchainRequest<T>
   **/
  ...
  /**
   * Lookup735: eth_bridge::requests::RequestStatus
   **/
  ...
  /**
   * Lookup742: eth_bridge::requests::outgoing::EthPeersSync
   **/
  ...
  /**
   * Lookup743: eth_bridge::BridgeStatus
   **/
  EthBridgeBridgeStatus: {
    _enum: ['Initialized', 'Migrating']
  },
  /**
   * Lookup744: eth_bridge::pallet::Error<T>
   **/
  EthBridgeError: {
  ...
  /**
   * Lookup747: pswap_distribution::pallet::Error<T>
   **/
  ...
  /**
   * Lookup753: pallet_scheduler::Scheduled<Name, frame_support::traits::preimages::Bounded<framenode_runtime::RuntimeCall>, BlockNumber, framenode_runtime::OriginCaller, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup755: pallet_scheduler::pallet::Error<T>
   **/
  PalletSchedulerError: {
    _enum: ['FailedToSchedule', 'NotFound', 'TargetBlockNumberInPast', 'RescheduleNoChange', 'Named']
  },
  /**
   * Lookup758: iroha_migration::PendingMultisigAccount<T>
   **/
  ...
  /**
   * Lookup759: iroha_migration::pallet::Error<T>
   **/
  IrohaMigrationError: {
  ...
  /**
   * Lookup761: pallet_membership::pallet::Error<T, I>
   **/
  PalletMembershipError: {
    _enum: ['AlreadyMember', 'NotMember', 'TooManyMembers']
  },
  /**
   * Lookup763: pallet_elections_phragmen::SeatHolder<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup764: pallet_elections_phragmen::Voter<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup765: pallet_elections_phragmen::pallet::Error<T>
   **/
  ...
  /**
   * Lookup766: vested_rewards::RewardInfo
   **/
  ...
  /**
   * Lookup767: vested_rewards::CrowdloanInfo<common::primitives::AssetId32<common::primitives::_allowed_deprecated::PredefinedAssetId>, BlockNumber, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup769: vested_rewards::CrowdloanUserInfo<common::primitives::AssetId32<common::primitives::_allowed_deprecated::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup770: vested_rewards::pallet::Error<T>
   **/
  VestedRewardsError: {
  ...
  /**
   * Lookup771: pallet_identity::types::Registration<Balance, MaxJudgements, MaxAdditionalFields>
   **/
  ...
  /**
   * Lookup779: pallet_identity::types::RegistrarInfo<Balance, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup781: pallet_identity::pallet::Error<T>
   **/
  PalletIdentityError: {
    _enum: ['TooManySubAccounts', 'NotFound', 'NotNamed', 'EmptyIndex', 'FeeChanged', 'NoIdentity', 'StickyJudgement', 'JudgementGiven', 'InvalidJudgement', 'InvalidIndex', 'InvalidTarget', 'TooManyFields', 'TooManyRegistrars', 'AlreadyClaimed', 'NotSub', 'NotOwned', 'JudgementForDifferentIdentity', 'JudgementPaymentFailed']
  },
  /**
   * Lookup783: farming::PoolFarmer<T>
   **/
  FarmingPoolFarmer: {
    account: 'AccountId32',
    block: 'u32',
  ...
  /**
   * Lookup784: farming::pallet::Error<T>
   **/
  FarmingError: {
    _enum: ['IncRefError']
  },
  /**
   * Lookup785: xst::SyntheticInfo<common::primitives::SymbolName>
   **/
  XstSyntheticInfo: {
    referenceSymbol: 'Bytes',
    feeRatio: 'FixnumFixedPoint'
  ...
  /**
   * Lookup787: price_tools::AggregatedPriceInfo
   **/
  ...
  /**
   * Lookup788: price_tools::PriceInfo
   **/
  PriceToolsPriceInfo: {
    priceFailures: 'u32',
    spotPrices: 'Vec<u128>',
  ...
  /**
   * Lookup789: price_tools::pallet::Error<T>
   **/
  PriceToolsError: {
  ...
  /**
   * Lookup790: ceres_staking::StakingInfo
   **/
  ...
  /**
   * Lookup791: ceres_staking::pallet::Error<T>
   **/
  CeresStakingError: {
    _enum: ['StakingPoolIsFull', 'Unauthorized']
  },
  /**
   * Lookup792: ceres_liquidity_locker::StorageVersion
   **/
  CeresLiquidityLockerStorageVersion: {
    _enum: ['V1', 'V2']
  },
  /**
   * Lookup794: ceres_liquidity_locker::LockInfo<Balance, Moment, common::primitives::AssetId32<common::primitives::_allowed_deprecated::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup795: ceres_liquidity_locker::pallet::Error<T>
   **/
  ...
  /**
   * Lookup796: ceres_token_locker::StorageVersion
   **/
  CeresTokenLockerStorageVersion: {
    _enum: ['V1', 'V2']
  },
  /**
   * Lookup798: ceres_token_locker::TokenLockInfo<Balance, Moment, common::primitives::AssetId32<common::primitives::_allowed_deprecated::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup799: ceres_token_locker::pallet::Error<T>
   **/
  ...
  /**
   * Lookup801: ceres_governance_platform::VotingInfo
   **/
  ...
  /**
   * Lookup802: ceres_governance_platform::PollInfo<common::primitives::AssetId32<common::primitives::_allowed_deprecated::PredefinedAssetId>, Moment, StringLimit, OptionsLimit, TitleLimit, DescriptionLimit>
   **/
  ...
  /**
   * Lookup803: ceres_governance_platform::StorageVersion
   **/
  CeresGovernancePlatformStorageVersion: {
    _enum: ['V1', 'V2', 'V3']
  },
  /**
   * Lookup804: ceres_governance_platform::pallet::Error<T>
   **/
  ...
  /**
   * Lookup805: ceres_launchpad::ILOInfo<Balance, sp_core::crypto::AccountId32, Moment, common::primitives::AssetId32<common::primitives::_allowed_deprecated::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup806: ceres_launchpad::ContributorsVesting<Balance, Moment>
   **/
  ...
  /**
   * Lookup807: ceres_launchpad::TeamVesting<Balance, Moment>
   **/
  ...
  /**
   * Lookup809: ceres_launchpad::ContributionInfo<Balance>
   **/
  ...
  /**
   * Lookup810: ceres_launchpad::pallet::Error<T>
   **/
  CeresLaunchpadError: {
  ...
  /**
   * Lookup811: demeter_farming_platform::TokenInfo<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup813: demeter_farming_platform::UserInfo<common::primitives::AssetId32<common::primitives::_allowed_deprecated::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup815: demeter_farming_platform::PoolData<common::primitives::AssetId32<common::primitives::_allowed_deprecated::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup816: demeter_farming_platform::StorageVersion
   **/
  DemeterFarmingPlatformStorageVersion: {
    _enum: ['V1', 'V2']
  },
  /**
   * Lookup817: demeter_farming_platform::pallet::Error<T>
   **/
  ...
  /**
   * Lookup823: pallet_election_provider_multi_phase::ReadySolution<T>
   **/
  ...
  /**
   * Lookup825: pallet_election_provider_multi_phase::RoundSnapshot<T>
   **/
  ...
  /**
   * Lookup831: pallet_election_provider_multi_phase::signed::SignedSubmission<sp_core::crypto::AccountId32, Balance, framenode_runtime::NposCompactSolution24>
   **/
  ...
  /**
   * Lookup832: pallet_election_provider_multi_phase::pallet::Error<T>
   **/
  ...
  /**
   * Lookup834: band::BandRate<BlockNumber>
   **/
  BandBandRate: {
    value: 'u128',
    lastUpdated: 'u64',
  ...
  /**
   * Lookup836: band::pallet::Error<T, I>
   **/
  BandError: {
  ...
  /**
   * Lookup839: oracle_proxy::pallet::Error<T>
   **/
  OracleProxyError: {
    _enum: ['OracleAlreadyEnabled', 'OracleAlreadyDisabled']
  },
  /**
   * Lookup840: hermes_governance_platform::HermesVotingInfo<StringLimit>
   **/
  ...
  /**
   * Lookup841: hermes_governance_platform::HermesPollInfo<sp_core::crypto::AccountId32, Moment, StringLimit, OptionsLimit, TitleLimit, DescriptionLimit>
   **/
  ...
  /**
   * Lookup842: hermes_governance_platform::StorageVersion
   **/
  HermesGovernancePlatformStorageVersion: {
    _enum: ['V1', 'V2']
  },
  /**
   * Lookup843: hermes_governance_platform::pallet::Error<T>
   **/
  ...
  /**
   * Lookup844: pallet_preimage::RequestStatus<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup848: pallet_preimage::pallet::Error<T>
   **/
  PalletPreimageError: {
    _enum: ['TooBig', 'AlreadyNoted', 'NotAuthorized', 'NotNoted', 'Requested', 'NotRequested']
  },
  /**
   * Lookup849: order_book::order_book::OrderBook<T>
   **/
  OrderBook: {
    orderBookId: 'OrderBookOrderBookId',
    status: 'OrderBookOrderBookStatus',
  ...
  /**
   * Lookup850: order_book::types::OrderBookTechStatus
   **/
  OrderBookOrderBookTechStatus: {
    _enum: ['Ready', 'Updating']
  },
  /**
   * Lookup852: order_book::limit_order::LimitOrder<T>
   **/
  OrderBookLimitOrder: {
    id: 'u128',
    owner: 'AccountId32',
  ...
  /**
   * Lookup862: order_book::pallet::Error<T>
   **/
  OrderBookError: {
  ...
  /**
   * Lookup863: kensetsu::CollateralInfo<Moment>
   **/
  ...
  /**
   * Lookup864: kensetsu::CollateralizedDebtPosition<sp_core::crypto::AccountId32, common::primitives::AssetId32<common::primitives::_allowed_deprecated::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup867: kensetsu::pallet::Error<T>
   **/
  KensetsuError: {
  ...
  /**
   * Lookup870: bridge_proxy::BridgeRequest<sp_core::crypto::AccountId32, common::primitives::AssetId32<common::primitives::_allowed_deprecated::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup871: bridge_types::types::MessageDirection
   **/
  BridgeTypesMessageDirection: {
    _enum: ['Inbound', 'Outbound']
  },
  /**
   * Lookup875: bridge_proxy::pallet::Error<T>
   **/
  BridgeProxyError: {
  ...
  /**
   * Lookup877: ethereum_light_client::PruningRange
   **/
  ...
  /**
   * Lookup879: ethereum_light_client::StoredHeader<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup881: ethereum_light_client::pallet::Error<T>
   **/
  ...
  /**
   * Lookup882: bridge_inbound_channel::pallet::Error<T>
   **/
  ...
  /**
   * Lookup883: bridge_types::types::GenericCommitmentWithBlock<BlockNumber, MaxMessages, MaxPayload>
   **/
  ...
  /**
   * Lookup890: erc20_app::pallet::Error<T>
   **/
  Erc20AppError: {
  ...
  /**
   * Lookup891: migration_app::pallet::Error<T>
   **/
  MigrationAppError: {
  ...
  /**
   * Lookup892: beefy_light_client::pallet::Error<T>
   **/
  ...
  /**
   * Lookup893: substrate_bridge_channel::inbound::pallet::Error<T>
   **/
  ...
  /**
   * Lookup894: substrate_bridge_channel::outbound::pallet::Error<T>
   **/
  ...
  /**
   * Lookup897: parachain_bridge_app::pallet::Error<T>
   **/
  ...
  /**
   * Lookup904: bridge_data_signer::pallet::Error<T>
   **/
  ...
  /**
   * Lookup905: multisig_verifier::pallet::Error<T>
   **/
  ...
  /**
   * Lookup909: faucet::pallet::Error<T>
   **/
  FaucetError: {
    _enum: ['AssetNotSupported', 'AmountAboveLimit', 'NotEnoughReserves']
  },
  /**
   * Lookup910: qa_tools::pallet::Error<T>
   **/
  QaToolsError: {
  ...
  /**
   * Lookup920: xor_fee::extension::ChargeTransactionPayment<T>
   **/
  XorFeeExtensionChargeTransactionPayment: {
    tip: 'Compact<u128>'
  },
  /**
   * Lookup921: framenode_runtime::Runtime
   **/
