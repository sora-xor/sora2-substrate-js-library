...
export default {
  ...
  /**
   * Lookup885: kensetsu::StablecoinCollateralIdentifier<common::primitives::AssetId32<common::primitives::_allowed_deprecated::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup886: kensetsu::CollateralInfo<Moment>
   **/
  ...
  /**
   * Lookup887: kensetsu::CollateralizedDebtPosition<sp_core::crypto::AccountId32, common::primitives::AssetId32<common::primitives::_allowed_deprecated::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup889: kensetsu::pallet::Error<T>
   **/
  KensetsuError: {
  ...
  /**
   * Lookup892: bridge_proxy::BridgeRequest<common::primitives::AssetId32<common::primitives::_allowed_deprecated::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup893: bridge_types::types::MessageDirection
   **/
  BridgeTypesMessageDirection: {
    _enum: ['Inbound', 'Outbound']
  },
  /**
   * Lookup896: bridge_proxy::pallet::Error<T>
   **/
  BridgeProxyError: {
  ...
  /**
   * Lookup897: bridge_channel::inbound::pallet::Error<T>
   **/
  ...
  /**
   * Lookup899: bridge_types::GenericBridgeMessage<MaxPayload>
   **/
  ...
  /**
   * Lookup901: bridge_types::types::GenericCommitmentWithBlock<BlockNumber, MaxMessages, MaxPayload>
   **/
  ...
  /**
   * Lookup902: bridge_channel::outbound::pallet::Error<T>
   **/
  ...
  /**
   * Lookup905: evm_fungible_app::BaseFeeInfo<BlockNumber>
   **/
  ...
  /**
   * Lookup906: evm_fungible_app::pallet::Error<T>
   **/
  EvmFungibleAppError: {
  ...
  /**
   * Lookup922: substrate_bridge_app::pallet::Error<T>
   **/
  ...
  /**
   * Lookup926: faucet::pallet::Error<T>
   **/
  FaucetError: {
    _enum: ['AssetNotSupported', 'AmountAboveLimit', 'NotEnoughReserves']
  },
  /**
   * Lookup927: qa_tools::pallet::Error<T>
   **/
  QaToolsError: {
  ...
  /**
   * Lookup928: apollo_platform::LendingPosition<BlockNumberFor>
   **/
  ...
  /**
   * Lookup930: apollo_platform::BorrowingPosition<BlockNumberFor>
   **/
  ...
  /**
   * Lookup933: apollo_platform::PoolInfo
   **/
  ...
  /**
   * Lookup934: apollo_platform::pallet::Error<T>
   **/
  ApolloPlatformError: {
  ...
  /**
   * Lookup936: sp_runtime::MultiSignature
   **/
  ...
  /**
   * Lookup945: xor_fee::extension::ChargeTransactionPayment<T>
   **/
  XorFeeExtensionChargeTransactionPayment: {
    tip: 'Compact<u128>'
  },
  /**
   * Lookup946: framenode_runtime::Runtime
   **/
