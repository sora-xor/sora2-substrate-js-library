...
export default {
  ...
  LiquidityProxyEvent: {
    _enum: {
      ...
      XorlessTransfer: '(CommonPrimitivesAssetId32,AccountId32,AccountId32,u128,Bytes)'
    }
  },
  /**
  ...
  /**
   * Lookup92: pallet_collective::pallet::Event<T, I>
   **/
  ...
  /**
   * Lookup94: pallet_democracy::pallet::Event<T>
   **/
  ...
  /**
   * Lookup95: pallet_democracy::vote_threshold::VoteThreshold
   **/
  PalletDemocracyVoteThreshold: {
    _enum: ['SuperMajorityApprove', 'SuperMajorityAgainst', 'SimpleMajority']
  },
  /**
   * Lookup96: pallet_democracy::vote::AccountVote<Balance>
   **/
  ...
  /**
   * Lookup98: eth_bridge::pallet::Event<T>
   **/
  EthBridgeEvent: {
    _enum: {
  ...
  /**
   * Lookup99: pswap_distribution::pallet::Event<T>
   **/
  ...
  /**
   * Lookup105: iroha_migration::pallet::Event<T>
   **/
  IrohaMigrationEvent: {
    _enum: {
  ...
  /**
   * Lookup111: vested_rewards::pallet::Event<T>
   **/
  VestedRewardsEvent: {
    _enum: {
      RewardsVested: 'u128',
  ...
  /**
   * Lookup112: common::primitives::RewardReason
   **/
  ...
  /**
   * Lookup116: price_tools::pallet::Event<T>
   **/
  PriceToolsEvent: 'Null',
  /**
   * Lookup117: ceres_staking::pallet::Event<T>
   **/
  CeresStakingEvent: {
    _enum: {
  ...
  /**
   * Lookup118: ceres_liquidity_locker::pallet::Event<T>
   **/
  ...
  /**
   * Lookup119: ceres_token_locker::pallet::Event<T>
   **/
  ...
  /**
   * Lookup120: ceres_governance_platform::pallet::Event<T>
   **/
  ...
  /**
   * Lookup121: ceres_launchpad::pallet::Event<T>
   **/
  CeresLaunchpadEvent: {
    _enum: {
  ...
  /**
   * Lookup122: demeter_farming_platform::pallet::Event<T>
   **/
  ...
  /**
   * Lookup123: pallet_bags_list::pallet::Event<T, I>
   **/
  PalletBagsListEvent: {
    _enum: {
      Rebagged: {
  ...
  /**
   * Lookup124: pallet_election_provider_multi_phase::pallet::Event<T>
   **/
  ...
  /**
   * Lookup125: pallet_election_provider_multi_phase::ElectionCompute
   **/
  PalletElectionProviderMultiPhaseElectionCompute: {
    _enum: ['OnChain', 'Signed', 'Unsigned', 'Fallback', 'Emergency']
  },
  /**
   * Lookup127: sp_npos_elections::ElectionScore
   **/
  ...
  /**
   * Lookup128: pallet_election_provider_multi_phase::Phase<Bn>
   **/
  ...
  /**
   * Lookup130: band::pallet::Event<T, I>
   **/
  BandEvent: {
    _enum: {
  ...
  /**
   * Lookup134: oracle_proxy::pallet::Event<T>
   **/
  OracleProxyEvent: {
    _enum: {
  ...
  /**
   * Lookup135: common::primitives::Oracle
   **/
  CommonPrimitivesOracle: {
    _enum: ['BandChainFeed']
  },
  /**
   * Lookup136: hermes_governance_platform::pallet::Event<T>
   **/
  ...
  /**
   * Lookup141: pallet_preimage::pallet::Event<T>
   **/
  PalletPreimageEvent: {
    _enum: {
      Noted: {
  ...
  /**
   * Lookup142: order_book::pallet::Event<T>
   **/
  OrderBookEvent: {
    _enum: {
      OrderBookCreated: {
  ...
  /**
   * Lookup143: order_book::types::OrderBookId<common::primitives::AssetId32<common::primitives::PredefinedAssetId>, DEXId>
   **/
  ...
  /**
   * Lookup144: order_book::types::OrderBookStatus
   **/
  OrderBookOrderBookStatus: {
    _enum: ['Trade', 'PlaceAndCancel', 'OnlyCancel', 'Stop']
  },
  /**
   * Lookup145: common::primitives::PriceVariant
   **/
  CommonPrimitivesPriceVariant: {
    _enum: ['Buy', 'Sell']
  },
  /**
   * Lookup146: order_book::types::OrderAmount
   **/
  ...
  /**
   * Lookup148: leaf_provider::pallet::Event<T>
   **/
  LeafProviderEvent: 'Null',
  /**
   * Lookup149: bridge_proxy::pallet::Event
   **/
  BridgeProxyEvent: {
    _enum: {
  ...
  /**
   * Lookup150: bridge_types::types::MessageStatus
   **/
  BridgeTypesMessageStatus: {
    _enum: ['InQueue', 'Committed', 'Done', 'Failed', 'Refunded', 'Approved']
  },
  /**
   * Lookup151: ethereum_light_client::pallet::Event<T>
   **/
  ...
  /**
   * Lookup154: bridge_types::header::HeaderId
   **/
  ...
  /**
   * Lookup155: bridge_inbound_channel::pallet::Event<T>
   **/
  BridgeInboundChannelEvent: 'Null',
  /**
   * Lookup156: bridge_outbound_channel::pallet::Event<T>
   **/
  ...
  /**
   * Lookup157: dispatch::pallet::Event<T, I>
   **/
  DispatchEvent: {
    _enum: {
  ...
  /**
   * Lookup158: bridge_types::types::MessageId
   **/
  ...
  /**
   * Lookup159: bridge_types::GenericNetworkId
   **/
  ...
  /**
   * Lookup160: bridge_types::SubNetworkId
   **/
  ...
  /**
   * Lookup162: eth_app::pallet::Event<T>
   **/
  EthAppEvent: {
    _enum: {
  ...
  /**
   * Lookup165: erc20_app::pallet::Event<T>
   **/
  Erc20AppEvent: {
    _enum: {
  ...
  /**
   * Lookup166: migration_app::pallet::Event<T>
   **/
  MigrationAppEvent: {
    _enum: {
  ...
  /**
   * Lookup167: beefy_light_client::pallet::Event<T>
   **/
  ...
  /**
   * Lookup168: substrate_bridge_channel::inbound::pallet::Event<T>
   **/
  SubstrateBridgeChannelInboundPalletEvent: 'Null',
  /**
   * Lookup169: substrate_bridge_channel::outbound::pallet::Event<T>
   **/
  ...
  /**
   * Lookup171: parachain_bridge_app::pallet::Event<T>
   **/
  ...
  /**
   * Lookup173: xcm::v2::multilocation::MultiLocation
   **/
  XcmV2MultiLocation: {
    parents: 'u8',
  ...
  /**
   * Lookup174: xcm::v2::multilocation::Junctions
   **/
  ...
  /**
   * Lookup175: xcm::v2::junction::Junction
   **/
  XcmV2Junction: {
    _enum: {
  ...
  /**
   * Lookup181: xcm::v3::multilocation::MultiLocation
   **/
  XcmV3MultiLocation: {
    parents: 'u8',
  ...
  /**
   * Lookup182: xcm::v3::junctions::Junctions
   **/
  XcmV3Junctions: {
    _enum: {
      Here: 'Null',
  ...
  /**
   * Lookup183: xcm::v3::junction::Junction
   **/
  XcmV3Junction: {
    _enum: {
      Parachain: 'Compact<u32>',
  ...
  /**
   * Lookup185: xcm::v3::junction::NetworkId
   **/
  ...
  /**
   * Lookup189: bridge_data_signer::pallet::Event<T>
   **/
  ...
  /**
   * Lookup191: sp_core::ecdsa::Public
   **/
  ...
  /**
   * Lookup198: multisig_verifier::pallet::Event<T>
   **/
  ...
  /**
   * Lookup200: faucet::pallet::Event<T>
   **/
  FaucetEvent: {
    _enum: {
  ...
  /**
   * Lookup233: sp_consensus_babe::digests::PreDigest
   **/
  ...
  /**
   * Lookup234: sp_consensus_babe::digests::PrimaryPreDigest
   **/
  ...
  /**
   * Lookup236: sp_consensus_babe::digests::SecondaryPlainPreDigest
   **/
  ...
  /**
   * Lookup237: sp_consensus_babe::digests::SecondaryVRFPreDigest
   **/
  ...
  /**
   * Lookup238: sp_consensus_babe::BabeEpochConfiguration
   **/
  ...
  /**
   * Lookup239: pallet_babe::pallet::Call<T>
   **/
  PalletBabeCall: {
    _enum: {
      report_equivocation: {
  ...
  /**
   * Lookup240: sp_consensus_slots::EquivocationProof<sp_runtime::generic::header::Header<Number, sp_runtime::traits::BlakeTwo256>, sp_consensus_babe::app::Public>
   **/
  ...
  /**
   * Lookup241: sp_runtime::generic::header::Header<Number, sp_runtime::traits::BlakeTwo256>
   **/
  SpRuntimeHeader: {
    parentHash: 'H256',
    number: 'Compact<u32>',
  ...
  /**
   * Lookup242: sp_runtime::traits::BlakeTwo256
   **/
  SpRuntimeBlakeTwo256: 'Null',
  /**
   * Lookup243: sp_session::MembershipProof
   **/
  ...
  /**
   * Lookup244: pallet_babe::pallet::Error<T>
   **/
  PalletBabeError: {
  ...
  /**
   * Lookup247: pallet_balances::BalanceLock<Balance>
   **/
  ...
  /**
   * Lookup248: pallet_balances::Reasons
   **/
  PalletBalancesReasons: {
    _enum: ['Fee', 'Misc', 'All']
  },
  /**
   * Lookup251: pallet_balances::ReserveData<ReserveIdentifier, Balance>
   **/
  ...
  /**
   * Lookup269: rewards::pallet::Call<T>
   **/
  RewardsCall: {
    _enum: {
      claim: {
  ...
  /**
   * Lookup272: pallet_multisig::MultisigAccount<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup275: pallet_multisig::Multisig<BlockNumber, Balance, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup278: pallet_multisig::pallet::Call<T>
   **/
  PalletMultisigCall: {
    _enum: {
      register_multisig: {
  ...
  /**
   * Lookup280: pallet_utility::pallet::Call<T>
   **/
  PalletUtilityCall: {
    _enum: {
      batch: {
  ...
  /**
   * Lookup282: framenode_runtime::OriginCaller
   **/
  ...
  /**
   * Lookup283: frame_support::dispatch::RawOrigin<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup284: pallet_collective::RawOrigin<sp_core::crypto::AccountId32, I>
   **/
  ...
  /**
   * Lookup287: bridge_types::types::CallOriginOutput<primitive_types::U256, primitive_types::H256, bridge_types::evm::AdditionalEVMInboundData>
   **/
  ...
  /**
   * Lookup288: bridge_types::evm::AdditionalEVMInboundData
   **/
  BridgeTypesEvmAdditionalEVMInboundData: {
    source: 'H160'
  },
  /**
   * Lookup289: bridge_types::GenericTimepoint
   **/
  ...
  /**
   * Lookup290: dispatch::RawOrigin<bridge_types::types::CallOriginOutput<bridge_types::SubNetworkId, primitive_types::H256, Additional>>
   **/
  DispatchRawOrigin: {
    origin: 'BridgeTypesCallOriginOutputSubNetworkId'
  },
  /**
   * Lookup291: bridge_types::types::CallOriginOutput<bridge_types::SubNetworkId, primitive_types::H256, Additional>
   **/
  ...
  SpCoreVoid: 'Null',
  /**
   * Lookup293: pallet_staking::pallet::pallet::Call<T>
   **/
  ...
  /**
   * Lookup294: pallet_staking::RewardDestination<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup296: pallet_staking::pallet::pallet::ConfigOp<T>
   **/
  ...
  /**
   * Lookup297: pallet_staking::pallet::pallet::ConfigOp<sp_arithmetic::per_things::Percent>
   **/
  ...
  /**
   * Lookup298: pallet_staking::pallet::pallet::ConfigOp<sp_arithmetic::per_things::Perbill>
   **/
  ...
  /**
   * Lookup299: pallet_session::pallet::Call<T>
   **/
  PalletSessionCall: {
    _enum: {
      set_keys: {
  ...
  /**
   * Lookup300: framenode_runtime::opaque::SessionKeys
   **/
  ...
  /**
   * Lookup301: sp_beefy::crypto::Public
   **/
  SpBeefyCryptoPublic: 'SpCoreEcdsaPublic',
  /**
   * Lookup302: pallet_grandpa::pallet::Call<T>
   **/
  PalletGrandpaCall: {
    _enum: {
      report_equivocation: {
  ...
  /**
   * Lookup303: sp_finality_grandpa::EquivocationProof<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup304: sp_finality_grandpa::Equivocation<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup305: finality_grandpa::Equivocation<sp_finality_grandpa::app::Public, finality_grandpa::Prevote<primitive_types::H256, N>, sp_finality_grandpa::app::Signature>
   **/
  ...
  /**
   * Lookup306: finality_grandpa::Prevote<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup307: sp_finality_grandpa::app::Signature
   **/
  SpFinalityGrandpaAppSignature: 'SpCoreEd25519Signature',
  /**
   * Lookup308: sp_core::ed25519::Signature
   **/
  SpCoreEd25519Signature: '[u8;64]',
  /**
   * Lookup310: finality_grandpa::Equivocation<sp_finality_grandpa::app::Public, finality_grandpa::Precommit<primitive_types::H256, N>, sp_finality_grandpa::app::Signature>
   **/
  ...
  /**
   * Lookup311: finality_grandpa::Precommit<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup315: sp_core::offchain::OpaqueNetworkState
   **/
  ...
  /**
   * Lookup319: pallet_im_online::sr25519::app_sr25519::Signature
   **/
  ...
  /**
   * Lookup321: trading_pair::pallet::Call<T>
   **/
  TradingPairCall: {
    _enum: {
      register: {
  ...
  /**
   * Lookup322: assets::pallet::Call<T>
   **/
  AssetsCall: {
    _enum: {
      register: {
  ...
  /**
   * Lookup327: multicollateral_bonding_curve_pool::pallet::Call<T>
   **/
  ...
  /**
   * Lookup328: technical::pallet::Call<T>
   **/
  TechnicalCall: 'Null',
  /**
   * Lookup329: pool_xyk::pallet::Call<T>
   **/
  PoolXykCall: {
    _enum: {
      deposit_liquidity: {
  ...
  /**
   * Lookup330: liquidity_proxy::pallet::Call<T>
   **/
  LiquidityProxyCall: {
    _enum: {
      swap: {
  ...
  /**
   * Lookup331: common::swap_amount::SwapAmount<AmountType>
   **/
  CommonSwapAmount: {
    _enum: {
      WithDesiredInput: {
  ...
  /**
   * Lookup333: common::primitives::FilterMode
   **/
  CommonPrimitivesFilterMode: {
    _enum: ['Disabled', 'ForbidSelected', 'AllowSelected']
  },
  /**
   * Lookup335: liquidity_proxy::SwapBatchInfo<common::primitives::AssetId32<common::primitives::PredefinedAssetId>, DEXId, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup337: liquidity_proxy::BatchReceiverInfo<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup338: pallet_collective::pallet::Call<T, I>
   **/
  ...
  /**
   * Lookup342: pallet_democracy::pallet::Call<T>
   **/
  PalletDemocracyCall: {
    _enum: {
      propose: {
  ...
  /**
   * Lookup343: frame_support::traits::preimages::Bounded<framenode_runtime::RuntimeCall>
   **/
  ...
  /**
   * Lookup345: pallet_democracy::conviction::Conviction
   **/
  PalletDemocracyConviction: {
    _enum: ['None', 'Locked1x', 'Locked2x', 'Locked3x', 'Locked4x', 'Locked5x', 'Locked6x']
  },
  /**
   * Lookup347: dex_api::pallet::Call<T>
   **/
  DexApiCall: 'Null',
  /**
   * Lookup348: eth_bridge::pallet::Call<T>
   **/
  EthBridgeCall: {
    _enum: {
      register_bridge: {
  ...
  /**
   * Lookup349: eth_bridge::BridgeSignatureVersion
   **/
  EthBridgeBridgeSignatureVersion: {
    _enum: ['V1', 'V2', 'V3']
  },
  /**
   * Lookup350: eth_bridge::requests::IncomingRequestKind
   **/
  ...
  /**
   * Lookup351: eth_bridge::requests::IncomingTransactionRequestKind
   **/
  ...
  /**
   * Lookup352: eth_bridge::requests::IncomingMetaRequestKind
   **/
  EthBridgeRequestsIncomingMetaRequestKind: {
    _enum: ['CancelOutgoingRequest', 'MarkAsDone']
  },
  /**
   * Lookup354: eth_bridge::requests::IncomingRequest<T>
   **/
  ...
  /**
   * Lookup355: eth_bridge::requests::incoming::IncomingTransfer<T>
   **/
  ...
  /**
   * Lookup356: eth_bridge::requests::AssetKind
   **/
  EthBridgeRequestsAssetKind: {
    _enum: ['Thischain', 'Sidechain', 'SidechainOwned']
  },
  /**
   * Lookup357: eth_bridge::requests::incoming::IncomingAddToken<T>
   **/
  ...
  /**
   * Lookup358: eth_bridge::requests::incoming::IncomingChangePeers<T>
   **/
  ...
  /**
   * Lookup359: eth_bridge::requests::incoming::IncomingCancelOutgoingRequest<T>
   **/
  ...
  /**
   * Lookup360: eth_bridge::requests::OutgoingRequest<T>
   **/
  ...
  /**
   * Lookup361: eth_bridge::requests::outgoing::OutgoingTransfer<T>
   **/
  ...
  /**
   * Lookup362: eth_bridge::requests::outgoing::OutgoingAddAsset<T>
   **/
  ...
  /**
   * Lookup363: eth_bridge::requests::outgoing::OutgoingAddToken<T>
   **/
  ...
  /**
   * Lookup364: eth_bridge::requests::outgoing::OutgoingAddPeer<T>
   **/
  ...
  /**
   * Lookup365: eth_bridge::requests::outgoing::OutgoingRemovePeer<T>
   **/
  ...
  /**
   * Lookup367: eth_bridge::requests::outgoing::OutgoingPrepareForMigration<T>
   **/
  ...
  /**
   * Lookup368: eth_bridge::requests::outgoing::OutgoingMigrate<T>
   **/
  ...
  /**
   * Lookup369: eth_bridge::requests::outgoing::OutgoingAddPeerCompat<T>
   **/
  ...
  /**
   * Lookup370: eth_bridge::requests::outgoing::OutgoingRemovePeerCompat<T>
   **/
  ...
  /**
   * Lookup371: eth_bridge::requests::incoming::IncomingMarkAsDoneRequest<T>
   **/
  ...
  /**
   * Lookup372: eth_bridge::requests::incoming::IncomingPrepareForMigration<T>
   **/
  ...
  /**
   * Lookup373: eth_bridge::requests::incoming::IncomingMigrate<T>
   **/
  ...
  /**
   * Lookup374: eth_bridge::requests::incoming::IncomingChangePeersCompat<T>
   **/
  ...
  /**
   * Lookup375: eth_bridge::requests::incoming::ChangePeersContract
   **/
  EthBridgeRequestsIncomingChangePeersContract: {
    _enum: ['XOR', 'VAL']
  },
  /**
   * Lookup376: eth_bridge::requests::LoadIncomingRequest<T>
   **/
  ...
  /**
   * Lookup377: eth_bridge::requests::LoadIncomingTransactionRequest<T>
   **/
  ...
  /**
   * Lookup378: eth_bridge::requests::LoadIncomingMetaRequest<T>
   **/
  ...
  /**
   * Lookup380: eth_bridge::offchain::SignatureParams
   **/
  ...
  /**
   * Lookup381: pswap_distribution::pallet::Call<T>
   **/
  PswapDistributionCall: {
    _enum: ['claim_incentive']
  },
  /**
   * Lookup384: pallet_scheduler::pallet::Call<T>
   **/
  PalletSchedulerCall: {
    _enum: {
      schedule: {
  ...
  /**
   * Lookup386: iroha_migration::pallet::Call<T>
   **/
  IrohaMigrationCall: {
    _enum: {
      migrate: {
  ...
  /**
   * Lookup388: pallet_elections_phragmen::pallet::Call<T>
   **/
  ...
  /**
   * Lookup389: pallet_elections_phragmen::Renouncing
   **/
  ...
  /**
   * Lookup390: vested_rewards::pallet::Call<T>
   **/
  VestedRewardsCall: {
    _enum: {
      claim_rewards: 'Null',
  ...
  /**
   * Lookup441: ceres_staking::pallet::Call<T>
   **/
  CeresStakingCall: {
    _enum: {
      deposit: {
  ...
  /**
   * Lookup442: ceres_liquidity_locker::pallet::Call<T>
   **/
  ...
  /**
   * Lookup443: ceres_token_locker::pallet::Call<T>
   **/
  ...
  /**
   * Lookup444: ceres_governance_platform::pallet::Call<T>
   **/
  ...
  /**
   * Lookup445: ceres_launchpad::pallet::Call<T>
   **/
  CeresLaunchpadCall: {
    _enum: {
      create_ilo: {
  ...
  /**
   * Lookup446: demeter_farming_platform::pallet::Call<T>
   **/
  ...
  /**
   * Lookup447: pallet_bags_list::pallet::Call<T, I>
   **/
  PalletBagsListCall: {
    _enum: {
      rebag: {
  ...
  /**
   * Lookup448: pallet_election_provider_multi_phase::pallet::Call<T>
   **/
  ...
  /**
   * Lookup449: pallet_election_provider_multi_phase::RawSolution<framenode_runtime::NposCompactSolution24>
   **/
  ...
  /**
   * Lookup450: framenode_runtime::NposCompactSolution24
   **/
  ...
  /**
   * Lookup525: pallet_election_provider_multi_phase::SolutionOrSnapshotSize
   **/
  ...
  /**
   * Lookup529: sp_npos_elections::Support<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup530: band::pallet::Call<T, I>
   **/
  BandCall: {
    _enum: {
      relay: {
  ...
  /**
   * Lookup534: band::FeeCalculationParameters
   **/
  ...
  /**
   * Lookup535: oracle_proxy::pallet::Call<T>
   **/
  OracleProxyCall: {
    _enum: {
      enable_oracle: {
  ...
  /**
   * Lookup536: hermes_governance_platform::pallet::Call<T>
   **/
  ...
  /**
   * Lookup542: order_book::pallet::Call<T>
   **/
  OrderBookCall: {
    _enum: {
      create_orderbook: {
  ...
  /**
   * Lookup545: bridge_proxy::pallet::Call<T>
   **/
  BridgeProxyCall: {
    _enum: {
      burn: {
  ...
  /**
   * Lookup547: bridge_proxy::TransferLimitSettings<BlockNumber>
   **/
  ...
  /**
   * Lookup548: ethereum_light_client::pallet::Call<T>
   **/
  ...
  /**
   * Lookup549: bridge_types::network_config::NetworkConfig
   **/
  ...
  /**
   * Lookup550: bridge_types::network_config::Consensus
   **/
  ...
  /**
   * Lookup551: bridge_types::difficulty::ForkConfig
   **/
  ...
  /**
   * Lookup552: bridge_types::difficulty::ClassicForkConfig
   **/
  ...
  /**
   * Lookup553: bridge_types::header::Header
   **/
  BridgeTypesHeader: {
    parentHash: 'H256',
    timestamp: 'u64',
  ...
  /**
   * Lookup554: ethbloom::Bloom
   **/
  EthbloomBloom: '[u8;256]',
  /**
   * Lookup558: bridge_types::ethashproof::DoubleNodeWithMerkleProof
   **/
  ...
  /**
   * Lookup562: bridge_types::ethashproof::MixNonce
   **/
  BridgeTypesEthashproofMixNonce: '[u8;32]',
  /**
   * Lookup563: sp_runtime::MultiSignature
   **/
  ...
  /**
   * Lookup564: bridge_inbound_channel::pallet::Call<T>
   **/
  ...
  /**
   * Lookup565: bridge_types::log::Log
   **/
  BridgeTypesLog: {
    address: 'H160',
    topics: 'Vec<H256>',
  ...
  /**
   * Lookup566: bridge_types::evm::Proof
   **/
  BridgeTypesEvmProof: {
    blockHash: 'H256',
    txIndex: 'u32',
  ...
  /**
   * Lookup567: eth_app::pallet::Call<T>
   **/
  EthAppCall: {
    _enum: {
      burn: {
  ...
  /**
   * Lookup568: erc20_app::pallet::Call<T>
   **/
  Erc20AppCall: {
    _enum: {
      mint: {
  ...
  /**
   * Lookup569: migration_app::pallet::Call<T>
   **/
  MigrationAppCall: {
    _enum: {
      migrate_erc20: {
  ...
  /**
   * Lookup572: beefy_light_client::pallet::Call<T>
   **/
  ...
  /**
   * Lookup573: sp_beefy::mmr::BeefyAuthoritySet<primitive_types::H256>
   **/
  ...
  /**
   * Lookup574: sp_beefy::commitment::Commitment<TBlockNumber>
   **/
  SpBeefyCommitment: {
  ...
  /**
   * Lookup575: sp_beefy::payload::Payload
   **/
  SpBeefyPayload: 'Vec<([u8;2],Bytes)>',
  /**
   * Lookup578: bridge_common::beefy_types::ValidatorProof
   **/
  ...
  /**
   * Lookup581: bitvec::order::Msb0
   **/
  BitvecOrderMsb0: 'Null',
  /**
   * Lookup583: sp_beefy::mmr::MmrLeaf<BlockNumber, primitive_types::H256, primitive_types::H256, bridge_types::types::LeafExtraData<primitive_types::H256, primitive_types::H256>>
   **/
  SpBeefyMmrMmrLeaf: {
    version: 'u8',
  ...
  /**
   * Lookup584: bridge_types::types::LeafExtraData<primitive_types::H256, primitive_types::H256>
   **/
  ...
  /**
   * Lookup587: bridge_common::simplified_proof::Proof<primitive_types::H256>
   **/
  ...
  /**
   * Lookup588: substrate_bridge_channel::inbound::pallet::Call<T>
   **/
  ...
  /**
   * Lookup589: bridge_types::GenericCommitment<MaxMessages, MaxPayload>
   **/
  ...
  /**
   * Lookup590: bridge_types::substrate::Commitment<MaxMessages, MaxPayload>
   **/
  ...
  /**
   * Lookup592: bridge_types::substrate::BridgeMessage<MaxPayload>
   **/
  ...
  /**
   * Lookup595: bridge_types::evm::Commitment<MaxMessages, MaxPayload>
   **/
  ...
  /**
   * Lookup597: bridge_types::evm::Message<MaxPayload>
   **/
  ...
  /**
   * Lookup599: framenode_runtime::MultiProof
   **/
  ...
  /**
   * Lookup600: beefy_light_client::SubstrateBridgeMessageProof
   **/
  ...
  /**
   * Lookup605: parachain_bridge_app::pallet::Call<T>
   **/
  ...
  /**
   * Lookup606: bridge_types::types::AssetKind
   **/
  BridgeTypesAssetKind: {
    _enum: ['Thischain', 'Sidechain']
  },
  /**
   * Lookup607: xcm::v3::multiasset::AssetId
   **/
  ...
  /**
   * Lookup608: bridge_types::substrate::XCMAppTransferStatus
   **/
  BridgeTypesSubstrateXcmAppTransferStatus: {
    _enum: ['Success', 'XCMTransferError']
  },
  /**
   * Lookup609: bridge_data_signer::pallet::Call<T>
   **/
  ...
  /**
   * Lookup610: multisig_verifier::pallet::Call<T>
   **/
  ...
  /**
   * Lookup611: pallet_sudo::pallet::Call<T>
   **/
  PalletSudoCall: {
    _enum: {
      sudo: {
  ...
  /**
   * Lookup612: faucet::pallet::Call<T>
   **/
  FaucetCall: {
    _enum: {
      transfer: {
  ...
  /**
   * Lookup613: qa_tools::pallet::Call<T>
   **/
  QaToolsCall: {
    _enum: {
      add_to_whitelist: {
  ...
  /**
   * Lookup617: qa_tools::pallets::order_book_tools::OrderBookFillSettings<Moment>
   **/
  ...
  /**
   * Lookup620: pallet_utility::pallet::Error<T>
   **/
  PalletUtilityError: {
    _enum: ['TooManyCalls']
  },
  /**
   * Lookup621: pallet_staking::sora::DurationWrapper
   **/
  ...
  /**
   * Lookup622: pallet_staking::StakingLedger<T>
   **/
  ...
  /**
   * Lookup624: pallet_staking::UnlockChunk<Balance>
   **/
  ...
  /**
   * Lookup627: pallet_staking::Nominations<T>
   **/
  ...
  /**
   * Lookup629: pallet_staking::ActiveEraInfo
   **/
  ...
  /**
   * Lookup631: pallet_staking::EraRewardPoints<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup636: pallet_staking::UnappliedSlash<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup638: pallet_staking::slashing::SlashingSpans
   **/
  ...
  /**
   * Lookup639: pallet_staking::slashing::SpanRecord<Balance>
   **/
  ...
  /**
   * Lookup642: pallet_staking::pallet::pallet::Error<T>
   **/
  ...
  /**
   * Lookup664: orml_tokens::BalanceLock<Balance>
   **/
  ...
  /**
   * Lookup666: orml_tokens::AccountData<Balance>
   **/
  ...
  /**
   * Lookup668: orml_tokens::ReserveData<ReserveIdentifier, Balance>
   **/
  ...
  /**
   * Lookup677: assets::AssetRecordArg<T>
   **/
  ...
  /**
   * Lookup679: common::primitives::AssetIdExtraAssetRecordArg<DEXId, common::primitives::LiquiditySourceType, AccountId>
   **/
  ...
  /**
   * Lookup680: assets::pallet::Error<T>
   **/
  AssetsError: {
  ...
  /**
   * Lookup681: common::primitives::DEXInfo<common::primitives::AssetId32<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup682: dex_manager::pallet::Error<T>
   **/
  DexManagerError: {
    _enum: ['DEXIdAlreadyExists', 'DEXDoesNotExist', 'InvalidFeeValue', 'InvalidAccountId']
  },
  /**
   * Lookup683: multicollateral_bonding_curve_pool::DistributionAccounts<multicollateral_bonding_curve_pool::DistributionAccountData<multicollateral_bonding_curve_pool::DistributionAccount<sp_core::crypto::AccountId32, common::primitives::TechAccountId<sp_core::crypto::AccountId32, common::primitives::TechAssetId<common::primitives::PredefinedAssetId>, DEXId>>>>
   **/
  ...
  /**
   * Lookup684: multicollateral_bonding_curve_pool::DistributionAccountData<multicollateral_bonding_curve_pool::DistributionAccount<sp_core::crypto::AccountId32, common::primitives::TechAccountId<sp_core::crypto::AccountId32, common::primitives::TechAssetId<common::primitives::PredefinedAssetId>, DEXId>>>
   **/
  ...
  /**
   * Lookup685: multicollateral_bonding_curve_pool::DistributionAccount<sp_core::crypto::AccountId32, common::primitives::TechAccountId<sp_core::crypto::AccountId32, common::primitives::TechAssetId<common::primitives::PredefinedAssetId>, DEXId>>
   **/
  ...
  /**
   * Lookup688: multicollateral_bonding_curve_pool::pallet::Error<T>
   **/
  ...
  /**
   * Lookup689: technical::pallet::Error<T>
   **/
  TechnicalError: {
  ...
  /**
   * Lookup692: pool_xyk::pallet::Error<T>
   **/
  PoolXykError: {
  ...
  /**
   * Lookup696: pallet_collective::pallet::Error<T, I>
   **/
  PalletCollectiveError: {
    _enum: ['NotMember', 'DuplicateProposal', 'ProposalMissing', 'WrongIndex', 'DuplicateVote', 'AlreadyInitialized', 'TooEarly', 'TooManyProposals', 'WrongProposalWeight', 'WrongProposalLength']
  },
  /**
   * Lookup704: pallet_democracy::types::ReferendumInfo<BlockNumber, frame_support::traits::preimages::Bounded<framenode_runtime::RuntimeCall>, Balance>
   **/
  ...
  /**
   * Lookup705: pallet_democracy::types::ReferendumStatus<BlockNumber, frame_support::traits::preimages::Bounded<framenode_runtime::RuntimeCall>, Balance>
   **/
  ...
  /**
   * Lookup706: pallet_democracy::types::Tally<Balance>
   **/
  ...
  /**
   * Lookup707: pallet_democracy::vote::Voting<Balance, sp_core::crypto::AccountId32, BlockNumber, MaxVotes>
   **/
  ...
  /**
   * Lookup711: pallet_democracy::types::Delegations<Balance>
   **/
  ...
  /**
   * Lookup712: pallet_democracy::vote::PriorLock<BlockNumber, Balance>
   **/
  PalletDemocracyVotePriorLock: '(u32,u128)',
  /**
   * Lookup716: pallet_democracy::pallet::Error<T>
   **/
  ...
  /**
   * Lookup717: eth_bridge::requests::OffchainRequest<T>
   **/
  ...
  /**
   * Lookup718: eth_bridge::requests::RequestStatus
   **/
  ...
  /**
   * Lookup725: eth_bridge::requests::outgoing::EthPeersSync
   **/
  ...
  /**
   * Lookup726: eth_bridge::BridgeStatus
   **/
  EthBridgeBridgeStatus: {
    _enum: ['Initialized', 'Migrating']
  },
  /**
   * Lookup727: eth_bridge::pallet::Error<T>
   **/
  EthBridgeError: {
  ...
  /**
   * Lookup730: pswap_distribution::pallet::Error<T>
   **/
  ...
  /**
   * Lookup736: pallet_scheduler::Scheduled<Name, frame_support::traits::preimages::Bounded<framenode_runtime::RuntimeCall>, BlockNumber, framenode_runtime::OriginCaller, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup741: iroha_migration::PendingMultisigAccount<T>
   **/
  ...
  /**
   * Lookup742: iroha_migration::pallet::Error<T>
   **/
  IrohaMigrationError: {
  ...
  /**
   * Lookup744: pallet_membership::pallet::Error<T, I>
   **/
  PalletMembershipError: {
    _enum: ['AlreadyMember', 'NotMember', 'TooManyMembers']
  },
  /**
   * Lookup746: pallet_elections_phragmen::SeatHolder<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup747: pallet_elections_phragmen::Voter<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup748: pallet_elections_phragmen::pallet::Error<T>
   **/
  ...
  /**
   * Lookup749: vested_rewards::RewardInfo
   **/
  ...
  /**
   * Lookup750: vested_rewards::CrowdloanInfo<common::primitives::AssetId32<common::primitives::PredefinedAssetId>, BlockNumber, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup752: vested_rewards::CrowdloanUserInfo<common::primitives::AssetId32<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup753: vested_rewards::pallet::Error<T>
   **/
  VestedRewardsError: {
  ...
  /**
   * Lookup754: pallet_identity::types::Registration<Balance, MaxJudgements, MaxAdditionalFields>
   **/
  ...
  /**
   * Lookup762: pallet_identity::types::RegistrarInfo<Balance, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup764: pallet_identity::pallet::Error<T>
   **/
  PalletIdentityError: {
    _enum: ['TooManySubAccounts', 'NotFound', 'NotNamed', 'EmptyIndex', 'FeeChanged', 'NoIdentity', 'StickyJudgement', 'JudgementGiven', 'InvalidJudgement', 'InvalidIndex', 'InvalidTarget', 'TooManyFields', 'TooManyRegistrars', 'AlreadyClaimed', 'NotSub', 'NotOwned', 'JudgementForDifferentIdentity', 'JudgementPaymentFailed']
  },
  /**
   * Lookup766: farming::PoolFarmer<T>
   **/
  FarmingPoolFarmer: {
    account: 'AccountId32',
    block: 'u32',
  ...
  /**
   * Lookup767: farming::pallet::Error<T>
   **/
  FarmingError: {
    _enum: ['IncRefError']
  },
  /**
   * Lookup768: xst::SyntheticInfo<common::primitives::SymbolName>
   **/
  XstSyntheticInfo: {
    referenceSymbol: 'Bytes',
    feeRatio: 'FixnumFixedPoint'
  ...
  /**
   * Lookup770: price_tools::AggregatedPriceInfo
   **/
  ...
  /**
   * Lookup771: price_tools::PriceInfo
   **/
  PriceToolsPriceInfo: {
    priceFailures: 'u32',
    spotPrices: 'Vec<u128>',
  ...
  /**
   * Lookup772: price_tools::pallet::Error<T>
   **/
  PriceToolsError: {
  ...
  /**
   * Lookup773: ceres_staking::StakingInfo
   **/
  ...
  /**
   * Lookup774: ceres_staking::pallet::Error<T>
   **/
  CeresStakingError: {
    _enum: ['StakingPoolIsFull', 'Unauthorized']
  },
  /**
   * Lookup775: ceres_liquidity_locker::StorageVersion
   **/
  CeresLiquidityLockerStorageVersion: {
    _enum: ['V1', 'V2']
  },
  /**
   * Lookup777: ceres_liquidity_locker::LockInfo<Balance, Moment, common::primitives::AssetId32<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup778: ceres_liquidity_locker::pallet::Error<T>
   **/
  ...
  /**
   * Lookup779: ceres_token_locker::StorageVersion
   **/
  CeresTokenLockerStorageVersion: {
    _enum: ['V1', 'V2']
  },
  /**
   * Lookup781: ceres_token_locker::TokenLockInfo<Balance, Moment, common::primitives::AssetId32<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup782: ceres_token_locker::pallet::Error<T>
   **/
  ...
  /**
   * Lookup784: ceres_governance_platform::VotingInfo
   **/
  ...
  /**
   * Lookup785: ceres_governance_platform::PollInfo<Moment>
   **/
  ...
  /**
   * Lookup786: ceres_governance_platform::StorageVersion
   **/
  CeresGovernancePlatformStorageVersion: {
    _enum: ['V1', 'V2']
  },
  /**
   * Lookup787: ceres_governance_platform::pallet::Error<T>
   **/
  ...
  /**
   * Lookup788: ceres_launchpad::ILOInfo<Balance, sp_core::crypto::AccountId32, Moment, common::primitives::AssetId32<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup789: ceres_launchpad::ContributorsVesting<Balance, Moment>
   **/
  ...
  /**
   * Lookup790: ceres_launchpad::TeamVesting<Balance, Moment>
   **/
  ...
  /**
   * Lookup792: ceres_launchpad::ContributionInfo<Balance>
   **/
  ...
  /**
   * Lookup793: ceres_launchpad::pallet::Error<T>
   **/
  CeresLaunchpadError: {
  ...
  /**
   * Lookup794: demeter_farming_platform::TokenInfo<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup796: demeter_farming_platform::UserInfo<common::primitives::AssetId32<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup798: demeter_farming_platform::PoolData<common::primitives::AssetId32<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup799: demeter_farming_platform::StorageVersion
   **/
  DemeterFarmingPlatformStorageVersion: {
    _enum: ['V1', 'V2']
  },
  /**
   * Lookup800: demeter_farming_platform::pallet::Error<T>
   **/
  ...
  /**
   * Lookup801: pallet_bags_list::list::Node<T, I>
   **/
  ...
  /**
   * Lookup802: pallet_bags_list::list::Bag<T, I>
   **/
  ...
  /**
   * Lookup804: pallet_bags_list::pallet::Error<T, I>
   **/
  PalletBagsListError: {
    _enum: {
  ...
  /**
   * Lookup805: pallet_bags_list::list::ListError
   **/
  PalletBagsListListListError: {
    _enum: ['Duplicate', 'NotHeavier', 'NotInSameBag', 'NodeNotFound']
  },
  /**
   * Lookup806: pallet_election_provider_multi_phase::ReadySolution<T>
   **/
  ...
  /**
   * Lookup808: pallet_election_provider_multi_phase::RoundSnapshot<T>
   **/
  ...
  /**
   * Lookup814: pallet_election_provider_multi_phase::signed::SignedSubmission<sp_core::crypto::AccountId32, Balance, framenode_runtime::NposCompactSolution24>
   **/
  ...
  /**
   * Lookup815: pallet_election_provider_multi_phase::pallet::Error<T>
   **/
  ...
  /**
   * Lookup817: band::BandRate<BlockNumber>
   **/
  BandBandRate: {
    value: 'u128',
    lastUpdated: 'u64',
  ...
  /**
   * Lookup819: band::pallet::Error<T, I>
   **/
  BandError: {
  ...
  /**
   * Lookup822: oracle_proxy::pallet::Error<T>
   **/
  OracleProxyError: {
    _enum: ['OracleAlreadyEnabled', 'OracleAlreadyDisabled']
  },
  /**
   * Lookup824: hermes_governance_platform::HermesVotingInfo<StringLimit>
   **/
  ...
  /**
   * Lookup825: hermes_governance_platform::HermesPollInfo<sp_core::crypto::AccountId32, Moment, StringLimit, OptionsLimit, TitleLimit, DescriptionLimit>
   **/
  ...
  /**
   * Lookup826: hermes_governance_platform::StorageVersion
   **/
  HermesGovernancePlatformStorageVersion: {
    _enum: ['V1', 'V2']
  },
  /**
   * Lookup827: hermes_governance_platform::pallet::Error<T>
   **/
  ...
  /**
   * Lookup828: pallet_preimage::RequestStatus<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup832: pallet_preimage::pallet::Error<T>
   **/
  PalletPreimageError: {
    _enum: ['TooBig', 'AlreadyNoted', 'NotAuthorized', 'NotNoted', 'Requested', 'NotRequested']
  },
  /**
   * Lookup833: order_book::order_book::OrderBook<T>
   **/
  OrderBook: {
    orderBookId: 'OrderBookOrderBookId',
    status: 'OrderBookOrderBookStatus',
  ...
  /**
   * Lookup835: order_book::limit_order::LimitOrder<T>
   **/
  OrderBookLimitOrder: {
    id: 'u128',
    owner: 'AccountId32',
  ...
  /**
   * Lookup846: order_book::pallet::Error<T>
   **/
  OrderBookError: {
  ...
  /**
   * Lookup849: bridge_proxy::BridgeRequest<sp_core::crypto::AccountId32, common::primitives::AssetId32<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup850: bridge_types::types::MessageDirection
   **/
  BridgeTypesMessageDirection: {
    _enum: ['Inbound', 'Outbound']
  },
  /**
   * Lookup854: bridge_proxy::pallet::Error<T>
   **/
  BridgeProxyError: {
  ...
  /**
   * Lookup856: ethereum_light_client::PruningRange
   **/
  ...
  /**
   * Lookup858: ethereum_light_client::StoredHeader<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup860: ethereum_light_client::pallet::Error<T>
   **/
  ...
  /**
   * Lookup861: bridge_inbound_channel::pallet::Error<T>
   **/
  ...
  /**
   * Lookup862: bridge_types::types::GenericCommitmentWithBlock<BlockNumber, MaxMessages, MaxPayload>
   **/
  ...
  /**
   * Lookup869: erc20_app::pallet::Error<T>
   **/
  Erc20AppError: {
  ...
  /**
   * Lookup870: migration_app::pallet::Error<T>
   **/
  MigrationAppError: {
  ...
  /**
   * Lookup871: beefy_light_client::pallet::Error<T>
   **/
  ...
  /**
   * Lookup872: substrate_bridge_channel::inbound::pallet::Error<T>
   **/
  ...
  /**
   * Lookup873: substrate_bridge_channel::outbound::pallet::Error<T>
   **/
  ...
  /**
   * Lookup876: parachain_bridge_app::pallet::Error<T>
   **/
  ...
  /**
   * Lookup883: bridge_data_signer::pallet::Error<T>
   **/
  ...
  /**
   * Lookup884: multisig_verifier::pallet::Error<T>
   **/
  ...
  /**
   * Lookup887: pallet_sudo::pallet::Error<T>
   **/
  PalletSudoError: {
    _enum: ['RequireSudo']
  },
  /**
   * Lookup888: faucet::pallet::Error<T>
   **/
  FaucetError: {
    _enum: ['AssetNotSupported', 'AmountAboveLimit', 'NotEnoughReserves']
  },
  /**
   * Lookup889: qa_tools::pallet::Error<T>
   **/
  QaToolsError: {
    _enum: ['WhitelistFull', 'AlreadyInWhitelist', 'NotInWhitelist', 'CannotFillUnknownOrderBook']
  },
  /**
   * Lookup892: frame_system::extensions::check_spec_version::CheckSpecVersion<T>
   **/
  FrameSystemExtensionsCheckSpecVersion: 'Null',
  /**
   * Lookup893: frame_system::extensions::check_tx_version::CheckTxVersion<T>
   **/
  FrameSystemExtensionsCheckTxVersion: 'Null',
  /**
   * Lookup894: frame_system::extensions::check_genesis::CheckGenesis<T>
   **/
  FrameSystemExtensionsCheckGenesis: 'Null',
  /**
   * Lookup897: frame_system::extensions::check_nonce::CheckNonce<T>
   **/
  FrameSystemExtensionsCheckNonce: 'Compact<u32>',
  /**
   * Lookup898: frame_system::extensions::check_weight::CheckWeight<T>
   **/
  FrameSystemExtensionsCheckWeight: 'Null',
  /**
   * Lookup899: xor_fee::extension::ChargeTransactionPayment<T>
   **/
  XorFeeExtensionChargeTransactionPayment: {
    tip: 'Compact<u128>'
  },
  /**
   * Lookup900: framenode_runtime::Runtime
   **/
