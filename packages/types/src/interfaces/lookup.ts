...
export default {
  ...
  /**
   * Lookup45: pallet_grandpa::pallet::Event
   **/
  PalletGrandpaEvent: {
    _enum: {
      NewAuthorities: {
  ...
  /**
   * Lookup48: sp_finality_grandpa::app::Public
   **/
  SpFinalityGrandpaAppPublic: 'SpCoreEd25519Public',
  /**
   * Lookup49: sp_core::ed25519::Public
   **/
  ...
  /**
   * Lookup52: sp_core::sr25519::Public
   **/
  SpCoreSr25519Public: '[u8;32]',
  /**
   * Lookup55: pallet_staking::Exposure<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup58: pallet_staking::IndividualExposure<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup60: common::primitives::AssetId32<common::primitives::PredefinedAssetId>
   **/
  CommonPrimitivesAssetId32: {
    code: '[u8;32]'
  },
  /**
   * Lookup61: common::primitives::PredefinedAssetId
   **/
  CommonPrimitivesPredefinedAssetId: {
    _enum: ['XOR', 'DOT', 'KSM', 'USDT', 'VAL', 'PSWAP', 'DAI', 'ETH', 'XSTUSD']
  },
  /**
   * Lookup63: trading_pair::pallet::Event<T>
   **/
  TradingPairEvent: {
    _enum: {
  ...
  /**
   * Lookup64: common::primitives::TradingPair<common::primitives::AssetId32<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup65: assets::pallet::Event<T>
   **/
  AssetsEvent: {
    _enum: {
  ...
  /**
   * Lookup66: multicollateral_bonding_curve_pool::pallet::Event<T>
   **/
  ...
  /**
   * Lookup68: fixnum::FixedPoint<I, P>
   **/
  FixnumFixedPoint: {
    inner: 'i128'
  },
  /**
   * Lookup70: technical::pallet::Event<T>
   **/
  TechnicalEvent: {
    _enum: {
  ...
  /**
   * Lookup71: common::primitives::TechAssetId<common::primitives::PredefinedAssetId>
   **/
  ...
  /**
   * Lookup72: common::primitives::TechAccountId<sp_core::crypto::AccountId32, common::primitives::TechAssetId<common::primitives::PredefinedAssetId>, DEXId>
   **/
  ...
  /**
   * Lookup73: common::primitives::TechPurpose<common::primitives::TechAssetId<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup74: common::primitives::TradingPair<common::primitives::TechAssetId<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup75: pool_xyk::pallet::Event<T>
   **/
  PoolXykEvent: {
    _enum: {
  ...
  /**
   * Lookup76: liquidity_proxy::pallet::Event<T>
   **/
  LiquidityProxyEvent: {
    _enum: {
  ...
  /**
   * Lookup78: common::primitives::LiquiditySourceId<DEXId, common::primitives::LiquiditySourceType>
   **/
  ...
  /**
   * Lookup79: common::primitives::LiquiditySourceType
   **/
  ...
  /**
   * Lookup88: eth_bridge::pallet::Event<T>
   **/
  EthBridgeEvent: {
    _enum: {
  ...
  /**
   * Lookup89: pswap_distribution::pallet::Event<T>
   **/
  ...
  /**
   * Lookup91: pallet_multisig::Timepoint<BlockNumber>
   **/
  ...
  /**
   * Lookup96: iroha_migration::pallet::Event<T>
   **/
  IrohaMigrationEvent: {
    _enum: {
  ...
  /**
   * Lookup98: pallet_membership::pallet::Event<T, I>
   **/
  PalletMembershipEvent: {
    _enum: ['MemberAdded', 'MemberRemoved', 'MembersSwapped', 'MembersReset', 'KeyChanged', 'Dummy']
  },
  /**
   * Lookup99: pallet_elections_phragmen::pallet::Event<T>
   **/
  ...
  /**
   * Lookup102: vested_rewards::pallet::Event<T>
   **/
  VestedRewardsEvent: {
    _enum: {
      RewardsVested: 'u128',
  ...
  /**
   * Lookup103: common::primitives::RewardReason
   **/
  ...
  /**
   * Lookup106: price_tools::pallet::Event<T>
   **/
  PriceToolsEvent: 'Null',
  /**
   * Lookup107: ceres_staking::pallet::Event<T>
   **/
  CeresStakingEvent: {
    _enum: {
  ...
  /**
   * Lookup108: ceres_liquidity_locker::pallet::Event<T>
   **/
  CeresLiquidityLockerEvent: {
    _enum: {
      Locked: '(AccountId32,u128,u32)'
    }
  },
  /**
   * Lookup109: ceres_token_locker::pallet::Event<T>
   **/
  ...
  /**
   * Lookup110: ceres_governance_platform::pallet::Event<T>
   **/
  CeresGovernancePlatformEvent: {
    _enum: {
      Voted: '(AccountId32,Bytes,u32,u128)',
      Created: '(AccountId32,u32,u32,u32)',
      Withdrawn: '(AccountId32,u128)'
    }
  },
  /**
   * Lookup111: ceres_launchpad::pallet::Event<T>
   **/
  CeresLaunchpadEvent: {
    _enum: {
  ...
  /**
   * Lookup112: demeter_farming_platform::pallet::Event<T>
   **/
  ...
  /**
   * Lookup114: pallet_election_provider_multi_phase::pallet::Event<T>
   **/
  ...
  /**
   * Lookup115: pallet_election_provider_multi_phase::ElectionCompute
   **/
  PalletElectionProviderMultiPhaseElectionCompute: {
    _enum: ['OnChain', 'Signed', 'Unsigned', 'Fallback', 'Emergency']
  },
  /**
   * Lookup117: faucet::pallet::Event<T>
   **/
  FaucetEvent: {
    _enum: {
  ...
  /**
   * Lookup118: ethereum_light_client::pallet::Event<T>
   **/
  EthereumLightClientEvent: {
    _enum: {
      Finalized: '(u32,BridgeTypesHeaderHeaderId)'
    }
  },
  /**
   * Lookup119: bridge_types::header::HeaderId
   **/
  ...
  /**
   * Lookup120: basic_channel::inbound::pallet::Event<T>
   **/
  BasicChannelInboundPalletEvent: 'Null',
  /**
   * Lookup121: basic_channel::outbound::pallet::Event<T>
   **/
  BasicChannelOutboundPalletEvent: {
    _enum: {
      MessageAccepted: 'u64'
    }
  },
  /**
   * Lookup122: incentivized_channel::inbound::pallet::Event<T>
   **/
  IncentivizedChannelInboundPalletEvent: 'Null',
  /**
   * Lookup123: incentivized_channel::outbound::pallet::Event<T>
   **/
  IncentivizedChannelOutboundPalletEvent: {
    _enum: {
      MessageAccepted: '(u32,u64)'
    }
  },
  /**
   * Lookup124: dispatch::pallet::Event<T>
   **/
  DispatchEvent: {
    _enum: {
  ...
  /**
   * Lookup125: bridge_types::types::MessageId
   **/
  ...
  /**
   * Lookup126: bridge_types::types::ChannelId
   **/
  BridgeTypesChannelId: {
    _enum: ['Basic', 'Incentivized']
  },
  /**
   * Lookup127: leaf_provider::pallet::Event<T>
   **/
  LeafProviderEvent: 'Null',
  /**
   * Lookup128: eth_app::pallet::Event<T>
   **/
  EthAppEvent: {
    _enum: {
      Burned: '(u32,AccountId32,H160,u128)',
      Minted: '(u32,H160,AccountId32,u128)'
    }
  },
  /**
   * Lookup131: erc20_app::pallet::Event<T>
   **/
  Erc20AppEvent: {
    _enum: {
      Burned: '(u32,CommonPrimitivesAssetId32,AccountId32,H160,u128)',
      Minted: '(u32,CommonPrimitivesAssetId32,H160,AccountId32,u128)'
    }
  },
  /**
   * Lookup132: migration_app::pallet::Event<T>
   **/
  MigrationAppEvent: {
    _enum: {
      Erc20Migrated: '(u32,H160)',
      SidechainMigrated: '(u32,H160)',
      EthMigrated: '(u32,H160)'
    }
  },
  /**
  ...
  /**
   * Lookup167: sp_consensus_babe::digests::PreDigest
   **/
  ...
  /**
   * Lookup168: sp_consensus_babe::digests::PrimaryPreDigest
   **/
  ...
  /**
   * Lookup170: sp_consensus_babe::digests::SecondaryPlainPreDigest
   **/
  ...
  /**
   * Lookup171: sp_consensus_babe::digests::SecondaryVRFPreDigest
   **/
  ...
  /**
   * Lookup173: sp_consensus_babe::BabeEpochConfiguration
   **/
  ...
  /**
   * Lookup174: pallet_babe::pallet::Call<T>
   **/
  PalletBabeCall: {
    _enum: {
      report_equivocation: {
  ...
  /**
   * Lookup175: sp_consensus_slots::EquivocationProof<sp_runtime::generic::header::Header<Number, sp_runtime::traits::BlakeTwo256>, sp_consensus_babe::app::Public>
   **/
  ...
  /**
   * Lookup178: sp_session::MembershipProof
   **/
  ...
  /**
   * Lookup179: pallet_babe::pallet::Error<T>
   **/
  PalletBabeError: {
  ...
  /**
   * Lookup189: pallet_balances::Releases
   **/
  ...
  /**
   * Lookup194: permissions::pallet::Call<T>
   **/
  PermissionsCall: 'Null',
  /**
   * Lookup195: referrals::pallet::Call<T>
   **/
  ReferralsCall: {
    _enum: {
      reserve: {
  ...
  /**
   * Lookup196: rewards::pallet::Call<T>
   **/
  RewardsCall: {
    _enum: {
      claim: {
  ...
  /**
   * Lookup198: xor_fee::pallet::Call<T>
   **/
  XorFeeCall: 'Null',
  /**
  ...
  /**
   * Lookup203: framenode_runtime::OriginCaller
   **/
  ...
  /**
   * Lookup205: pallet_collective::RawOrigin<sp_core::crypto::AccountId32, I>
   **/
  ...
  /**
   * Lookup207: dispatch::RawOrigin
   **/
  DispatchRawOrigin: '(u32,H160)',
  /**
  ...
  /**
   * Lookup222: framenode_runtime::opaque::SessionKeys
   **/
  ...
  /**
   * Lookup223: beefy_primitives::crypto::Public
   **/
  BeefyPrimitivesCryptoPublic: 'SpCoreEcdsaPublic',
  /**
   * Lookup224: sp_core::ecdsa::Public
   **/
  ...
  /**
   * Lookup227: sp_finality_grandpa::EquivocationProof<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup228: sp_finality_grandpa::Equivocation<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup229: finality_grandpa::Equivocation<sp_finality_grandpa::app::Public, finality_grandpa::Prevote<primitive_types::H256, N>, sp_finality_grandpa::app::Signature>
   **/
  ...
  /**
   * Lookup231: sp_finality_grandpa::app::Signature
   **/
  ...
  /**
   * Lookup245: orml_currencies::module::Call<T>
   **/
  ...
  /**
   * Lookup246: trading_pair::pallet::Call<T>
   **/
  TradingPairCall: {
    _enum: {
      register: {
  ...
  /**
   * Lookup247: assets::pallet::Call<T>
   **/
  AssetsCall: {
    _enum: {
      register: {
  ...
  /**
   * Lookup254: multicollateral_bonding_curve_pool::pallet::Call<T>
   **/
  ...
  /**
   * Lookup255: technical::pallet::Call<T>
   **/
  TechnicalCall: 'Null',
  /**
   * Lookup256: pool_xyk::pallet::Call<T>
   **/
  PoolXykCall: {
    _enum: {
      deposit_liquidity: {
  ...
  /**
   * Lookup257: liquidity_proxy::pallet::Call<T>
   **/
  LiquidityProxyCall: {
    _enum: {
      swap: {
  ...
  /**
   * Lookup258: common::swap_amount::SwapAmount<AmountType>
   **/
  CommonSwapAmount: {
    _enum: {
      WithDesiredInput: {
  ...
  /**
   * Lookup260: common::primitives::FilterMode
   **/
  ...
  /**
   * Lookup266: dex_api::pallet::Call<T>
   **/
  DexApiCall: 'Null',
  /**
   * Lookup267: eth_bridge::pallet::Call<T>
   **/
  EthBridgeCall: {
    _enum: {
      register_bridge: {
  ...
  /**
   * Lookup268: eth_bridge::requests::IncomingRequestKind
   **/
  ...
  /**
   * Lookup269: eth_bridge::requests::IncomingTransactionRequestKind
   **/
  ...
  /**
   * Lookup270: eth_bridge::requests::IncomingMetaRequestKind
   **/
  EthBridgeRequestsIncomingMetaRequestKind: {
    _enum: ['CancelOutgoingRequest', 'MarkAsDone']
  },
  /**
   * Lookup272: eth_bridge::requests::IncomingRequest<T>
   **/
  ...
  /**
   * Lookup273: eth_bridge::requests::incoming::IncomingTransfer<T>
   **/
  ...
  /**
   * Lookup274: eth_bridge::requests::AssetKind
   **/
  EthBridgeRequestsAssetKind: {
    _enum: ['Thischain', 'Sidechain', 'SidechainOwned']
  },
  /**
   * Lookup275: eth_bridge::requests::incoming::IncomingAddToken<T>
   **/
  ...
  /**
   * Lookup276: eth_bridge::requests::incoming::IncomingChangePeers<T>
   **/
  ...
  /**
   * Lookup277: eth_bridge::requests::incoming::IncomingCancelOutgoingRequest<T>
   **/
  ...
  /**
   * Lookup278: eth_bridge::requests::OutgoingRequest<T>
   **/
  ...
  /**
   * Lookup279: eth_bridge::requests::outgoing::OutgoingTransfer<T>
   **/
  ...
  /**
   * Lookup280: eth_bridge::requests::outgoing::OutgoingAddAsset<T>
   **/
  ...
  /**
   * Lookup281: eth_bridge::requests::outgoing::OutgoingAddToken<T>
   **/
  ...
  /**
   * Lookup282: eth_bridge::requests::outgoing::OutgoingAddPeer<T>
   **/
  ...
  /**
   * Lookup283: eth_bridge::requests::outgoing::OutgoingRemovePeer<T>
   **/
  ...
  /**
   * Lookup285: eth_bridge::requests::outgoing::OutgoingPrepareForMigration<T>
   **/
  ...
  /**
   * Lookup286: eth_bridge::requests::outgoing::OutgoingMigrate<T>
   **/
  ...
  /**
   * Lookup287: eth_bridge::requests::outgoing::OutgoingAddPeerCompat<T>
   **/
  ...
  /**
   * Lookup288: eth_bridge::requests::outgoing::OutgoingRemovePeerCompat<T>
   **/
  ...
  /**
   * Lookup289: eth_bridge::requests::incoming::IncomingMarkAsDoneRequest<T>
   **/
  ...
  /**
   * Lookup290: eth_bridge::requests::incoming::IncomingPrepareForMigration<T>
   **/
  ...
  /**
   * Lookup291: eth_bridge::requests::incoming::IncomingMigrate<T>
   **/
  ...
  /**
   * Lookup292: eth_bridge::requests::incoming::IncomingChangePeersCompat<T>
   **/
  ...
  /**
   * Lookup293: eth_bridge::requests::incoming::ChangePeersContract
   **/
  EthBridgeRequestsIncomingChangePeersContract: {
    _enum: ['XOR', 'VAL']
  },
  /**
   * Lookup294: eth_bridge::requests::LoadIncomingRequest<T>
   **/
  ...
  /**
   * Lookup295: eth_bridge::requests::LoadIncomingTransactionRequest<T>
   **/
  ...
  /**
   * Lookup296: eth_bridge::requests::LoadIncomingMetaRequest<T>
   **/
  ...
  /**
   * Lookup298: eth_bridge::offchain::SignatureParams
   **/
  ...
  /**
   * Lookup299: pswap_distribution::pallet::Call<T>
   **/
  ...
  /**
   * Lookup305: frame_support::traits::schedule::MaybeHashed<framenode_runtime::Call, primitive_types::H256>
   **/
  ...
  /**
   * Lookup306: iroha_migration::pallet::Call<T>
   **/
  IrohaMigrationCall: {
    _enum: {
      migrate: {
  ...
  /**
   * Lookup310: vested_rewards::pallet::Call<T>
   **/
  VestedRewardsCall: {
    _enum: {
      claim_rewards: 'Null',
  ...
  /**
   * Lookup348: pallet_identity::types::BitFlags<pallet_identity::types::IdentityField>
   **/
  ...
  /**
   * Lookup349: pallet_identity::types::IdentityField
   **/
  ...
  /**
   * Lookup350: pallet_identity::types::Judgement<Balance>
   **/
  ...
  /**
   * Lookup352: ceres_staking::pallet::Call<T>
   **/
  CeresStakingCall: {
    _enum: {
      deposit: {
  ...
  /**
   * Lookup353: ceres_liquidity_locker::pallet::Call<T>
   **/
  ...
  /**
   * Lookup354: ceres_token_locker::pallet::Call<T>
   **/
  ...
  /**
   * Lookup355: ceres_governance_platform::pallet::Call<T>
   **/
  ...
  /**
   * Lookup356: ceres_launchpad::pallet::Call<T>
   **/
  CeresLaunchpadCall: {
    _enum: {
      create_ilo: {
  ...
  /**
   * Lookup357: demeter_farming_platform::pallet::Call<T>
   **/
  ...
  /**
   * Lookup359: pallet_election_provider_multi_phase::pallet::Call<T>
   **/
  ...
  /**
   * Lookup360: pallet_election_provider_multi_phase::RawSolution<framenode_runtime::NposCompactSolution24>
   **/
  ...
  /**
   * Lookup361: framenode_runtime::NposCompactSolution24
   **/
  ...
  /**
   * Lookup436: sp_npos_elections::ElectionScore
   **/
  ...
  /**
   * Lookup437: pallet_election_provider_multi_phase::SolutionOrSnapshotSize
   **/
  ...
  /**
   * Lookup441: sp_npos_elections::Support<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup442: faucet::pallet::Call<T>
   **/
  FaucetCall: {
    _enum: {
      transfer: {
  ...
  /**
   * Lookup443: ethereum_light_client::pallet::Call<T>
   **/
  ...
  /**
   * Lookup444: bridge_types::header::Header
   **/
  BridgeTypesHeader: {
    parentHash: 'H256',
    timestamp: 'u64',
  ...
  /**
   * Lookup451: bridge_types::ethashproof::DoubleNodeWithMerkleProof
   **/
  ...
  /**
   * Lookup456: basic_channel::inbound::pallet::Call<T>
   **/
  BasicChannelInboundPalletCall: {
    _enum: {
      submit: {
        networkId: 'u32',
  ...
  /**
   * Lookup457: bridge_types::types::Message
   **/
  BridgeTypesMessage: {
    data: 'Bytes',
  ...
  /**
   * Lookup458: bridge_types::types::Proof
   **/
  BridgeTypesProof: {
    blockHash: 'H256',
    txIndex: 'u32',
  ...
  /**
   * Lookup459: incentivized_channel::inbound::pallet::Call<T>
   **/
  IncentivizedChannelInboundPalletCall: {
    _enum: {
      submit: {
        networkId: 'u32',
        message: 'BridgeTypesMessage',
  ...
  /**
   * Lookup460: eth_app::pallet::Call<T>
   **/
  EthAppCall: {
    _enum: {
      burn: {
  ...
  /**
   * Lookup461: erc20_app::pallet::Call<T>
   **/
  Erc20AppCall: {
    _enum: {
      mint: {
  ...
  /**
   * Lookup462: migration_app::pallet::Call<T>
   **/
  MigrationAppCall: {
    _enum: {
      migrate_erc20: {
  ...
  /**
   * Lookup470: frame_support::weights::WeightToFeeCoefficient<Balance>
   **/
  ...
  /**
   * Lookup479: rewards::pallet::Error<T>
   **/
  RewardsError: {
    _enum: ['NothingToClaim', 'AddressNotEligible', 'SignatureInvalid', 'SignatureVerificationFailed', 'IllegalCall']
  },
  /**
   * Lookup480: pallet_multisig::MultisigAccount<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup482: pallet_multisig::Multisig<BlockNumber, Balance, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup488: pallet_authorship::UncleEntryItem<BlockNumber, primitive_types::H256, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup489: pallet_authorship::pallet::Error<T>
   **/
  PalletAuthorshipError: {
    _enum: ['InvalidUncleParent', 'UnclesAlreadySet', 'TooManyUncles', 'GenesisUncle', 'TooHighUncle', 'UncleAlreadyIncluded', 'OldUncle']
  },
  /**
   * Lookup490: pallet_staking::sora::DurationWrapper
   **/
  ...
  /**
   * Lookup491: pallet_staking::StakingLedger<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup493: pallet_staking::UnlockChunk<Balance>
   **/
  ...
  /**
   * Lookup495: pallet_staking::Nominations<T>
   **/
  ...
  /**
   * Lookup497: pallet_staking::ActiveEraInfo
   **/
  ...
  /**
   * Lookup499: pallet_staking::EraRewardPoints<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup503: pallet_staking::Forcing
   **/
  ...
  /**
   * Lookup511: pallet_staking::Releases
   **/
  PalletStakingReleases: {
    _enum: ['V1_0_0Ancient', 'V2_0_0', 'V3_0_0', 'V4_0_0', 'V5_0_0', 'V6_0_0', 'V7_0_0', 'V8_0_0', 'V9_0_0']
  },
  /**
   * Lookup512: pallet_staking::pallet::pallet::Error<T>
   **/
  ...
  /**
   * Lookup513: sp_staking::offence::OffenceDetails<sp_core::crypto::AccountId32, Offender>
   **/
  ...
  /**
   * Lookup518: sp_core::crypto::KeyTypeId
   **/
  SpCoreCryptoKeyTypeId: '[u8;4]',
  /**
   * Lookup519: pallet_session::pallet::Error<T>
   **/
  PalletSessionError: {
  ...
  /**
   * Lookup547: assets::AssetRecordArg<T>
   **/
  ...
  /**
   * Lookup549: common::primitives::AssetIdExtraAssetRecordArg<DEXId, common::primitives::LiquiditySourceType, AccountId>
   **/
  ...
  /**
   * Lookup550: assets::pallet::Error<T>
   **/
  AssetsError: {
  ...
  /**
   * Lookup551: common::primitives::DEXInfo<common::primitives::AssetId32<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup552: dex_manager::pallet::Error<T>
   **/
  DexManagerError: {
    _enum: ['DEXIdAlreadyExists', 'DEXDoesNotExist', 'InvalidFeeValue', 'InvalidAccountId']
  },
  /**
   * Lookup555: multicollateral_bonding_curve_pool::DistributionAccounts<multicollateral_bonding_curve_pool::DistributionAccountData<multicollateral_bonding_curve_pool::DistributionAccount<sp_core::crypto::AccountId32, common::primitives::TechAccountId<sp_core::crypto::AccountId32, common::primitives::TechAssetId<common::primitives::PredefinedAssetId>, DEXId>>>>
   **/
  ...
  /**
   * Lookup556: multicollateral_bonding_curve_pool::DistributionAccountData<multicollateral_bonding_curve_pool::DistributionAccount<sp_core::crypto::AccountId32, common::primitives::TechAccountId<sp_core::crypto::AccountId32, common::primitives::TechAssetId<common::primitives::PredefinedAssetId>, DEXId>>>
   **/
  ...
  /**
   * Lookup557: multicollateral_bonding_curve_pool::DistributionAccount<sp_core::crypto::AccountId32, common::primitives::TechAccountId<sp_core::crypto::AccountId32, common::primitives::TechAssetId<common::primitives::PredefinedAssetId>, DEXId>>
   **/
  ...
  /**
   * Lookup560: multicollateral_bonding_curve_pool::pallet::Error<T>
   **/
  ...
  /**
   * Lookup561: technical::pallet::Error<T>
   **/
  TechnicalError: {
  ...
  /**
   * Lookup564: pool_xyk::pallet::Error<T>
   **/
  PoolXykError: {
  ...
  /**
   * Lookup565: liquidity_proxy::pallet::Error<T>
   **/
  LiquidityProxyError: {
    _enum: ['UnavailableExchangePath', 'MaxFeeExceeded', 'InvalidFeeValue', 'InsufficientLiquidity', 'AggregationError', 'CalculationError', 'SlippageNotTolerated', 'ForbiddenFilter', 'FailedToCalculatePriceWithoutImpact']
  },
  /**
   * Lookup567: pallet_collective::Votes<sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup568: pallet_collective::pallet::Error<T, I>
   **/
  PalletCollectiveError: {
    _enum: ['NotMember', 'DuplicateProposal', 'ProposalMissing', 'WrongIndex', 'DuplicateVote', 'AlreadyInitialized', 'TooEarly', 'TooManyProposals', 'WrongProposalWeight', 'WrongProposalLength']
  },
  /**
   * Lookup574: pallet_democracy::PreimageStatus<sp_core::crypto::AccountId32, Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup575: pallet_democracy::types::ReferendumInfo<BlockNumber, primitive_types::H256, Balance>
   **/
  ...
  /**
   * Lookup576: pallet_democracy::types::ReferendumStatus<BlockNumber, primitive_types::H256, Balance>
   **/
  ...
  /**
   * Lookup578: pallet_democracy::vote::Voting<Balance, sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup581: pallet_democracy::types::Delegations<Balance>
   **/
  ...
  /**
   * Lookup582: pallet_democracy::vote::PriorLock<BlockNumber, Balance>
   **/
  PalletDemocracyVotePriorLock: '(u32,u128)',
  /**
   * Lookup585: pallet_democracy::Releases
   **/
  ...
  /**
   * Lookup588: eth_bridge::requests::OffchainRequest<T>
   **/
  ...
  /**
   * Lookup589: eth_bridge::requests::RequestStatus
   **/
  ...
  /**
   * Lookup596: eth_bridge::requests::outgoing::EthPeersSync
   **/
  ...
  /**
   * Lookup597: eth_bridge::BridgeStatus
   **/
  EthBridgeBridgeStatus: {
    _enum: ['Initialized', 'Migrating']
  },
  /**
   * Lookup601: eth_bridge::pallet::Error<T>
   **/
  EthBridgeError: {
  ...
  /**
   * Lookup604: pswap_distribution::pallet::Error<T>
   **/
  ...
  /**
   * Lookup610: pallet_scheduler::ScheduledV3<frame_support::traits::schedule::MaybeHashed<framenode_runtime::Call, primitive_types::H256>, BlockNumber, framenode_runtime::OriginCaller, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup614: iroha_migration::PendingMultisigAccount<T>
   **/
  ...
  /**
   * Lookup615: iroha_migration::pallet::Error<T>
   **/
  IrohaMigrationError: {
  ...
  /**
   * Lookup616: pallet_membership::pallet::Error<T, I>
   **/
  ...
  /**
   * Lookup621: vested_rewards::RewardInfo
   **/
  ...
  /**
   * Lookup625: vested_rewards::MarketMakerInfo
   **/
  ...
  /**
   * Lookup626: vested_rewards::CrowdloanReward
   **/
  ...
  /**
   * Lookup627: vested_rewards::pallet::Error<T>
   **/
  VestedRewardsError: {
    _enum: ['NothingToClaim', 'ClaimLimitExceeded', 'UnhandledRewardType', 'RewardsSupplyShortage', 'IncRefError', 'CantSubtractSnapshot', 'CantCalculateReward', 'MarketMakingPairAlreadyAllowed', 'MarketMakingPairAlreadyDisallowed', 'NoRewardsForAsset']
  },
  /**
   * Lookup628: pallet_identity::types::Registration<Balance, MaxJudgements, MaxAdditionalFields>
   **/
  ...
  /**
   * Lookup636: pallet_identity::types::RegistrarInfo<Balance, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup640: farming::PoolFarmer<T>
   **/
  FarmingPoolFarmer: {
    account: 'AccountId32',
    block: 'u32',
  ...
  /**
   * Lookup641: farming::pallet::Error<T>
   **/
  FarmingError: {
    _enum: ['IncRefError']
  },
  /**
   * Lookup642: xst::pallet::Error<T>
   **/
  XstError: {
  ...
  /**
   * Lookup643: price_tools::PriceInfo
   **/
  PriceToolsPriceInfo: {
    priceFailures: 'u32',
    spotPrices: 'Vec<u128>',
  ...
  /**
   * Lookup644: price_tools::pallet::Error<T>
   **/
  PriceToolsError: {
  ...
  /**
   * Lookup645: ceres_staking::StakingInfo
   **/
  ...
  /**
   * Lookup646: ceres_staking::pallet::Error<T>
   **/
  CeresStakingError: {
    _enum: ['StakingPoolIsFull', 'Unauthorized']
  },
  /**
   * Lookup648: ceres_liquidity_locker::LockInfo<Balance, BlockNumber, common::primitives::AssetId32<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup649: ceres_liquidity_locker::pallet::Error<T>
   **/
  CeresLiquidityLockerError: {
    _enum: ['PoolDoesNotExist', 'InsufficientLiquidityToLock', 'InvalidPercentage', 'Unauthorized', 'InvalidUnlockingBlock']
  },
  /**
   * Lookup651: ceres_token_locker::TokenLockInfo<Balance, BlockNumber, common::primitives::AssetId32<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup652: ceres_token_locker::pallet::Error<T>
   **/
  CeresTokenLockerError: {
    _enum: ['InvalidNumberOfTokens', 'Unauthorized', 'InvalidUnlockingBlock', 'NotEnoughFunds', 'NotUnlockedYet', 'LockInfoDoesNotExist']
  },
  /**
   * Lookup654: ceres_governance_platform::VotingInfo
   **/
  ...
  /**
   * Lookup655: ceres_governance_platform::PollInfo<BlockNumber>
   **/
  ...
  /**
   * Lookup656: ceres_governance_platform::pallet::Error<T>
   **/
  CeresGovernancePlatformError: {
    _enum: ['InvalidVotes', 'PollIsFinished', 'PollIsNotStarted', 'NotEnoughFunds', 'InvalidNumberOfOption', 'VoteDenied', 'InvalidStartBlock', 'InvalidEndBlock', 'PollIsNotFinished', 'InvalidNumberOfVotes', 'FundsAlreadyWithdrawn', 'PollIdAlreadyExists']
  },
  /**
   * Lookup657: ceres_launchpad::ILOInfo<Balance, sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup658: ceres_launchpad::ContributorsVesting<Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup659: ceres_launchpad::TeamVesting<Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup661: ceres_launchpad::ContributionInfo<Balance>
   **/
  ...
  /**
   * Lookup665: demeter_farming_platform::UserInfo<common::primitives::AssetId32<common::primitives::PredefinedAssetId>>
   **/
  ...
  /**
   * Lookup667: demeter_farming_platform::PoolData
   **/
  ...
  /**
   * Lookup668: demeter_farming_platform::pallet::Error<T>
   **/
  ...
  /**
   * Lookup669: pallet_bags_list::list::Node<T, I>
   **/
  ...
  /**
   * Lookup670: pallet_bags_list::list::Bag<T, I>
   **/
  ...
  /**
   * Lookup672: pallet_bags_list::pallet::Error<T, I>
   **/
  PalletBagsListError: {
    _enum: {
  ...
  /**
   * Lookup673: pallet_bags_list::list::ListError
   **/
  PalletBagsListListListError: {
    _enum: ['Duplicate', 'NotHeavier', 'NotInSameBag', 'NodeNotFound']
  },
  /**
   * Lookup674: pallet_election_provider_multi_phase::Phase<Bn>
   **/
  ...
  /**
   * Lookup676: pallet_election_provider_multi_phase::ReadySolution<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup677: pallet_election_provider_multi_phase::RoundSnapshot<T>
   **/
  ...
  /**
   * Lookup684: pallet_election_provider_multi_phase::signed::SignedSubmission<sp_core::crypto::AccountId32, Balance, framenode_runtime::NposCompactSolution24>
   **/
  ...
  /**
   * Lookup685: pallet_election_provider_multi_phase::pallet::Error<T>
   **/
  ...
  /**
   * Lookup686: faucet::pallet::Error<T>
   **/
  FaucetError: {
    _enum: ['AssetNotSupported', 'AmountAboveLimit', 'NotEnoughReserves']
  },
  /**
   * Lookup688: beefy_primitives::mmr::BeefyNextAuthoritySet<primitive_types::H256>
   **/
  ...
  /**
   * Lookup690: ethereum_light_client::PruningRange
   **/
  ...
  /**
   * Lookup691: ethereum_light_client::StoredHeader<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup692: bridge_types::difficulty::DifficultyConfig
   **/
  BridgeTypesDifficultyDifficultyConfig: {
  ...
  /**
   * Lookup693: ethereum_light_client::pallet::Error<T>
   **/
  EthereumLightClientError: {
    _enum: ['AncientHeader', 'MissingHeader', 'MissingParentHeader', 'DuplicateHeader', 'HeaderNotFinalized', 'HeaderOnStaleFork', 'InvalidHeader', 'InvalidProof', 'DecodeFailed', 'NetworkNotFound', 'NetworkAlreadyExists', 'Unknown']
  },
  /**
   * Lookup694: basic_channel::inbound::pallet::Error<T>
   **/
  BasicChannelInboundPalletError: {
    _enum: ['InvalidNetwork', 'InvalidSourceChannel', 'InvalidEnvelope', 'InvalidNonce', 'ChannelExists', 'CallEncodeFailed']
  },
  /**
   * Lookup696: basic_channel::outbound::Message
   **/
  BasicChannelOutboundMessage: {
    networkId: 'u32',
    target: 'H160',
    nonce: 'u64',
    payload: 'Bytes'
  ...
  /**
   * Lookup697: basic_channel::outbound::pallet::Error<T>
   **/
  BasicChannelOutboundPalletError: {
    _enum: ['PayloadTooLarge', 'QueueSizeLimitReached', 'Overflow', 'NotAuthorized', 'InvalidNetwork', 'ChannelExists']
  },
  /**
   * Lookup698: incentivized_channel::inbound::pallet::Error<T>
   **/
  ...
  /**
   * Lookup700: incentivized_channel::outbound::Message
   **/
  IncentivizedChannelOutboundMessage: {
    networkId: 'u32',
    target: 'H160',
    nonce: 'u64',
    fee: 'U256',
  ...
  /**
   * Lookup701: incentivized_channel::outbound::pallet::Error<T>
   **/
  IncentivizedChannelOutboundPalletError: {
    _enum: ['PayloadTooLarge', 'QueueSizeLimitReached', 'NoFunds', 'Overflow', 'ChannelExists']
  },
  /**
   * Lookup702: bridge_types::types::AuxiliaryDigest
   **/
  BridgeTypesAuxiliaryDigest: {
    logs: 'Vec<BridgeTypesAuxiliaryDigestItem>'
  },
  /**
   * Lookup704: bridge_types::types::AuxiliaryDigestItem
   **/
  BridgeTypesAuxiliaryDigestItem: {
    _enum: {
      Commitment: '(u32,BridgeTypesChannelId,H256)'
    }
  },
  /**
   * Lookup706: eth_app::pallet::Error<T>
   **/
  EthAppError: {
    _enum: ['InvalidPayload', 'AppIsNotRegistered', 'InvalidAppAddress', 'AppAlreadyExists', 'DestAccountIsNotSet', 'CallEncodeFailed']
  },
  /**
   * Lookup708: bridge_types::types::AssetKind
   **/
  BridgeTypesAssetKind: {
    _enum: ['Thischain', 'Sidechain']
  },
  /**
   * Lookup709: erc20_app::pallet::Error<T>
   **/
  Erc20AppError: {
    _enum: ['TokenIsNotRegistered', 'AppIsNotRegistered', 'NotEnoughFunds', 'InvalidNetwork', 'TokenAlreadyRegistered', 'AppAlreadyRegistered', 'CallEncodeFailed']
  },
  /**
   * Lookup710: migration_app::pallet::Error<T>
   **/
  MigrationAppError: {
  ...
  /**
   * Lookup712: sp_runtime::MultiSignature
   **/
  ...
  /**
   * Lookup713: sp_core::ecdsa::Signature
   **/
  ...
  /**
   * Lookup722: frame_system::extensions::check_weight::CheckWeight<T>
   **/
  FrameSystemExtensionsCheckWeight: 'Null',
  /**
   * Lookup723: framenode_runtime::extensions::ChargeTransactionPayment<T>
   **/
  ...
  /**
   * Lookup725: framenode_runtime::Runtime
   **/
