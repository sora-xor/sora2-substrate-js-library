...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    'Option<WrappedBalance>': Option<WrappedBalance>;
    'Vec<WrappedBalance>': Vec<WrappedBalance>;
    AssetIdOf: AssetIdOf;
