...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    OutgoingTransferEthEncoded: OutgoingTransferEthEncoded;
    'Option<OutgoingTransferEthEncoded>': Option<OutgoingTransferEthEncoded>;
    'Vec<OutgoingTransferEthEncoded>': Vec<OutgoingTransferEthEncoded>;
    AddAssetOutgoingRequest: AddAssetOutgoingRequest;
    'Option<AddAssetOutgoingRequest>': Option<AddAssetOutgoingRequest>;
    'Vec<AddAssetOutgoingRequest>': Vec<AddAssetOutgoingRequest>;
    AddAssetRequestEncoded: AddAssetRequestEncoded;
    'Option<AddAssetRequestEncoded>': Option<AddAssetRequestEncoded>;
    'Vec<AddAssetRequestEncoded>': Vec<AddAssetRequestEncoded>;
    AddTokenOutgoingRequest: AddTokenOutgoingRequest;
    'Option<AddTokenOutgoingRequest>': Option<AddTokenOutgoingRequest>;
    'Vec<AddTokenOutgoingRequest>': Vec<AddTokenOutgoingRequest>;
    AddTokenRequestEncoded: AddTokenRequestEncoded;
    'Option<AddTokenRequestEncoded>': Option<AddTokenRequestEncoded>;
    'Vec<AddTokenRequestEncoded>': Vec<AddTokenRequestEncoded>;
    AddPeerOutgoingRequest: AddPeerOutgoingRequest;
    'Option<AddPeerOutgoingRequest>': Option<AddPeerOutgoingRequest>;
    'Vec<AddPeerOutgoingRequest>': Vec<AddPeerOutgoingRequest>;
    AddPeerOutgoingRequestEncoded: AddPeerOutgoingRequestEncoded;
    'Option<AddPeerOutgoingRequestEncoded>': Option<AddPeerOutgoingRequestEncoded>;
    'Vec<AddPeerOutgoingRequestEncoded>': Vec<AddPeerOutgoingRequestEncoded>;
    RemovePeerOutgoingRequest: RemovePeerOutgoingRequest;
    'Option<RemovePeerOutgoingRequest>': Option<RemovePeerOutgoingRequest>;
    'Vec<RemovePeerOutgoingRequest>': Vec<RemovePeerOutgoingRequest>;
    RemovePeerOutgoingRequestEncoded: RemovePeerOutgoingRequestEncoded;
    'Option<RemovePeerOutgoingRequestEncoded>': Option<RemovePeerOutgoingRequestEncoded>;
    'Vec<RemovePeerOutgoingRequestEncoded>': Vec<RemovePeerOutgoingRequestEncoded>;
    ...
    'Option<CancelOutgoingRequest>': Option<CancelOutgoingRequest>;
    'Vec<CancelOutgoingRequest>': Vec<CancelOutgoingRequest>;
