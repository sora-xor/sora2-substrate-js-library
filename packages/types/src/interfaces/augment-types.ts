...
import { AssetKind, CurrencyIdEncoded, FixedBytes, IncomingAddToken, IncomingCancelOutgoingRequest, IncomingChangePeers, IncomingClaimPswap, IncomingPreRequest, IncomingRequest, IncomingRequestKind, IncomingTransfer, NetworkId, OffchainRequest, OutgoingAddAsset, OutgoingAddAssetEncoded, OutgoingAddPeer, OutgoingAddPeerEncoded, OutgoingAddToken, OutgoingAddTokenEncoded, OutgoingRemovePeer, OutgoingRemovePeerEncoded, OutgoingRequest, OutgoingRequestEncoded, OutgoingTransfer, OutgoingTransferEncoded, RequestStatus, SignatureParams } from '@sora-substrate/types/interfaces/ethBridge';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    NetworkId: NetworkId;
    'Compact<NetworkId>': Compact<NetworkId>;
