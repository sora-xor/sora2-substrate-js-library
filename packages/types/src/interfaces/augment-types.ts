...
import type {
  ...
  DispatchTime,
  ScheduleTaskIndex,
} from '@open-web3/orml-types/interfaces/authority';
import type {
  GraduallyUpdate,
  StorageKeyBytes,
  StorageValue,
  StorageValueBytes,
} from '@open-web3/orml-types/interfaces/graduallyUpdates';
import type {
  DataProviderId,
  OrderedSet,
  RpcDataProviderId,
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    'Option<ContentSource>': Option<ContentSource>;
    ...
    'Vec<ContentSource>': Vec<ContentSource>;
    ...
    'Vec<Description>': Vec<Description>;
