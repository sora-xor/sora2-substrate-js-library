...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    ResultBalanceInfo: ResultBalanceInfo;
    'Option<ResultBalanceInfo>': Option<ResultBalanceInfo>;
    'Vec<ResultBalanceInfo>': Vec<ResultBalanceInfo>;
    ResultAssetInfo: ResultAssetInfo;
    'Option<ResultAssetInfo>': Option<ResultAssetInfo>;
    'Vec<ResultAssetInfo>': Vec<ResultAssetInfo>;
    ResultBool: ResultBool;
    'Option<ResultBool>': Option<ResultBool>;
    'Vec<ResultBool>': Vec<ResultBool>;
    ResultDexApiSwapOutcomeInfo: ResultDexApiSwapOutcomeInfo;
    'Option<ResultDexApiSwapOutcomeInfo>': Option<ResultDexApiSwapOutcomeInfo>;
    'Vec<ResultDexApiSwapOutcomeInfo>': Vec<ResultDexApiSwapOutcomeInfo>;
    ResultVecTradingPair: ResultVecTradingPair;
    'Option<ResultVecTradingPair>': Option<ResultVecTradingPair>;
    'Vec<ResultVecTradingPair>': Vec<ResultVecTradingPair>;
    ResultVecLiquiditySourceType: ResultVecLiquiditySourceType;
    'Option<ResultVecLiquiditySourceType>': Option<ResultVecLiquiditySourceType>;
    'Vec<ResultVecLiquiditySourceType>': Vec<ResultVecLiquiditySourceType>;
    ResultSwapOutcomeInfo: ResultSwapOutcomeInfo;
    'Option<ResultSwapOutcomeInfo>': Option<ResultSwapOutcomeInfo>;
    'Vec<ResultSwapOutcomeInfo>': Vec<ResultSwapOutcomeInfo>;
