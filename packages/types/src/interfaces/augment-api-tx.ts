...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    ...
    dexapi: {
      ...
      swap: AugmentedSubmittable<
        (
          ...
          limit: Balance | AnyNumber | Uint8Array,
          swapVariant: SwapVariant | 'WithDesiredInput' | 'WithDesiredOutput' | number | Uint8Array,
          receiver: Option<AccountId> | null | object | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [DEXId, LiquiditySourceType, AssetId, AssetId, Balance, Balance, SwapVariant, Option<AccountId>]
      >;
      /**
       * Generic tx
       **/
    ...
    liquidityProxy: {
      ...
      swap: AugmentedSubmittable<
        (
          ...
          inputAssetId: AssetId | AnyNumber | Uint8Array,
          outputAssetId: AssetId | AnyNumber | Uint8Array,
          swapAmount: SwapAmount | { WithDesiredInput: any } | { WithDesiredOutput: any } | string | Uint8Array,
          selectedSourceTypes:
        ...
        [DEXId, AssetId, AssetId, SwapAmount, Vec<LiquiditySourceType>, FilterMode]
      >;
      /**
       * Generic tx
       **/
    ...
    referrals: {
       ...
       **/
      reserve: AugmentedSubmittable<
        (balance: Balance | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [Balance]
      >;
      /**
      ...
      setReferrer: AugmentedSubmittable<
        (referrer: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [AccountId]
      >;
      /**
       * Generic tx
