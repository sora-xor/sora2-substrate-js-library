...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    vestedRewards: {
      ...
      unlockPendingScheduleByManager: AugmentedSubmittable<(dest: AccountId32 | string | Uint8Array, start: Option<u32> | null | Uint8Array | u32 | AnyNumber, filterSchedule: VestedRewardsVestingCurrenciesVestingScheduleVariant | { LinearVestingSchedule: any } | { LinearPendingVestingSchedule: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, Option<u32>, VestedRewardsVestingCurrenciesVestingScheduleVariant]>;
