...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    presto: {
      ...
      createCropReceipt: AugmentedSubmittable<(amount: u128 | AnyNumber | Uint8Array, closeInitialPeriod: u64 | AnyNumber | Uint8Array, dateOfIssue: u64 | AnyNumber | Uint8Array, placeOfIssue: Bytes | string | Uint8Array, debtor: Bytes | string | Uint8Array, creditor: Bytes | string | Uint8Array, perfomanceTime: u64 | AnyNumber | Uint8Array, data: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128, u64, u64, Bytes, Bytes, Bytes, u64, Bytes]>;
