...
declare module '@polkadot/api-base/types/submittable' {
  export interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    basicInboundChannel: {
      registerChannel: AugmentedSubmittable<(networkId: u32 | AnyNumber | Uint8Array, channel: H160 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, H160]>;
      submit: AugmentedSubmittable<(networkId: u32 | AnyNumber | Uint8Array, message: BridgeTypesMessage | { data?: any; proof?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, BridgeTypesMessage]>;
    };
    bridgeMultisig: {
      /**
    ...
    erc20App: {
      burn: AugmentedSubmittable<(networkId: u32 | AnyNumber | Uint8Array, channelId: BridgeTypesChannelId | 'Basic' | 'Incentivized' | number | Uint8Array, assetId: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array, recipient: H160 | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, BridgeTypesChannelId, CommonPrimitivesAssetId32, H160, u128]>;
      ...
      registerErc20App: AugmentedSubmittable<(networkId: u32 | AnyNumber | Uint8Array, contract: H160 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, H160]>;
      registerErc20Asset: AugmentedSubmittable<(networkId: u32 | AnyNumber | Uint8Array, address: H160 | string | Uint8Array, symbol: Bytes | string | Uint8Array, name: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, H160, Bytes, Bytes]>;
      registerExistingErc20Asset: AugmentedSubmittable<(networkId: u32 | AnyNumber | Uint8Array, address: H160 | string | Uint8Array, assetId: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, H160, CommonPrimitivesAssetId32]>;
      registerNativeApp: AugmentedSubmittable<(networkId: u32 | AnyNumber | Uint8Array, contract: H160 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, H160]>;
      registerNativeAsset: AugmentedSubmittable<(networkId: u32 | AnyNumber | Uint8Array, assetId: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, CommonPrimitivesAssetId32]>;
    };
    ethApp: {
      burn: AugmentedSubmittable<(networkId: u32 | AnyNumber | Uint8Array, channelId: BridgeTypesChannelId | 'Basic' | 'Incentivized' | number | Uint8Array, recipient: H160 | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, BridgeTypesChannelId, H160, u128]>;
      ...
      registerNetwork: AugmentedSubmittable<(networkId: u32 | AnyNumber | Uint8Array, name: Bytes | string | Uint8Array, symbol: Bytes | string | Uint8Array, contract: H160 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, Bytes, Bytes, H160]>;
      registerNetworkWithExistingAsset: AugmentedSubmittable<(networkId: u32 | AnyNumber | Uint8Array, assetId: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array, contract: H160 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, CommonPrimitivesAssetId32, H160]>;
    };
    ethBridge: {
      /**
    ...
    migrationApp: {
      migrateErc20: AugmentedSubmittable<(networkId: u32 | AnyNumber | Uint8Array, erc20Assets: Vec<ITuple<[CommonPrimitivesAssetId32, H160]>> | ([CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array, H160 | string | Uint8Array])[]) => SubmittableExtrinsic<ApiType>, [u32, Vec<ITuple<[CommonPrimitivesAssetId32, H160]>>]>;
      migrateEth: AugmentedSubmittable<(networkId: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32]>;
      migrateSidechain: AugmentedSubmittable<(networkId: u32 | AnyNumber | Uint8Array, sidechainAssets: Vec<ITuple<[CommonPrimitivesAssetId32, H160]>> | ([CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array, H160 | string | Uint8Array])[]) => SubmittableExtrinsic<ApiType>, [u32, Vec<ITuple<[CommonPrimitivesAssetId32, H160]>>]>;
      registerNetwork: AugmentedSubmittable<(networkId: u32 | AnyNumber | Uint8Array, contract: H160 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, H160]>;
    };
    multicollateralBondingCurvePool: {
      /**
