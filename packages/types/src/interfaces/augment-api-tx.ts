...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    apolloPlatform: {
       ...
       **/
      changeCollateralFactor: AugmentedSubmittable<(amount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128]>;
      /**
       * Change rewards amount
       **/
       ...
       * Edit pool info
       **/
      editPoolInfo: AugmentedSubmittable<(assetId: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array, newLoanToValue: u128 | AnyNumber | Uint8Array, newLiquidationThreshold: u128 | AnyNumber | Uint8Array, newOptimalUtilizationRate: u128 | AnyNumber | Uint8Array, newBaseRate: u128 | AnyNumber | Uint8Array, newSlopeRate1: u128 | AnyNumber | Uint8Array, newSlopeRate2: u128 | AnyNumber | Uint8Array, newReserveFactor: u128 | AnyNumber | Uint8Array, newTl: u128 | AnyNumber | Uint8Array, newTb: u128 | AnyNumber | Uint8Array, newTc: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [CommonPrimitivesAssetId32, u128, u128, u128, u128, u128, u128, u128, u128, u128, u128]>;
      /**
       * Get rewards
       **/
    ...
    bridgeDataSigner: {
      addPeer: AugmentedSubmittable<(networkId: BridgeTypesGenericNetworkId | { EVM: any } | { Sub: any } | { EVMLegacy: any } | { TON: any } | string | Uint8Array, peer: SpCoreEcdsaPublic | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [BridgeTypesGenericNetworkId, SpCoreEcdsaPublic]>;
      approve: AugmentedSubmittable<(networkId: BridgeTypesGenericNetworkId | { EVM: any } | { Sub: any } | { EVMLegacy: any } | { TON: any } | string | Uint8Array, data: H256 | string | Uint8Array, signature: SpCoreEcdsaSignature | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [BridgeTypesGenericNetworkId, H256, SpCoreEcdsaSignature]>;
      ...
      registerNetwork: AugmentedSubmittable<(networkId: BridgeTypesGenericNetworkId | { EVM: any } | { Sub: any } | { EVMLegacy: any } | { TON: any } | string | Uint8Array, peers: Vec<SpCoreEcdsaPublic> | (SpCoreEcdsaPublic | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [BridgeTypesGenericNetworkId, Vec<SpCoreEcdsaPublic>]>;
      removePeer: AugmentedSubmittable<(networkId: BridgeTypesGenericNetworkId | { EVM: any } | { Sub: any } | { EVMLegacy: any } | { TON: any } | string | Uint8Array, peer: SpCoreEcdsaPublic | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [BridgeTypesGenericNetworkId, SpCoreEcdsaPublic]>;
    };
    bridgeInboundChannel: {
      registerEvmChannel: AugmentedSubmittable<(networkId: H256 | string | Uint8Array, channelAddress: H160 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, H160]>;
      registerTonChannel: AugmentedSubmittable<(networkId: BridgeTypesTonTonNetworkId | 'Mainnet' | 'Testnet' | number | Uint8Array, channelAddress: BridgeTypesTonTonAddress | { workchain?: any; address?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [BridgeTypesTonTonNetworkId, BridgeTypesTonTonAddress]>;
      submit: AugmentedSubmittable<(networkId: BridgeTypesGenericNetworkId | { EVM: any } | { Sub: any } | { EVMLegacy: any } | { TON: any } | string | Uint8Array, commitment: BridgeTypesGenericCommitment | { Sub: any } | { EVM: any } | { TON: any } | string | Uint8Array, proof: FramenodeRuntimeMultiProof | { Beefy: any } | { Multisig: any } | { EVMMultisig: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [BridgeTypesGenericNetworkId, BridgeTypesGenericCommitment, FramenodeRuntimeMultiProof]>;
    };
    bridgeMultisig: {
      /**
    ...
    bridgeProxy: {
      ...
      burn: AugmentedSubmittable<(networkId: BridgeTypesGenericNetworkId | { EVM: any } | { Sub: any } | { EVMLegacy: any } | { TON: any } | string | Uint8Array, assetId: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array, recipient: BridgeTypesGenericAccount | { EVM: any } | { Sora: any } | { Liberland: any } | { Parachain: any } | { Unknown: any } | { Root: any } | { TON: any } | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [BridgeTypesGenericNetworkId, CommonPrimitivesAssetId32, BridgeTypesGenericAccount, u128]>;
    ...
    denomination: {
      ...
      startDenomination: AugmentedSubmittable<(denominator: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128]>;
    };
    dexapi: {
      disableLiquiditySource: AugmentedSubmittable<(source: CommonPrimitivesLiquiditySourceType | 'XYKPool' | 'BondingCurvePool' | 'MulticollateralBondingCurvePool' | 'MockPool' | 'MockPool2' | 'MockPool3' | 'MockPool4' | 'XSTPool' | 'OrderBook' | number | Uint8Array) => SubmittableExtrinsic<ApiType>, [CommonPrimitivesLiquiditySourceType]>;
      enableLiquiditySource: AugmentedSubmittable<(source: CommonPrimitivesLiquiditySourceType | 'XYKPool' | 'BondingCurvePool' | 'MulticollateralBondingCurvePool' | 'MockPool' | 'MockPool2' | 'MockPool3' | 'MockPool4' | 'XSTPool' | 'OrderBook' | number | Uint8Array) => SubmittableExtrinsic<ApiType>, [CommonPrimitivesLiquiditySourceType]>;
    };
    ...
    evmFungibleApp: {
      burn: AugmentedSubmittable<(networkId: H256 | string | Uint8Array, assetId: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array, recipient: H160 | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, CommonPrimitivesAssetId32, H160, u128]>;
      claimRelayerFees: AugmentedSubmittable<(networkId: H256 | string | Uint8Array, relayer: H160 | string | Uint8Array, signature: SpCoreEcdsaSignature | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, H160, SpCoreEcdsaSignature]>;
      ...
      registerExistingSidechainAsset: AugmentedSubmittable<(networkId: H256 | string | Uint8Array, address: H160 | string | Uint8Array, assetId: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array, decimals: u8 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, H160, CommonPrimitivesAssetId32, u8]>;
      registerNetwork: AugmentedSubmittable<(networkId: H256 | string | Uint8Array, contract: H160 | string | Uint8Array, symbol: Bytes | string | Uint8Array, name: Bytes | string | Uint8Array, sidechainPrecision: u8 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, H160, Bytes, Bytes, u8]>;
      registerNetworkWithExistingAsset: AugmentedSubmittable<(networkId: H256 | string | Uint8Array, contract: H160 | string | Uint8Array, assetId: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array, sidechainPrecision: u8 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, H160, CommonPrimitivesAssetId32, u8]>;
    ...
    jettonApp: {
       ...
       **/
      mint: AugmentedSubmittable<(token: BridgeTypesTonTonAddressWithPrefix | { prefix?: any; address?: any } | string | Uint8Array, sender: BridgeTypesTonTonAddressWithPrefix | { prefix?: any; address?: any } | string | Uint8Array, recipient: AccountId32 | string | Uint8Array, amount: H128 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [BridgeTypesTonTonAddressWithPrefix, BridgeTypesTonTonAddressWithPrefix, AccountId32, H128]>;
      /**
       ...
       **/
      registerNetwork: AugmentedSubmittable<(networkId: BridgeTypesTonTonNetworkId | 'Mainnet' | 'Testnet' | number | Uint8Array, contract: BridgeTypesTonTonAddress | { workchain?: any; address?: any } | string | Uint8Array, symbol: Bytes | string | Uint8Array, name: Bytes | string | Uint8Array, decimals: u8 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [BridgeTypesTonTonNetworkId, BridgeTypesTonTonAddress, Bytes, Bytes, u8]>;
      /**
       * Register network with the new asset for native TON
       * 
       * Arguments:
       ...
       * - Network already registered
       **/
      registerNetworkWithExistingAsset: AugmentedSubmittable<(networkId: BridgeTypesTonTonNetworkId | 'Mainnet' | 'Testnet' | number | Uint8Array, contract: BridgeTypesTonTonAddress | { workchain?: any; address?: any } | string | Uint8Array, assetId: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array, decimals: u8 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [BridgeTypesTonTonNetworkId, BridgeTypesTonTonAddress, CommonPrimitivesAssetId32, u8]>;
    };
    kensetsu: {
      /**
    ...
    liquidityProxy: {
       ...
       **/
      swapTransferBatch: AugmentedSubmittable<(swapBatches: Vec<LiquidityProxySwapBatchInfo> | (LiquidityProxySwapBatchInfo | { outcomeAssetId?: any; outcomeAssetReuse?: any; dexId?: any; receivers?: any } | string | Uint8Array)[], inputAssetId: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array, maxInputAmount: u128 | AnyNumber | Uint8Array, selectedSourceTypes: Vec<CommonPrimitivesLiquiditySourceType> | (CommonPrimitivesLiquiditySourceType | 'XYKPool' | 'BondingCurvePool' | 'MulticollateralBondingCurvePool' | 'MockPool' | 'MockPool2' | 'MockPool3' | 'MockPool4' | 'XSTPool' | 'OrderBook' | number | Uint8Array)[], filterMode: CommonPrimitivesFilterMode | 'Disabled' | 'ForbidSelected' | 'AllowSelected' | number | Uint8Array, additionalData: Option<Bytes> | null | Uint8Array | Bytes | string) => SubmittableExtrinsic<ApiType>, [Vec<LiquidityProxySwapBatchInfo>, CommonPrimitivesAssetId32, u128, Vec<CommonPrimitivesLiquiditySourceType>, CommonPrimitivesFilterMode, Option<Bytes>]>;
      /**
    ...
    multisigVerifier: {
      ...
      initialize: AugmentedSubmittable<(networkId: BridgeTypesGenericNetworkId | { EVM: any } | { Sub: any } | { EVMLegacy: any } | { TON: any } | string | Uint8Array, peers: Vec<SpCoreEcdsaPublic> | (SpCoreEcdsaPublic | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [BridgeTypesGenericNetworkId, Vec<SpCoreEcdsaPublic>]>;
    ...
    orderBook: {
       ...
       **/
      cancelLimitOrder: AugmentedSubmittable<(orderBookId: CommonPrimitivesOrderBookId | { dexId?: any; base?: any; quote?: any } | string | Uint8Array, orderId: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [CommonPrimitivesOrderBookId, u128]>;
      /**
       ...
       **/
      cancelLimitOrdersBatch: AugmentedSubmittable<(limitOrdersToCancel: Vec<ITuple<[CommonPrimitivesOrderBookId, Vec<u128>]>> | ([CommonPrimitivesOrderBookId | { dexId?: any; base?: any; quote?: any } | string | Uint8Array, Vec<u128> | (u128 | AnyNumber | Uint8Array)[]])[]) => SubmittableExtrinsic<ApiType>, [Vec<ITuple<[CommonPrimitivesOrderBookId, Vec<u128>]>>]>;
      /**
       ...
       **/
      changeOrderbookStatus: AugmentedSubmittable<(orderBookId: CommonPrimitivesOrderBookId | { dexId?: any; base?: any; quote?: any } | string | Uint8Array, status: OrderBookOrderBookStatus | 'Trade' | 'PlaceAndCancel' | 'OnlyCancel' | 'Stop' | number | Uint8Array) => SubmittableExtrinsic<ApiType>, [CommonPrimitivesOrderBookId, OrderBookOrderBookStatus]>;
      /**
       ...
       **/
      createOrderbook: AugmentedSubmittable<(orderBookId: CommonPrimitivesOrderBookId | { dexId?: any; base?: any; quote?: any } | string | Uint8Array, tickSize: u128 | AnyNumber | Uint8Array, stepLotSize: u128 | AnyNumber | Uint8Array, minLotSize: u128 | AnyNumber | Uint8Array, maxLotSize: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [CommonPrimitivesOrderBookId, u128, u128, u128, u128]>;
      /**
       ...
       **/
      deleteOrderbook: AugmentedSubmittable<(orderBookId: CommonPrimitivesOrderBookId | { dexId?: any; base?: any; quote?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CommonPrimitivesOrderBookId]>;
      /**
       ...
       **/
      executeMarketOrder: AugmentedSubmittable<(orderBookId: CommonPrimitivesOrderBookId | { dexId?: any; base?: any; quote?: any } | string | Uint8Array, direction: CommonPrimitivesPriceVariant | 'Buy' | 'Sell' | number | Uint8Array, amount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [CommonPrimitivesOrderBookId, CommonPrimitivesPriceVariant, u128]>;
      /**
       ...
       **/
      placeLimitOrder: AugmentedSubmittable<(orderBookId: CommonPrimitivesOrderBookId | { dexId?: any; base?: any; quote?: any } | string | Uint8Array, price: u128 | AnyNumber | Uint8Array, amount: u128 | AnyNumber | Uint8Array, side: CommonPrimitivesPriceVariant | 'Buy' | 'Sell' | number | Uint8Array, lifespan: Option<u64> | null | Uint8Array | u64 | AnyNumber) => SubmittableExtrinsic<ApiType>, [CommonPrimitivesOrderBookId, u128, u128, CommonPrimitivesPriceVariant, Option<u64>]>;
      /**
       ...
       **/
      updateOrderbook: AugmentedSubmittable<(orderBookId: CommonPrimitivesOrderBookId | { dexId?: any; base?: any; quote?: any } | string | Uint8Array, tickSize: u128 | AnyNumber | Uint8Array, stepLotSize: u128 | AnyNumber | Uint8Array, minLotSize: u128 | AnyNumber | Uint8Array, maxLotSize: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [CommonPrimitivesOrderBookId, u128, u128, u128, u128]>;
    };
    parachainBridgeApp: {
      ...
      bindSidechainAsset: AugmentedSubmittable<(networkId: BridgeTypesSubNetworkId | 'Mainnet' | 'Kusama' | 'Polkadot' | 'Rococo' | 'Alphanet' | 'Liberland' | number | Uint8Array, assetId: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array, sidechainAsset: XcmV3MultiassetAssetId | { Concrete: any } | { Abstract: any } | string | Uint8Array, sidechainPrecision: u8 | AnyNumber | Uint8Array, allowedParachains: Vec<u32> | (u32 | AnyNumber | Uint8Array)[], minimalXcmAmount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [BridgeTypesSubNetworkId, CommonPrimitivesAssetId32, XcmV3MultiassetAssetId, u8, Vec<u32>, u128]>;
    ...
    presto: {
      ...
      applyCreditorKyc: AugmentedSubmittable<(creditor: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32]>;
      applyInvestorKyc: AugmentedSubmittable<(investor: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32]>;
      ...
      claimRefund: AugmentedSubmittable<(couponAssetId: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array, couponAmount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [CommonPrimitivesAssetId32, u128]>;
      createCropReceipt: AugmentedSubmittable<(amount: u128 | AnyNumber | Uint8Array, profit: Permill | AnyNumber | Uint8Array, country: PrestoCropReceiptCountry | 'Brazil' | 'Indonesia' | 'Nigeria' | 'Ukraine' | 'Usa' | 'Other' | number | Uint8Array, closeInitialPeriod: u64 | AnyNumber | Uint8Array, dateOfIssue: u64 | AnyNumber | Uint8Array, placeOfIssue: Bytes | string | Uint8Array, debtor: Bytes | string | Uint8Array, creditor: Bytes | string | Uint8Array, perfomanceTime: u64 | AnyNumber | Uint8Array, data: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128, Permill, PrestoCropReceiptCountry, u64, u64, Bytes, Bytes, Bytes, u64, Bytes]>;
      ...
      payOffCropReceipt: AugmentedSubmittable<(cropReceiptId: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64]>;
      publishCropReceipt: AugmentedSubmittable<(cropReceiptId: u64 | AnyNumber | Uint8Array, supply: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, u128]>;
      ...
      removeCreditorKyc: AugmentedSubmittable<(creditor: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32]>;
      removeInvestorKyc: AugmentedSubmittable<(investor: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32]>;
    ...
    qaTools: {
       ...
       **/
      mcbcInitialize: AugmentedSubmittable<(baseSupply: Option<QaToolsPalletToolsMcbcBaseSupply> | null | Uint8Array | QaToolsPalletToolsMcbcBaseSupply | { assetCollector?: any; target?: any } | string, otherCollaterals: Vec<QaToolsPalletToolsMcbcOtherCollateralInput> | (QaToolsPalletToolsMcbcOtherCollateralInput | { asset?: any; parameters?: any } | string | Uint8Array)[], tbcdCollateral: Option<QaToolsPalletToolsMcbcTbcdCollateralInput> | null | Uint8Array | QaToolsPalletToolsMcbcTbcdCollateralInput | { parameters?: any; refXorPrices?: any } | string) => SubmittableExtrinsic<ApiType>, [Option<QaToolsPalletToolsMcbcBaseSupply>, Vec<QaToolsPalletToolsMcbcOtherCollateralInput>, Option<QaToolsPalletToolsMcbcTbcdCollateralInput>]>;
      /**
       ...
       **/
      orderBookCreateAndFillBatch: AugmentedSubmittable<(bidsOwner: AccountId32 | string | Uint8Array, asksOwner: AccountId32 | string | Uint8Array, settings: Vec<ITuple<[CommonPrimitivesOrderBookId, QaToolsPalletToolsOrderBookOrderBookAttributes, QaToolsPalletToolsOrderBookFillInput]>> | ([CommonPrimitivesOrderBookId | { dexId?: any; base?: any; quote?: any } | string | Uint8Array, QaToolsPalletToolsOrderBookOrderBookAttributes | { tickSize?: any; stepLotSize?: any; minLotSize?: any; maxLotSize?: any } | string | Uint8Array, QaToolsPalletToolsOrderBookFillInput | { asks?: any; bids?: any; randomSeed?: any } | string | Uint8Array])[]) => SubmittableExtrinsic<ApiType>, [AccountId32, AccountId32, Vec<ITuple<[CommonPrimitivesOrderBookId, QaToolsPalletToolsOrderBookOrderBookAttributes, QaToolsPalletToolsOrderBookFillInput]>>]>;
      /**
       ...
       **/
      orderBookFillBatch: AugmentedSubmittable<(bidsOwner: AccountId32 | string | Uint8Array, asksOwner: AccountId32 | string | Uint8Array, settings: Vec<ITuple<[CommonPrimitivesOrderBookId, QaToolsPalletToolsOrderBookFillInput]>> | ([CommonPrimitivesOrderBookId | { dexId?: any; base?: any; quote?: any } | string | Uint8Array, QaToolsPalletToolsOrderBookFillInput | { asks?: any; bids?: any; randomSeed?: any } | string | Uint8Array])[]) => SubmittableExtrinsic<ApiType>, [AccountId32, AccountId32, Vec<ITuple<[CommonPrimitivesOrderBookId, QaToolsPalletToolsOrderBookFillInput]>>]>;
      /**
       ...
       **/
      priceToolsSetAssetPrice: AugmentedSubmittable<(assetPerXor: QaToolsPalletToolsPriceToolsAssetPrices | { buy?: any; sell?: any } | string | Uint8Array, assetId: QaToolsInputAssetId | { McbcReference: any } | { XstReference: any } | { Other: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [QaToolsPalletToolsPriceToolsAssetPrices, QaToolsInputAssetId]>;
      /**
    ...
    substrateBridgeApp: {
       ...
       **/
      burn: AugmentedSubmittable<(networkId: BridgeTypesSubNetworkId | 'Mainnet' | 'Kusama' | 'Polkadot' | 'Rococo' | 'Alphanet' | 'Liberland' | number | Uint8Array, assetId: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array, recipient: BridgeTypesGenericAccount | { EVM: any } | { Sora: any } | { Liberland: any } | { Parachain: any } | { Unknown: any } | { Root: any } | { TON: any } | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [BridgeTypesSubNetworkId, CommonPrimitivesAssetId32, BridgeTypesGenericAccount, u128]>;
      /**
       ...
       **/
      finalizeAssetRegistration: AugmentedSubmittable<(assetId: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array, sidechainAssetId: BridgeTypesGenericAssetId | { Sora: any } | { XCM: any } | { EVM: any } | { Liberland: any } | string | Uint8Array, assetKind: BridgeTypesAssetKind | 'Thischain' | 'Sidechain' | number | Uint8Array, sidechainPrecision: u8 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [CommonPrimitivesAssetId32, BridgeTypesGenericAssetId, BridgeTypesAssetKind, u8]>;
      /**
       ...
       **/
      incomingThischainAssetRegistration: AugmentedSubmittable<(assetId: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array, sidechainAssetId: BridgeTypesGenericAssetId | { Sora: any } | { XCM: any } | { EVM: any } | { Liberland: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CommonPrimitivesAssetId32, BridgeTypesGenericAssetId]>;
      /**
       * Function used to mint or unlock tokens
       * The Origin for this call is the Bridge Origin
       * Only the relayer can call this function
       **/
      mint: AugmentedSubmittable<(assetId: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array, sender: BridgeTypesGenericAccount | { EVM: any } | { Sora: any } | { Liberland: any } | { Parachain: any } | { Unknown: any } | { Root: any } | { TON: any } | string | Uint8Array, recipient: AccountId32 | string | Uint8Array, amount: BridgeTypesGenericBalance | { Substrate: any } | { EVM: any } | { TON: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CommonPrimitivesAssetId32, BridgeTypesGenericAccount, AccountId32, BridgeTypesGenericBalance]>;
      /**
       ...
       **/
      registerSidechainAsset: AugmentedSubmittable<(networkId: BridgeTypesSubNetworkId | 'Mainnet' | 'Kusama' | 'Polkadot' | 'Rococo' | 'Alphanet' | 'Liberland' | number | Uint8Array, sidechainAsset: BridgeTypesGenericAssetId | { Sora: any } | { XCM: any } | { EVM: any } | { Liberland: any } | string | Uint8Array, symbol: Bytes | string | Uint8Array, name: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [BridgeTypesSubNetworkId, BridgeTypesGenericAssetId, Bytes, Bytes]>;
      /**
       * Function used to update transaction status
       * The Origin for this call is the Bridge Origin
       * Only the relayer can call this function
       **/
      updateTransactionStatus: AugmentedSubmittable<(messageId: H256 | string | Uint8Array, messageStatus: BridgeTypesMessageStatus | 'InQueue' | 'Committed' | 'Done' | 'Failed' | 'Refunded' | 'Approved' | number | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256, BridgeTypesMessageStatus]>;
    };
    substrateBridgeInboundChannel: {
      submit: AugmentedSubmittable<(networkId: BridgeTypesSubNetworkId | 'Mainnet' | 'Kusama' | 'Polkadot' | 'Rococo' | 'Alphanet' | 'Liberland' | number | Uint8Array, commitment: BridgeTypesGenericCommitment | { Sub: any } | { EVM: any } | { TON: any } | string | Uint8Array, proof: FramenodeRuntimeMultiProof | { Beefy: any } | { Multisig: any } | { EVMMultisig: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [BridgeTypesSubNetworkId, BridgeTypesGenericCommitment, FramenodeRuntimeMultiProof]>;
    };
    substrateBridgeOutboundChannel: {
      updateInterval: AugmentedSubmittable<(newInterval: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32]>;
    };
    sudo: {
      /**
    ...
    vestedRewards: {
      ...
      claimFor: AugmentedSubmittable<(assetId: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array, dest: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CommonPrimitivesAssetId32, AccountId32]>;
      /**
       * Claim all available PSWAP rewards by account signing this transaction.
       **/
      claimRewards: AugmentedSubmittable<() => SubmittableExtrinsic<ApiType>, []>;
      claimUnlocked: AugmentedSubmittable<(assetId: CommonPrimitivesAssetId32 | { code?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CommonPrimitivesAssetId32]>;
      ...
      updateVestingSchedules: AugmentedSubmittable<(who: AccountId32 | string | Uint8Array, vestingSchedules: Vec<VestedRewardsVestingCurrenciesVestingScheduleVariant> | (VestedRewardsVestingCurrenciesVestingScheduleVariant | { LinearVestingSchedule: any } | { LinearPendingVestingSchedule: any } | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [AccountId32, Vec<VestedRewardsVestingCurrenciesVestingScheduleVariant>]>;
    ...
    xorFee: {
       ...
       **/
      scaleMultiplier: AugmentedSubmittable<(factor: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128]>;
      /**
