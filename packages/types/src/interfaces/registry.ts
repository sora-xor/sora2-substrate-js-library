...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    BridgeTypesSubstrateSubstrateAppCall: BridgeTypesSubstrateSubstrateAppCall;
