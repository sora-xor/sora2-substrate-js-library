...
import { Fixed18 } from '@sora-neo-substrate/app-util';
...
async function main(): Promise<void> {
  ...
  var fxd = Fixed18.fromParts(manualCreate.toString());
  strictEqual(fxd.toString(), '1.05');
  var fxd2 = fxd.mul(Fixed18.fromNatural(2));
  strictEqual(fxd2.toString(), '2.1');
  strictEqual(fxd2.innerToString(), '2100000000000000000')
  ...
  ok(price2.isSome);
  strictEqual(Fixed18.fromParts(price2.unwrap().amount.toString()).toString(), '1.211862');
  strictEqual(Fixed18.fromParts(price2.unwrap().fee.toString()).toString(), '0.00315');
